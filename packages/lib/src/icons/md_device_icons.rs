...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("Md1xMobiledata".to_owned(), rsx!(Icon { icon: Md1xMobiledata, width: width, height: height })));
    icons.push(("Md30fps".to_owned(), rsx!(Icon { icon: Md30fps, width: width, height: height })));
    icons.push(("Md3gMobiledata".to_owned(), rsx!(Icon { icon: Md3gMobiledata, width: width, height: height })));
    icons.push(("Md4gMobiledata".to_owned(), rsx!(Icon { icon: Md4gMobiledata, width: width, height: height })));
    icons.push(("Md4gPlusMobiledata".to_owned(), rsx!(Icon { icon: Md4gPlusMobiledata, width: width, height: height })));
    icons.push(("Md60fps".to_owned(), rsx!(Icon { icon: Md60fps, width: width, height: height })));
    icons.push(("MdAccessAlarm".to_owned(), rsx!(Icon { icon: MdAccessAlarm, width: width, height: height })));
    icons.push(("MdAccessAlarms".to_owned(), rsx!(Icon { icon: MdAccessAlarms, width: width, height: height })));
    icons.push(("MdAccessTime".to_owned(), rsx!(Icon { icon: MdAccessTime, width: width, height: height })));
    icons.push(("MdAccessTimeFilled".to_owned(), rsx!(Icon { icon: MdAccessTimeFilled, width: width, height: height })));
    icons.push(("MdAdUnits".to_owned(), rsx!(Icon { icon: MdAdUnits, width: width, height: height })));
    icons.push(("MdAddAlarm".to_owned(), rsx!(Icon { icon: MdAddAlarm, width: width, height: height })));
    icons.push(("MdAddToHomeScreen".to_owned(), rsx!(Icon { icon: MdAddToHomeScreen, width: width, height: height })));
    icons.push(("MdAir".to_owned(), rsx!(Icon { icon: MdAir, width: width, height: height })));
    icons.push(("MdAirplaneTicket".to_owned(), rsx!(Icon { icon: MdAirplaneTicket, width: width, height: height })));
    icons.push(("MdAirplanemodeActive".to_owned(), rsx!(Icon { icon: MdAirplanemodeActive, width: width, height: height })));
    icons.push(("MdAirplanemodeInactive".to_owned(), rsx!(Icon { icon: MdAirplanemodeInactive, width: width, height: height })));
    icons.push(("MdAod".to_owned(), rsx!(Icon { icon: MdAod, width: width, height: height })));
    icons.push(("MdBattery0Bar".to_owned(), rsx!(Icon { icon: MdBattery0Bar, width: width, height: height })));
    icons.push(("MdBattery1Bar".to_owned(), rsx!(Icon { icon: MdBattery1Bar, width: width, height: height })));
    icons.push(("MdBattery2Bar".to_owned(), rsx!(Icon { icon: MdBattery2Bar, width: width, height: height })));
    icons.push(("MdBattery3Bar".to_owned(), rsx!(Icon { icon: MdBattery3Bar, width: width, height: height })));
    icons.push(("MdBattery4Bar".to_owned(), rsx!(Icon { icon: MdBattery4Bar, width: width, height: height })));
    icons.push(("MdBattery5Bar".to_owned(), rsx!(Icon { icon: MdBattery5Bar, width: width, height: height })));
    icons.push(("MdBattery6Bar".to_owned(), rsx!(Icon { icon: MdBattery6Bar, width: width, height: height })));
    icons.push(("MdBatteryAlert".to_owned(), rsx!(Icon { icon: MdBatteryAlert, width: width, height: height })));
    icons.push(("MdBatteryChargingFull".to_owned(), rsx!(Icon { icon: MdBatteryChargingFull, width: width, height: height })));
    icons.push(("MdBatteryFull".to_owned(), rsx!(Icon { icon: MdBatteryFull, width: width, height: height })));
    icons.push(("MdBatterySaver".to_owned(), rsx!(Icon { icon: MdBatterySaver, width: width, height: height })));
    icons.push(("MdBatteryStd".to_owned(), rsx!(Icon { icon: MdBatteryStd, width: width, height: height })));
    icons.push(("MdBatteryUnknown".to_owned(), rsx!(Icon { icon: MdBatteryUnknown, width: width, height: height })));
    icons.push(("MdBloodtype".to_owned(), rsx!(Icon { icon: MdBloodtype, width: width, height: height })));
    icons.push(("MdBluetooth".to_owned(), rsx!(Icon { icon: MdBluetooth, width: width, height: height })));
    icons.push(("MdBluetoothConnected".to_owned(), rsx!(Icon { icon: MdBluetoothConnected, width: width, height: height })));
    icons.push(("MdBluetoothDisabled".to_owned(), rsx!(Icon { icon: MdBluetoothDisabled, width: width, height: height })));
    icons.push(("MdBluetoothDrive".to_owned(), rsx!(Icon { icon: MdBluetoothDrive, width: width, height: height })));
    icons.push(("MdBluetoothSearching".to_owned(), rsx!(Icon { icon: MdBluetoothSearching, width: width, height: height })));
    icons.push(("MdBrightnessAuto".to_owned(), rsx!(Icon { icon: MdBrightnessAuto, width: width, height: height })));
    icons.push(("MdBrightnessHigh".to_owned(), rsx!(Icon { icon: MdBrightnessHigh, width: width, height: height })));
    icons.push(("MdBrightnessLow".to_owned(), rsx!(Icon { icon: MdBrightnessLow, width: width, height: height })));
    icons.push(("MdBrightnessMedium".to_owned(), rsx!(Icon { icon: MdBrightnessMedium, width: width, height: height })));
    icons.push(("MdCable".to_owned(), rsx!(Icon { icon: MdCable, width: width, height: height })));
    icons.push(("MdCameraswitch".to_owned(), rsx!(Icon { icon: MdCameraswitch, width: width, height: height })));
    icons.push(("MdCreditScore".to_owned(), rsx!(Icon { icon: MdCreditScore, width: width, height: height })));
    icons.push(("MdDarkMode".to_owned(), rsx!(Icon { icon: MdDarkMode, width: width, height: height })));
    icons.push(("MdDataSaverOff".to_owned(), rsx!(Icon { icon: MdDataSaverOff, width: width, height: height })));
    icons.push(("MdDataSaverOn".to_owned(), rsx!(Icon { icon: MdDataSaverOn, width: width, height: height })));
    icons.push(("MdDataUsage".to_owned(), rsx!(Icon { icon: MdDataUsage, width: width, height: height })));
    icons.push(("MdDataset".to_owned(), rsx!(Icon { icon: MdDataset, width: width, height: height })));
    icons.push(("MdDatasetLinked".to_owned(), rsx!(Icon { icon: MdDatasetLinked, width: width, height: height })));
    icons.push(("MdDeveloperMode".to_owned(), rsx!(Icon { icon: MdDeveloperMode, width: width, height: height })));
    icons.push(("MdDeviceThermostat".to_owned(), rsx!(Icon { icon: MdDeviceThermostat, width: width, height: height })));
    icons.push(("MdDevices".to_owned(), rsx!(Icon { icon: MdDevices, width: width, height: height })));
    icons.push(("MdDevicesFold".to_owned(), rsx!(Icon { icon: MdDevicesFold, width: width, height: height })));
    icons.push(("MdDiscount".to_owned(), rsx!(Icon { icon: MdDiscount, width: width, height: height })));
    icons.push(("MdDoNotDisturbOnTotalSilence".to_owned(), rsx!(Icon { icon: MdDoNotDisturbOnTotalSilence, width: width, height: height })));
    icons.push(("MdDvr".to_owned(), rsx!(Icon { icon: MdDvr, width: width, height: height })));
    icons.push(("MdEMobiledata".to_owned(), rsx!(Icon { icon: MdEMobiledata, width: width, height: height })));
    icons.push(("MdEdgesensorHigh".to_owned(), rsx!(Icon { icon: MdEdgesensorHigh, width: width, height: height })));
    icons.push(("MdEdgesensorLow".to_owned(), rsx!(Icon { icon: MdEdgesensorLow, width: width, height: height })));
    icons.push(("MdFlashlightOff".to_owned(), rsx!(Icon { icon: MdFlashlightOff, width: width, height: height })));
    icons.push(("MdFlashlightOn".to_owned(), rsx!(Icon { icon: MdFlashlightOn, width: width, height: height })));
    icons.push(("MdFlourescent".to_owned(), rsx!(Icon { icon: MdFlourescent, width: width, height: height })));
    icons.push(("MdFluorescent".to_owned(), rsx!(Icon { icon: MdFluorescent, width: width, height: height })));
    icons.push(("MdFmdBad".to_owned(), rsx!(Icon { icon: MdFmdBad, width: width, height: height })));
    icons.push(("MdFmdGood".to_owned(), rsx!(Icon { icon: MdFmdGood, width: width, height: height })));
    icons.push(("MdGMobiledata".to_owned(), rsx!(Icon { icon: MdGMobiledata, width: width, height: height })));
    icons.push(("MdGppBad".to_owned(), rsx!(Icon { icon: MdGppBad, width: width, height: height })));
    icons.push(("MdGppGood".to_owned(), rsx!(Icon { icon: MdGppGood, width: width, height: height })));
    icons.push(("MdGppMaybe".to_owned(), rsx!(Icon { icon: MdGppMaybe, width: width, height: height })));
    icons.push(("MdGpsFixed".to_owned(), rsx!(Icon { icon: MdGpsFixed, width: width, height: height })));
    icons.push(("MdGpsNotFixed".to_owned(), rsx!(Icon { icon: MdGpsNotFixed, width: width, height: height })));
    icons.push(("MdGpsOff".to_owned(), rsx!(Icon { icon: MdGpsOff, width: width, height: height })));
    icons.push(("MdGraphicEq".to_owned(), rsx!(Icon { icon: MdGraphicEq, width: width, height: height })));
    icons.push(("MdGrid3x3".to_owned(), rsx!(Icon { icon: MdGrid3x3, width: width, height: height })));
    icons.push(("MdGrid4x4".to_owned(), rsx!(Icon { icon: MdGrid4x4, width: width, height: height })));
    icons.push(("MdGridGoldenratio".to_owned(), rsx!(Icon { icon: MdGridGoldenratio, width: width, height: height })));
    icons.push(("MdHMobiledata".to_owned(), rsx!(Icon { icon: MdHMobiledata, width: width, height: height })));
    icons.push(("MdHPlusMobiledata".to_owned(), rsx!(Icon { icon: MdHPlusMobiledata, width: width, height: height })));
    icons.push(("MdHdrAuto".to_owned(), rsx!(Icon { icon: MdHdrAuto, width: width, height: height })));
    icons.push(("MdHdrAutoSelect".to_owned(), rsx!(Icon { icon: MdHdrAutoSelect, width: width, height: height })));
    icons.push(("MdHdrOffSelect".to_owned(), rsx!(Icon { icon: MdHdrOffSelect, width: width, height: height })));
    icons.push(("MdHdrOnSelect".to_owned(), rsx!(Icon { icon: MdHdrOnSelect, width: width, height: height })));
    icons.push(("MdLan".to_owned(), rsx!(Icon { icon: MdLan, width: width, height: height })));
    icons.push(("MdLensBlur".to_owned(), rsx!(Icon { icon: MdLensBlur, width: width, height: height })));
    icons.push(("MdLightMode".to_owned(), rsx!(Icon { icon: MdLightMode, width: width, height: height })));
    icons.push(("MdLocationDisabled".to_owned(), rsx!(Icon { icon: MdLocationDisabled, width: width, height: height })));
    icons.push(("MdLocationSearching".to_owned(), rsx!(Icon { icon: MdLocationSearching, width: width, height: height })));
    icons.push(("MdLteMobiledata".to_owned(), rsx!(Icon { icon: MdLteMobiledata, width: width, height: height })));
    icons.push(("MdLtePlusMobiledata".to_owned(), rsx!(Icon { icon: MdLtePlusMobiledata, width: width, height: height })));
    icons.push(("MdMacroOff".to_owned(), rsx!(Icon { icon: MdMacroOff, width: width, height: height })));
    icons.push(("MdMediaBluetoothOff".to_owned(), rsx!(Icon { icon: MdMediaBluetoothOff, width: width, height: height })));
    icons.push(("MdMediaBluetoothOn".to_owned(), rsx!(Icon { icon: MdMediaBluetoothOn, width: width, height: height })));
    icons.push(("MdMedication".to_owned(), rsx!(Icon { icon: MdMedication, width: width, height: height })));
    icons.push(("MdMedicationLiquid".to_owned(), rsx!(Icon { icon: MdMedicationLiquid, width: width, height: height })));
    icons.push(("MdMobileFriendly".to_owned(), rsx!(Icon { icon: MdMobileFriendly, width: width, height: height })));
    icons.push(("MdMobileOff".to_owned(), rsx!(Icon { icon: MdMobileOff, width: width, height: height })));
    icons.push(("MdMobiledataOff".to_owned(), rsx!(Icon { icon: MdMobiledataOff, width: width, height: height })));
    icons.push(("MdModeNight".to_owned(), rsx!(Icon { icon: MdModeNight, width: width, height: height })));
    icons.push(("MdModeStandby".to_owned(), rsx!(Icon { icon: MdModeStandby, width: width, height: height })));
    icons.push(("MdMonitorHeart".to_owned(), rsx!(Icon { icon: MdMonitorHeart, width: width, height: height })));
    icons.push(("MdMonitorWeight".to_owned(), rsx!(Icon { icon: MdMonitorWeight, width: width, height: height })));
    icons.push(("MdNearbyError".to_owned(), rsx!(Icon { icon: MdNearbyError, width: width, height: height })));
    icons.push(("MdNearbyOff".to_owned(), rsx!(Icon { icon: MdNearbyOff, width: width, height: height })));
    icons.push(("MdNetworkCell".to_owned(), rsx!(Icon { icon: MdNetworkCell, width: width, height: height })));
    icons.push(("MdNetworkWifi".to_owned(), rsx!(Icon { icon: MdNetworkWifi, width: width, height: height })));
    icons.push(("MdNetworkWifi1Bar".to_owned(), rsx!(Icon { icon: MdNetworkWifi1Bar, width: width, height: height })));
    icons.push(("MdNetworkWifi2Bar".to_owned(), rsx!(Icon { icon: MdNetworkWifi2Bar, width: width, height: height })));
    icons.push(("MdNetworkWifi3Bar".to_owned(), rsx!(Icon { icon: MdNetworkWifi3Bar, width: width, height: height })));
    icons.push(("MdNfc".to_owned(), rsx!(Icon { icon: MdNfc, width: width, height: height })));
    icons.push(("MdNightlight".to_owned(), rsx!(Icon { icon: MdNightlight, width: width, height: height })));
    icons.push(("MdNoteAlt".to_owned(), rsx!(Icon { icon: MdNoteAlt, width: width, height: height })));
    icons.push(("MdPassword".to_owned(), rsx!(Icon { icon: MdPassword, width: width, height: height })));
    icons.push(("MdPattern".to_owned(), rsx!(Icon { icon: MdPattern, width: width, height: height })));
    icons.push(("MdPhishing".to_owned(), rsx!(Icon { icon: MdPhishing, width: width, height: height })));
    icons.push(("MdPin".to_owned(), rsx!(Icon { icon: MdPin, width: width, height: height })));
    icons.push(("MdPlayLesson".to_owned(), rsx!(Icon { icon: MdPlayLesson, width: width, height: height })));
    icons.push(("MdPriceChange".to_owned(), rsx!(Icon { icon: MdPriceChange, width: width, height: height })));
    icons.push(("MdPriceCheck".to_owned(), rsx!(Icon { icon: MdPriceCheck, width: width, height: height })));
    icons.push(("MdPunchClock".to_owned(), rsx!(Icon { icon: MdPunchClock, width: width, height: height })));
    icons.push(("MdQuiz".to_owned(), rsx!(Icon { icon: MdQuiz, width: width, height: height })));
    icons.push(("MdRMobiledata".to_owned(), rsx!(Icon { icon: MdRMobiledata, width: width, height: height })));
    icons.push(("MdRadar".to_owned(), rsx!(Icon { icon: MdRadar, width: width, height: height })));
    icons.push(("MdRememberMe".to_owned(), rsx!(Icon { icon: MdRememberMe, width: width, height: height })));
    icons.push(("MdResetTv".to_owned(), rsx!(Icon { icon: MdResetTv, width: width, height: height })));
    icons.push(("MdRestartAlt".to_owned(), rsx!(Icon { icon: MdRestartAlt, width: width, height: height })));
    icons.push(("MdReviews".to_owned(), rsx!(Icon { icon: MdReviews, width: width, height: height })));
    icons.push(("MdRsvp".to_owned(), rsx!(Icon { icon: MdRsvp, width: width, height: height })));
    icons.push(("MdScreenLockLandscape".to_owned(), rsx!(Icon { icon: MdScreenLockLandscape, width: width, height: height })));
    icons.push(("MdScreenLockPortrait".to_owned(), rsx!(Icon { icon: MdScreenLockPortrait, width: width, height: height })));
    icons.push(("MdScreenLockRotation".to_owned(), rsx!(Icon { icon: MdScreenLockRotation, width: width, height: height })));
    icons.push(("MdScreenRotation".to_owned(), rsx!(Icon { icon: MdScreenRotation, width: width, height: height })));
    icons.push(("MdScreenSearchDesktop".to_owned(), rsx!(Icon { icon: MdScreenSearchDesktop, width: width, height: height })));
    icons.push(("MdScreenshot".to_owned(), rsx!(Icon { icon: MdScreenshot, width: width, height: height })));
    icons.push(("MdScreenshotMonitor".to_owned(), rsx!(Icon { icon: MdScreenshotMonitor, width: width, height: height })));
    icons.push(("MdSdStorage".to_owned(), rsx!(Icon { icon: MdSdStorage, width: width, height: height })));
    icons.push(("MdSecurityUpdate".to_owned(), rsx!(Icon { icon: MdSecurityUpdate, width: width, height: height })));
    icons.push(("MdSecurityUpdateGood".to_owned(), rsx!(Icon { icon: MdSecurityUpdateGood, width: width, height: height })));
    icons.push(("MdSecurityUpdateWarning".to_owned(), rsx!(Icon { icon: MdSecurityUpdateWarning, width: width, height: height })));
    icons.push(("MdSell".to_owned(), rsx!(Icon { icon: MdSell, width: width, height: height })));
    icons.push(("MdSendToMobile".to_owned(), rsx!(Icon { icon: MdSendToMobile, width: width, height: height })));
    icons.push(("MdSettingsSuggest".to_owned(), rsx!(Icon { icon: MdSettingsSuggest, width: width, height: height })));
    icons.push(("MdSettingsSystemDaydream".to_owned(), rsx!(Icon { icon: MdSettingsSystemDaydream, width: width, height: height })));
    icons.push(("MdShareLocation".to_owned(), rsx!(Icon { icon: MdShareLocation, width: width, height: height })));
    icons.push(("MdShortcut".to_owned(), rsx!(Icon { icon: MdShortcut, width: width, height: height })));
    icons.push(("MdSignalCellular0Bar".to_owned(), rsx!(Icon { icon: MdSignalCellular0Bar, width: width, height: height })));
    icons.push(("MdSignalCellular4Bar".to_owned(), rsx!(Icon { icon: MdSignalCellular4Bar, width: width, height: height })));
    icons.push(("MdSignalCellularAlt".to_owned(), rsx!(Icon { icon: MdSignalCellularAlt, width: width, height: height })));
    icons.push(("MdSignalCellularAlt1Bar".to_owned(), rsx!(Icon { icon: MdSignalCellularAlt1Bar, width: width, height: height })));
    icons.push(("MdSignalCellularAlt2Bar".to_owned(), rsx!(Icon { icon: MdSignalCellularAlt2Bar, width: width, height: height })));
    icons.push(("MdSignalCellularConnectedNoInternet0Bar".to_owned(), rsx!(Icon { icon: MdSignalCellularConnectedNoInternet0Bar, width: width, height: height })));
    icons.push(("MdSignalCellularConnectedNoInternet4Bar".to_owned(), rsx!(Icon { icon: MdSignalCellularConnectedNoInternet4Bar, width: width, height: height })));
    icons.push(("MdSignalCellularNoSim".to_owned(), rsx!(Icon { icon: MdSignalCellularNoSim, width: width, height: height })));
    icons.push(("MdSignalCellularNodata".to_owned(), rsx!(Icon { icon: MdSignalCellularNodata, width: width, height: height })));
    icons.push(("MdSignalCellularNull".to_owned(), rsx!(Icon { icon: MdSignalCellularNull, width: width, height: height })));
    icons.push(("MdSignalCellularOff".to_owned(), rsx!(Icon { icon: MdSignalCellularOff, width: width, height: height })));
    icons.push(("MdSignalWifi0Bar".to_owned(), rsx!(Icon { icon: MdSignalWifi0Bar, width: width, height: height })));
    icons.push(("MdSignalWifi4Bar".to_owned(), rsx!(Icon { icon: MdSignalWifi4Bar, width: width, height: height })));
    icons.push(("MdSignalWifi4BarLock".to_owned(), rsx!(Icon { icon: MdSignalWifi4BarLock, width: width, height: height })));
    icons.push(("MdSignalWifiBad".to_owned(), rsx!(Icon { icon: MdSignalWifiBad, width: width, height: height })));
    icons.push(("MdSignalWifiConnectedNoInternet4".to_owned(), rsx!(Icon { icon: MdSignalWifiConnectedNoInternet4, width: width, height: height })));
    icons.push(("MdSignalWifiOff".to_owned(), rsx!(Icon { icon: MdSignalWifiOff, width: width, height: height })));
    icons.push(("MdSignalWifiStatusbar4Bar".to_owned(), rsx!(Icon { icon: MdSignalWifiStatusbar4Bar, width: width, height: height })));
    icons.push(("MdSignalWifiStatusbarConnectedNoInternet4".to_owned(), rsx!(Icon { icon: MdSignalWifiStatusbarConnectedNoInternet4, width: width, height: height })));
    icons.push(("MdSignalWifiStatusbarNull".to_owned(), rsx!(Icon { icon: MdSignalWifiStatusbarNull, width: width, height: height })));
    icons.push(("MdSimCardDownload".to_owned(), rsx!(Icon { icon: MdSimCardDownload, width: width, height: height })));
    icons.push(("MdSplitscreen".to_owned(), rsx!(Icon { icon: MdSplitscreen, width: width, height: height })));
    icons.push(("MdSportsScore".to_owned(), rsx!(Icon { icon: MdSportsScore, width: width, height: height })));
    icons.push(("MdSsidChart".to_owned(), rsx!(Icon { icon: MdSsidChart, width: width, height: height })));
    icons.push(("MdStorage".to_owned(), rsx!(Icon { icon: MdStorage, width: width, height: height })));
    icons.push(("MdStorm".to_owned(), rsx!(Icon { icon: MdStorm, width: width, height: height })));
    icons.push(("MdSummarize".to_owned(), rsx!(Icon { icon: MdSummarize, width: width, height: height })));
    icons.push(("MdSystemSecurityUpdate".to_owned(), rsx!(Icon { icon: MdSystemSecurityUpdate, width: width, height: height })));
    icons.push(("MdSystemSecurityUpdateGood".to_owned(), rsx!(Icon { icon: MdSystemSecurityUpdateGood, width: width, height: height })));
    icons.push(("MdSystemSecurityUpdateWarning".to_owned(), rsx!(Icon { icon: MdSystemSecurityUpdateWarning, width: width, height: height })));
    icons.push(("MdTask".to_owned(), rsx!(Icon { icon: MdTask, width: width, height: height })));
    icons.push(("MdThermostat".to_owned(), rsx!(Icon { icon: MdThermostat, width: width, height: height })));
    icons.push(("MdTimer10Select".to_owned(), rsx!(Icon { icon: MdTimer10Select, width: width, height: height })));
    icons.push(("MdTimer3Select".to_owned(), rsx!(Icon { icon: MdTimer3Select, width: width, height: height })));
    icons.push(("MdTungsten".to_owned(), rsx!(Icon { icon: MdTungsten, width: width, height: height })));
    icons.push(("MdUsb".to_owned(), rsx!(Icon { icon: MdUsb, width: width, height: height })));
    icons.push(("MdUsbOff".to_owned(), rsx!(Icon { icon: MdUsbOff, width: width, height: height })));
    icons.push(("MdWallpaper".to_owned(), rsx!(Icon { icon: MdWallpaper, width: width, height: height })));
    icons.push(("MdWater".to_owned(), rsx!(Icon { icon: MdWater, width: width, height: height })));
    icons.push(("MdWidgets".to_owned(), rsx!(Icon { icon: MdWidgets, width: width, height: height })));
    icons.push(("MdWifi1Bar".to_owned(), rsx!(Icon { icon: MdWifi1Bar, width: width, height: height })));
    icons.push(("MdWifi2Bar".to_owned(), rsx!(Icon { icon: MdWifi2Bar, width: width, height: height })));
    icons.push(("MdWifiCalling3".to_owned(), rsx!(Icon { icon: MdWifiCalling3, width: width, height: height })));
    icons.push(("MdWifiChannel".to_owned(), rsx!(Icon { icon: MdWifiChannel, width: width, height: height })));
    icons.push(("MdWifiFind".to_owned(), rsx!(Icon { icon: MdWifiFind, width: width, height: height })));
    icons.push(("MdWifiLock".to_owned(), rsx!(Icon { icon: MdWifiLock, width: width, height: height })));
    icons.push(("MdWifiPassword".to_owned(), rsx!(Icon { icon: MdWifiPassword, width: width, height: height })));
    icons.push(("MdWifiTethering".to_owned(), rsx!(Icon { icon: MdWifiTethering, width: width, height: height })));
    icons.push(("MdWifiTetheringError".to_owned(), rsx!(Icon { icon: MdWifiTetheringError, width: width, height: height })));
    icons.push(("MdWifiTetheringErrorRounded".to_owned(), rsx!(Icon { icon: MdWifiTetheringErrorRounded, width: width, height: height })));
    icons.push(("MdWifiTetheringOff".to_owned(), rsx!(Icon { icon: MdWifiTetheringOff, width: width, height: height })));
    icons
}}
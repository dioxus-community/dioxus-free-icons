...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("Md123".to_owned(), rsx!(Icon { icon: Md123, width: width, height: height })));
    icons.push(("Md3dRotation".to_owned(), rsx!(Icon { icon: Md3dRotation, width: width, height: height })));
    icons.push(("MdAbc".to_owned(), rsx!(Icon { icon: MdAbc, width: width, height: height })));
    icons.push(("MdAccessibility".to_owned(), rsx!(Icon { icon: MdAccessibility, width: width, height: height })));
    icons.push(("MdAccessibilityNew".to_owned(), rsx!(Icon { icon: MdAccessibilityNew, width: width, height: height })));
    icons.push(("MdAccessible".to_owned(), rsx!(Icon { icon: MdAccessible, width: width, height: height })));
    icons.push(("MdAccessibleForward".to_owned(), rsx!(Icon { icon: MdAccessibleForward, width: width, height: height })));
    icons.push(("MdAccountBalance".to_owned(), rsx!(Icon { icon: MdAccountBalance, width: width, height: height })));
    icons.push(("MdAccountBalanceWallet".to_owned(), rsx!(Icon { icon: MdAccountBalanceWallet, width: width, height: height })));
    icons.push(("MdAccountBox".to_owned(), rsx!(Icon { icon: MdAccountBox, width: width, height: height })));
    icons.push(("MdAccountCircle".to_owned(), rsx!(Icon { icon: MdAccountCircle, width: width, height: height })));
    icons.push(("MdAddCard".to_owned(), rsx!(Icon { icon: MdAddCard, width: width, height: height })));
    icons.push(("MdAddHome".to_owned(), rsx!(Icon { icon: MdAddHome, width: width, height: height })));
    icons.push(("MdAddShoppingCart".to_owned(), rsx!(Icon { icon: MdAddShoppingCart, width: width, height: height })));
    icons.push(("MdAddTask".to_owned(), rsx!(Icon { icon: MdAddTask, width: width, height: height })));
    icons.push(("MdAddToDrive".to_owned(), rsx!(Icon { icon: MdAddToDrive, width: width, height: height })));
    icons.push(("MdAddchart".to_owned(), rsx!(Icon { icon: MdAddchart, width: width, height: height })));
    icons.push(("MdAdminPanelSettings".to_owned(), rsx!(Icon { icon: MdAdminPanelSettings, width: width, height: height })));
    icons.push(("MdAdsClick".to_owned(), rsx!(Icon { icon: MdAdsClick, width: width, height: height })));
    icons.push(("MdAlarm".to_owned(), rsx!(Icon { icon: MdAlarm, width: width, height: height })));
    icons.push(("MdAlarmAdd".to_owned(), rsx!(Icon { icon: MdAlarmAdd, width: width, height: height })));
    icons.push(("MdAlarmOff".to_owned(), rsx!(Icon { icon: MdAlarmOff, width: width, height: height })));
    icons.push(("MdAlarmOn".to_owned(), rsx!(Icon { icon: MdAlarmOn, width: width, height: height })));
    icons.push(("MdAllInbox".to_owned(), rsx!(Icon { icon: MdAllInbox, width: width, height: height })));
    icons.push(("MdAllOut".to_owned(), rsx!(Icon { icon: MdAllOut, width: width, height: height })));
    icons.push(("MdAnalytics".to_owned(), rsx!(Icon { icon: MdAnalytics, width: width, height: height })));
    icons.push(("MdAnchor".to_owned(), rsx!(Icon { icon: MdAnchor, width: width, height: height })));
    icons.push(("MdAndroid".to_owned(), rsx!(Icon { icon: MdAndroid, width: width, height: height })));
    icons.push(("MdAnnouncement".to_owned(), rsx!(Icon { icon: MdAnnouncement, width: width, height: height })));
    icons.push(("MdApi".to_owned(), rsx!(Icon { icon: MdApi, width: width, height: height })));
    icons.push(("MdAppBlocking".to_owned(), rsx!(Icon { icon: MdAppBlocking, width: width, height: height })));
    icons.push(("MdAppShortcut".to_owned(), rsx!(Icon { icon: MdAppShortcut, width: width, height: height })));
    icons.push(("MdArrowCircleDown".to_owned(), rsx!(Icon { icon: MdArrowCircleDown, width: width, height: height })));
    icons.push(("MdArrowCircleLeft".to_owned(), rsx!(Icon { icon: MdArrowCircleLeft, width: width, height: height })));
    icons.push(("MdArrowCircleRight".to_owned(), rsx!(Icon { icon: MdArrowCircleRight, width: width, height: height })));
    icons.push(("MdArrowCircleUp".to_owned(), rsx!(Icon { icon: MdArrowCircleUp, width: width, height: height })));
    icons.push(("MdArrowOutward".to_owned(), rsx!(Icon { icon: MdArrowOutward, width: width, height: height })));
    icons.push(("MdArrowRightAlt".to_owned(), rsx!(Icon { icon: MdArrowRightAlt, width: width, height: height })));
    icons.push(("MdArticle".to_owned(), rsx!(Icon { icon: MdArticle, width: width, height: height })));
    icons.push(("MdAspectRatio".to_owned(), rsx!(Icon { icon: MdAspectRatio, width: width, height: height })));
    icons.push(("MdAssessment".to_owned(), rsx!(Icon { icon: MdAssessment, width: width, height: height })));
    icons.push(("MdAssignment".to_owned(), rsx!(Icon { icon: MdAssignment, width: width, height: height })));
    icons.push(("MdAssignmentAdd".to_owned(), rsx!(Icon { icon: MdAssignmentAdd, width: width, height: height })));
    icons.push(("MdAssignmentInd".to_owned(), rsx!(Icon { icon: MdAssignmentInd, width: width, height: height })));
    icons.push(("MdAssignmentLate".to_owned(), rsx!(Icon { icon: MdAssignmentLate, width: width, height: height })));
    icons.push(("MdAssignmentReturn".to_owned(), rsx!(Icon { icon: MdAssignmentReturn, width: width, height: height })));
    icons.push(("MdAssignmentReturned".to_owned(), rsx!(Icon { icon: MdAssignmentReturned, width: width, height: height })));
    icons.push(("MdAssignmentTurnedIn".to_owned(), rsx!(Icon { icon: MdAssignmentTurnedIn, width: width, height: height })));
    icons.push(("MdAssuredWorkload".to_owned(), rsx!(Icon { icon: MdAssuredWorkload, width: width, height: height })));
    icons.push(("MdAutorenew".to_owned(), rsx!(Icon { icon: MdAutorenew, width: width, height: height })));
    icons.push(("MdBackup".to_owned(), rsx!(Icon { icon: MdBackup, width: width, height: height })));
    icons.push(("MdBackupTable".to_owned(), rsx!(Icon { icon: MdBackupTable, width: width, height: height })));
    icons.push(("MdBalance".to_owned(), rsx!(Icon { icon: MdBalance, width: width, height: height })));
    icons.push(("MdBarcodeReader".to_owned(), rsx!(Icon { icon: MdBarcodeReader, width: width, height: height })));
    icons.push(("MdBatchPrediction".to_owned(), rsx!(Icon { icon: MdBatchPrediction, width: width, height: height })));
    icons.push(("MdBook".to_owned(), rsx!(Icon { icon: MdBook, width: width, height: height })));
    icons.push(("MdBookOnline".to_owned(), rsx!(Icon { icon: MdBookOnline, width: width, height: height })));
    icons.push(("MdBookmark".to_owned(), rsx!(Icon { icon: MdBookmark, width: width, height: height })));
    icons.push(("MdBookmarkAdd".to_owned(), rsx!(Icon { icon: MdBookmarkAdd, width: width, height: height })));
    icons.push(("MdBookmarkAdded".to_owned(), rsx!(Icon { icon: MdBookmarkAdded, width: width, height: height })));
    icons.push(("MdBookmarkBorder".to_owned(), rsx!(Icon { icon: MdBookmarkBorder, width: width, height: height })));
    icons.push(("MdBookmarkRemove".to_owned(), rsx!(Icon { icon: MdBookmarkRemove, width: width, height: height })));
    icons.push(("MdBookmarks".to_owned(), rsx!(Icon { icon: MdBookmarks, width: width, height: height })));
    icons.push(("MdBrowseGallery".to_owned(), rsx!(Icon { icon: MdBrowseGallery, width: width, height: height })));
    icons.push(("MdBugReport".to_owned(), rsx!(Icon { icon: MdBugReport, width: width, height: height })));
    icons.push(("MdBuild".to_owned(), rsx!(Icon { icon: MdBuild, width: width, height: height })));
    icons.push(("MdBuildCircle".to_owned(), rsx!(Icon { icon: MdBuildCircle, width: width, height: height })));
    icons.push(("MdCached".to_owned(), rsx!(Icon { icon: MdCached, width: width, height: height })));
    icons.push(("MdCalendarMonth".to_owned(), rsx!(Icon { icon: MdCalendarMonth, width: width, height: height })));
    icons.push(("MdCalendarToday".to_owned(), rsx!(Icon { icon: MdCalendarToday, width: width, height: height })));
    icons.push(("MdCalendarViewDay".to_owned(), rsx!(Icon { icon: MdCalendarViewDay, width: width, height: height })));
    icons.push(("MdCalendarViewMonth".to_owned(), rsx!(Icon { icon: MdCalendarViewMonth, width: width, height: height })));
    icons.push(("MdCalendarViewWeek".to_owned(), rsx!(Icon { icon: MdCalendarViewWeek, width: width, height: height })));
    icons.push(("MdCameraEnhance".to_owned(), rsx!(Icon { icon: MdCameraEnhance, width: width, height: height })));
    icons.push(("MdCancelScheduleSend".to_owned(), rsx!(Icon { icon: MdCancelScheduleSend, width: width, height: height })));
    icons.push(("MdCardGiftcard".to_owned(), rsx!(Icon { icon: MdCardGiftcard, width: width, height: height })));
    icons.push(("MdCardMembership".to_owned(), rsx!(Icon { icon: MdCardMembership, width: width, height: height })));
    icons.push(("MdCardTravel".to_owned(), rsx!(Icon { icon: MdCardTravel, width: width, height: height })));
    icons.push(("MdChangeHistory".to_owned(), rsx!(Icon { icon: MdChangeHistory, width: width, height: height })));
    icons.push(("MdCheckCircle".to_owned(), rsx!(Icon { icon: MdCheckCircle, width: width, height: height })));
    icons.push(("MdCheckCircleOutline".to_owned(), rsx!(Icon { icon: MdCheckCircleOutline, width: width, height: height })));
    icons.push(("MdChromeReaderMode".to_owned(), rsx!(Icon { icon: MdChromeReaderMode, width: width, height: height })));
    icons.push(("MdCircleNotifications".to_owned(), rsx!(Icon { icon: MdCircleNotifications, width: width, height: height })));
    icons.push(("MdClass".to_owned(), rsx!(Icon { icon: MdClass, width: width, height: height })));
    icons.push(("MdCloseFullscreen".to_owned(), rsx!(Icon { icon: MdCloseFullscreen, width: width, height: height })));
    icons.push(("MdCode".to_owned(), rsx!(Icon { icon: MdCode, width: width, height: height })));
    icons.push(("MdCodeOff".to_owned(), rsx!(Icon { icon: MdCodeOff, width: width, height: height })));
    icons.push(("MdCommentBank".to_owned(), rsx!(Icon { icon: MdCommentBank, width: width, height: height })));
    icons.push(("MdCommit".to_owned(), rsx!(Icon { icon: MdCommit, width: width, height: height })));
    icons.push(("MdCommute".to_owned(), rsx!(Icon { icon: MdCommute, width: width, height: height })));
    icons.push(("MdCompareArrows".to_owned(), rsx!(Icon { icon: MdCompareArrows, width: width, height: height })));
    icons.push(("MdCompress".to_owned(), rsx!(Icon { icon: MdCompress, width: width, height: height })));
    icons.push(("MdContactPage".to_owned(), rsx!(Icon { icon: MdContactPage, width: width, height: height })));
    icons.push(("MdContactSupport".to_owned(), rsx!(Icon { icon: MdContactSupport, width: width, height: height })));
    icons.push(("MdContactless".to_owned(), rsx!(Icon { icon: MdContactless, width: width, height: height })));
    icons.push(("MdCopyright".to_owned(), rsx!(Icon { icon: MdCopyright, width: width, height: height })));
    icons.push(("MdCreditCard".to_owned(), rsx!(Icon { icon: MdCreditCard, width: width, height: height })));
    icons.push(("MdCreditCardOff".to_owned(), rsx!(Icon { icon: MdCreditCardOff, width: width, height: height })));
    icons.push(("MdCss".to_owned(), rsx!(Icon { icon: MdCss, width: width, height: height })));
    icons.push(("MdCurrencyExchange".to_owned(), rsx!(Icon { icon: MdCurrencyExchange, width: width, height: height })));
    icons.push(("MdDangerous".to_owned(), rsx!(Icon { icon: MdDangerous, width: width, height: height })));
    icons.push(("MdDashboard".to_owned(), rsx!(Icon { icon: MdDashboard, width: width, height: height })));
    icons.push(("MdDashboardCustomize".to_owned(), rsx!(Icon { icon: MdDashboardCustomize, width: width, height: height })));
    icons.push(("MdDataExploration".to_owned(), rsx!(Icon { icon: MdDataExploration, width: width, height: height })));
    icons.push(("MdDataThresholding".to_owned(), rsx!(Icon { icon: MdDataThresholding, width: width, height: height })));
    icons.push(("MdDateRange".to_owned(), rsx!(Icon { icon: MdDateRange, width: width, height: height })));
    icons.push(("MdDelete".to_owned(), rsx!(Icon { icon: MdDelete, width: width, height: height })));
    icons.push(("MdDeleteForever".to_owned(), rsx!(Icon { icon: MdDeleteForever, width: width, height: height })));
    icons.push(("MdDeleteOutline".to_owned(), rsx!(Icon { icon: MdDeleteOutline, width: width, height: height })));
    icons.push(("MdDensityLarge".to_owned(), rsx!(Icon { icon: MdDensityLarge, width: width, height: height })));
    icons.push(("MdDensityMedium".to_owned(), rsx!(Icon { icon: MdDensityMedium, width: width, height: height })));
    icons.push(("MdDensitySmall".to_owned(), rsx!(Icon { icon: MdDensitySmall, width: width, height: height })));
    icons.push(("MdDescription".to_owned(), rsx!(Icon { icon: MdDescription, width: width, height: height })));
    icons.push(("MdDisabledByDefault".to_owned(), rsx!(Icon { icon: MdDisabledByDefault, width: width, height: height })));
    icons.push(("MdDisabledVisible".to_owned(), rsx!(Icon { icon: MdDisabledVisible, width: width, height: height })));
    icons.push(("MdDisplaySettings".to_owned(), rsx!(Icon { icon: MdDisplaySettings, width: width, height: height })));
    icons.push(("MdDns".to_owned(), rsx!(Icon { icon: MdDns, width: width, height: height })));
    icons.push(("MdDone".to_owned(), rsx!(Icon { icon: MdDone, width: width, height: height })));
    icons.push(("MdDoneAll".to_owned(), rsx!(Icon { icon: MdDoneAll, width: width, height: height })));
    icons.push(("MdDoneOutline".to_owned(), rsx!(Icon { icon: MdDoneOutline, width: width, height: height })));
    icons.push(("MdDonutLarge".to_owned(), rsx!(Icon { icon: MdDonutLarge, width: width, height: height })));
    icons.push(("MdDonutSmall".to_owned(), rsx!(Icon { icon: MdDonutSmall, width: width, height: height })));
    icons.push(("MdDragIndicator".to_owned(), rsx!(Icon { icon: MdDragIndicator, width: width, height: height })));
    icons.push(("MdDynamicForm".to_owned(), rsx!(Icon { icon: MdDynamicForm, width: width, height: height })));
    icons.push(("MdEco".to_owned(), rsx!(Icon { icon: MdEco, width: width, height: height })));
    icons.push(("MdEditCalendar".to_owned(), rsx!(Icon { icon: MdEditCalendar, width: width, height: height })));
    icons.push(("MdEditDocument".to_owned(), rsx!(Icon { icon: MdEditDocument, width: width, height: height })));
    icons.push(("MdEditOff".to_owned(), rsx!(Icon { icon: MdEditOff, width: width, height: height })));
    icons.push(("MdEditSquare".to_owned(), rsx!(Icon { icon: MdEditSquare, width: width, height: height })));
    icons.push(("MdEject".to_owned(), rsx!(Icon { icon: MdEject, width: width, height: height })));
    icons.push(("MdEuroSymbol".to_owned(), rsx!(Icon { icon: MdEuroSymbol, width: width, height: height })));
    icons.push(("MdEvent".to_owned(), rsx!(Icon { icon: MdEvent, width: width, height: height })));
    icons.push(("MdEventRepeat".to_owned(), rsx!(Icon { icon: MdEventRepeat, width: width, height: height })));
    icons.push(("MdEventSeat".to_owned(), rsx!(Icon { icon: MdEventSeat, width: width, height: height })));
    icons.push(("MdExitToApp".to_owned(), rsx!(Icon { icon: MdExitToApp, width: width, height: height })));
    icons.push(("MdExpand".to_owned(), rsx!(Icon { icon: MdExpand, width: width, height: height })));
    icons.push(("MdExplore".to_owned(), rsx!(Icon { icon: MdExplore, width: width, height: height })));
    icons.push(("MdExploreOff".to_owned(), rsx!(Icon { icon: MdExploreOff, width: width, height: height })));
    icons.push(("MdExtension".to_owned(), rsx!(Icon { icon: MdExtension, width: width, height: height })));
    icons.push(("MdExtensionOff".to_owned(), rsx!(Icon { icon: MdExtensionOff, width: width, height: height })));
    icons.push(("MdFace".to_owned(), rsx!(Icon { icon: MdFace, width: width, height: height })));
    icons.push(("MdFactCheck".to_owned(), rsx!(Icon { icon: MdFactCheck, width: width, height: height })));
    icons.push(("MdFavorite".to_owned(), rsx!(Icon { icon: MdFavorite, width: width, height: height })));
    icons.push(("MdFavoriteBorder".to_owned(), rsx!(Icon { icon: MdFavoriteBorder, width: width, height: height })));
    icons.push(("MdFax".to_owned(), rsx!(Icon { icon: MdFax, width: width, height: height })));
    icons.push(("MdFeedback".to_owned(), rsx!(Icon { icon: MdFeedback, width: width, height: height })));
    icons.push(("MdFilePresent".to_owned(), rsx!(Icon { icon: MdFilePresent, width: width, height: height })));
    icons.push(("MdFilterAlt".to_owned(), rsx!(Icon { icon: MdFilterAlt, width: width, height: height })));
    icons.push(("MdFilterAltOff".to_owned(), rsx!(Icon { icon: MdFilterAltOff, width: width, height: height })));
    icons.push(("MdFilterListAlt".to_owned(), rsx!(Icon { icon: MdFilterListAlt, width: width, height: height })));
    icons.push(("MdFindInPage".to_owned(), rsx!(Icon { icon: MdFindInPage, width: width, height: height })));
    icons.push(("MdFindReplace".to_owned(), rsx!(Icon { icon: MdFindReplace, width: width, height: height })));
    icons.push(("MdFingerprint".to_owned(), rsx!(Icon { icon: MdFingerprint, width: width, height: height })));
    icons.push(("MdFitScreen".to_owned(), rsx!(Icon { icon: MdFitScreen, width: width, height: height })));
    icons.push(("MdFlaky".to_owned(), rsx!(Icon { icon: MdFlaky, width: width, height: height })));
    icons.push(("MdFlightLand".to_owned(), rsx!(Icon { icon: MdFlightLand, width: width, height: height })));
    icons.push(("MdFlightTakeoff".to_owned(), rsx!(Icon { icon: MdFlightTakeoff, width: width, height: height })));
    icons.push(("MdFlipToBack".to_owned(), rsx!(Icon { icon: MdFlipToBack, width: width, height: height })));
    icons.push(("MdFlipToFront".to_owned(), rsx!(Icon { icon: MdFlipToFront, width: width, height: height })));
    icons.push(("MdFlutterDash".to_owned(), rsx!(Icon { icon: MdFlutterDash, width: width, height: height })));
    icons.push(("MdFreeCancellation".to_owned(), rsx!(Icon { icon: MdFreeCancellation, width: width, height: height })));
    icons.push(("MdGTranslate".to_owned(), rsx!(Icon { icon: MdGTranslate, width: width, height: height })));
    icons.push(("MdGavel".to_owned(), rsx!(Icon { icon: MdGavel, width: width, height: height })));
    icons.push(("MdGeneratingTokens".to_owned(), rsx!(Icon { icon: MdGeneratingTokens, width: width, height: height })));
    icons.push(("MdGetApp".to_owned(), rsx!(Icon { icon: MdGetApp, width: width, height: height })));
    icons.push(("MdGif".to_owned(), rsx!(Icon { icon: MdGif, width: width, height: height })));
    icons.push(("MdGifBox".to_owned(), rsx!(Icon { icon: MdGifBox, width: width, height: height })));
    icons.push(("MdGrade".to_owned(), rsx!(Icon { icon: MdGrade, width: width, height: height })));
    icons.push(("MdGrading".to_owned(), rsx!(Icon { icon: MdGrading, width: width, height: height })));
    icons.push(("MdGroupWork".to_owned(), rsx!(Icon { icon: MdGroupWork, width: width, height: height })));
    icons.push(("MdHelp".to_owned(), rsx!(Icon { icon: MdHelp, width: width, height: height })));
    icons.push(("MdHelpCenter".to_owned(), rsx!(Icon { icon: MdHelpCenter, width: width, height: height })));
    icons.push(("MdHelpOutline".to_owned(), rsx!(Icon { icon: MdHelpOutline, width: width, height: height })));
    icons.push(("MdHideSource".to_owned(), rsx!(Icon { icon: MdHideSource, width: width, height: height })));
    icons.push(("MdHighlightAlt".to_owned(), rsx!(Icon { icon: MdHighlightAlt, width: width, height: height })));
    icons.push(("MdHighlightOff".to_owned(), rsx!(Icon { icon: MdHighlightOff, width: width, height: height })));
    icons.push(("MdHistory".to_owned(), rsx!(Icon { icon: MdHistory, width: width, height: height })));
    icons.push(("MdHistoryToggleOff".to_owned(), rsx!(Icon { icon: MdHistoryToggleOff, width: width, height: height })));
    icons.push(("MdHls".to_owned(), rsx!(Icon { icon: MdHls, width: width, height: height })));
    icons.push(("MdHlsOff".to_owned(), rsx!(Icon { icon: MdHlsOff, width: width, height: height })));
    icons.push(("MdHome".to_owned(), rsx!(Icon { icon: MdHome, width: width, height: height })));
    icons.push(("MdHomeFilled".to_owned(), rsx!(Icon { icon: MdHomeFilled, width: width, height: height })));
    icons.push(("MdHorizontalSplit".to_owned(), rsx!(Icon { icon: MdHorizontalSplit, width: width, height: height })));
    icons.push(("MdHotelClass".to_owned(), rsx!(Icon { icon: MdHotelClass, width: width, height: height })));
    icons.push(("MdHourglassDisabled".to_owned(), rsx!(Icon { icon: MdHourglassDisabled, width: width, height: height })));
    icons.push(("MdHourglassEmpty".to_owned(), rsx!(Icon { icon: MdHourglassEmpty, width: width, height: height })));
    icons.push(("MdHourglassFull".to_owned(), rsx!(Icon { icon: MdHourglassFull, width: width, height: height })));
    icons.push(("MdHtml".to_owned(), rsx!(Icon { icon: MdHtml, width: width, height: height })));
    icons.push(("MdHttp".to_owned(), rsx!(Icon { icon: MdHttp, width: width, height: height })));
    icons.push(("MdHttps".to_owned(), rsx!(Icon { icon: MdHttps, width: width, height: height })));
    icons.push(("MdImportantDevices".to_owned(), rsx!(Icon { icon: MdImportantDevices, width: width, height: height })));
    icons.push(("MdInfo".to_owned(), rsx!(Icon { icon: MdInfo, width: width, height: height })));
    icons.push(("MdInfoOutline".to_owned(), rsx!(Icon { icon: MdInfoOutline, width: width, height: height })));
    icons.push(("MdInput".to_owned(), rsx!(Icon { icon: MdInput, width: width, height: height })));
    icons.push(("MdInstallDesktop".to_owned(), rsx!(Icon { icon: MdInstallDesktop, width: width, height: height })));
    icons.push(("MdInstallMobile".to_owned(), rsx!(Icon { icon: MdInstallMobile, width: width, height: height })));
    icons.push(("MdIntegrationInstructions".to_owned(), rsx!(Icon { icon: MdIntegrationInstructions, width: width, height: height })));
    icons.push(("MdInvertColors".to_owned(), rsx!(Icon { icon: MdInvertColors, width: width, height: height })));
    icons.push(("MdJavascript".to_owned(), rsx!(Icon { icon: MdJavascript, width: width, height: height })));
    icons.push(("MdJoinFull".to_owned(), rsx!(Icon { icon: MdJoinFull, width: width, height: height })));
    icons.push(("MdJoinInner".to_owned(), rsx!(Icon { icon: MdJoinInner, width: width, height: height })));
    icons.push(("MdJoinLeft".to_owned(), rsx!(Icon { icon: MdJoinLeft, width: width, height: height })));
    icons.push(("MdJoinRight".to_owned(), rsx!(Icon { icon: MdJoinRight, width: width, height: height })));
    icons.push(("MdLabel".to_owned(), rsx!(Icon { icon: MdLabel, width: width, height: height })));
    icons.push(("MdLabelImportant".to_owned(), rsx!(Icon { icon: MdLabelImportant, width: width, height: height })));
    icons.push(("MdLabelImportantOutline".to_owned(), rsx!(Icon { icon: MdLabelImportantOutline, width: width, height: height })));
    icons.push(("MdLabelOff".to_owned(), rsx!(Icon { icon: MdLabelOff, width: width, height: height })));
    icons.push(("MdLabelOutline".to_owned(), rsx!(Icon { icon: MdLabelOutline, width: width, height: height })));
    icons.push(("MdLanguage".to_owned(), rsx!(Icon { icon: MdLanguage, width: width, height: height })));
    icons.push(("MdLaunch".to_owned(), rsx!(Icon { icon: MdLaunch, width: width, height: height })));
    icons.push(("MdLeaderboard".to_owned(), rsx!(Icon { icon: MdLeaderboard, width: width, height: height })));
    icons.push(("MdLightbulb".to_owned(), rsx!(Icon { icon: MdLightbulb, width: width, height: height })));
    icons.push(("MdLightbulbCircle".to_owned(), rsx!(Icon { icon: MdLightbulbCircle, width: width, height: height })));
    icons.push(("MdLightbulbOutline".to_owned(), rsx!(Icon { icon: MdLightbulbOutline, width: width, height: height })));
    icons.push(("MdLineStyle".to_owned(), rsx!(Icon { icon: MdLineStyle, width: width, height: height })));
    icons.push(("MdLineWeight".to_owned(), rsx!(Icon { icon: MdLineWeight, width: width, height: height })));
    icons.push(("MdList".to_owned(), rsx!(Icon { icon: MdList, width: width, height: height })));
    icons.push(("MdLock".to_owned(), rsx!(Icon { icon: MdLock, width: width, height: height })));
    icons.push(("MdLockClock".to_owned(), rsx!(Icon { icon: MdLockClock, width: width, height: height })));
    icons.push(("MdLockOpen".to_owned(), rsx!(Icon { icon: MdLockOpen, width: width, height: height })));
    icons.push(("MdLockOutline".to_owned(), rsx!(Icon { icon: MdLockOutline, width: width, height: height })));
    icons.push(("MdLockPerson".to_owned(), rsx!(Icon { icon: MdLockPerson, width: width, height: height })));
    icons.push(("MdLockReset".to_owned(), rsx!(Icon { icon: MdLockReset, width: width, height: height })));
    icons.push(("MdLogin".to_owned(), rsx!(Icon { icon: MdLogin, width: width, height: height })));
    icons.push(("MdLogout".to_owned(), rsx!(Icon { icon: MdLogout, width: width, height: height })));
    icons.push(("MdLoyalty".to_owned(), rsx!(Icon { icon: MdLoyalty, width: width, height: height })));
    icons.push(("MdManageAccounts".to_owned(), rsx!(Icon { icon: MdManageAccounts, width: width, height: height })));
    icons.push(("MdManageHistory".to_owned(), rsx!(Icon { icon: MdManageHistory, width: width, height: height })));
    icons.push(("MdMarkAsUnread".to_owned(), rsx!(Icon { icon: MdMarkAsUnread, width: width, height: height })));
    icons.push(("MdMarkunreadMailbox".to_owned(), rsx!(Icon { icon: MdMarkunreadMailbox, width: width, height: height })));
    icons.push(("MdMaximize".to_owned(), rsx!(Icon { icon: MdMaximize, width: width, height: height })));
    icons.push(("MdMediation".to_owned(), rsx!(Icon { icon: MdMediation, width: width, height: height })));
    icons.push(("MdMinimize".to_owned(), rsx!(Icon { icon: MdMinimize, width: width, height: height })));
    icons.push(("MdModelTraining".to_owned(), rsx!(Icon { icon: MdModelTraining, width: width, height: height })));
    icons.push(("MdNetworkPing".to_owned(), rsx!(Icon { icon: MdNetworkPing, width: width, height: height })));
    icons.push(("MdNewLabel".to_owned(), rsx!(Icon { icon: MdNewLabel, width: width, height: height })));
    icons.push(("MdNextPlan".to_owned(), rsx!(Icon { icon: MdNextPlan, width: width, height: height })));
    icons.push(("MdNightlightRound".to_owned(), rsx!(Icon { icon: MdNightlightRound, width: width, height: height })));
    icons.push(("MdNoAccounts".to_owned(), rsx!(Icon { icon: MdNoAccounts, width: width, height: height })));
    icons.push(("MdNoiseAware".to_owned(), rsx!(Icon { icon: MdNoiseAware, width: width, height: height })));
    icons.push(("MdNoiseControlOff".to_owned(), rsx!(Icon { icon: MdNoiseControlOff, width: width, height: height })));
    icons.push(("MdNotAccessible".to_owned(), rsx!(Icon { icon: MdNotAccessible, width: width, height: height })));
    icons.push(("MdNotStarted".to_owned(), rsx!(Icon { icon: MdNotStarted, width: width, height: height })));
    icons.push(("MdNoteAdd".to_owned(), rsx!(Icon { icon: MdNoteAdd, width: width, height: height })));
    icons.push(("MdOfflineBolt".to_owned(), rsx!(Icon { icon: MdOfflineBolt, width: width, height: height })));
    icons.push(("MdOfflinePin".to_owned(), rsx!(Icon { icon: MdOfflinePin, width: width, height: height })));
    icons.push(("MdOnDeviceTraining".to_owned(), rsx!(Icon { icon: MdOnDeviceTraining, width: width, height: height })));
    icons.push(("MdOnlinePrediction".to_owned(), rsx!(Icon { icon: MdOnlinePrediction, width: width, height: height })));
    icons.push(("MdOpacity".to_owned(), rsx!(Icon { icon: MdOpacity, width: width, height: height })));
    icons.push(("MdOpenInBrowser".to_owned(), rsx!(Icon { icon: MdOpenInBrowser, width: width, height: height })));
    icons.push(("MdOpenInFull".to_owned(), rsx!(Icon { icon: MdOpenInFull, width: width, height: height })));
    icons.push(("MdOpenInNew".to_owned(), rsx!(Icon { icon: MdOpenInNew, width: width, height: height })));
    icons.push(("MdOpenInNewOff".to_owned(), rsx!(Icon { icon: MdOpenInNewOff, width: width, height: height })));
    icons.push(("MdOpenWith".to_owned(), rsx!(Icon { icon: MdOpenWith, width: width, height: height })));
    icons.push(("MdOutbond".to_owned(), rsx!(Icon { icon: MdOutbond, width: width, height: height })));
    icons.push(("MdOutbound".to_owned(), rsx!(Icon { icon: MdOutbound, width: width, height: height })));
    icons.push(("MdOutbox".to_owned(), rsx!(Icon { icon: MdOutbox, width: width, height: height })));
    icons.push(("MdOutgoingMail".to_owned(), rsx!(Icon { icon: MdOutgoingMail, width: width, height: height })));
    icons.push(("MdOutlet".to_owned(), rsx!(Icon { icon: MdOutlet, width: width, height: height })));
    icons.push(("MdOutput".to_owned(), rsx!(Icon { icon: MdOutput, width: width, height: height })));
    icons.push(("MdPageview".to_owned(), rsx!(Icon { icon: MdPageview, width: width, height: height })));
    icons.push(("MdPaid".to_owned(), rsx!(Icon { icon: MdPaid, width: width, height: height })));
    icons.push(("MdPanTool".to_owned(), rsx!(Icon { icon: MdPanTool, width: width, height: height })));
    icons.push(("MdPanToolAlt".to_owned(), rsx!(Icon { icon: MdPanToolAlt, width: width, height: height })));
    icons.push(("MdPayment".to_owned(), rsx!(Icon { icon: MdPayment, width: width, height: height })));
    icons.push(("MdPending".to_owned(), rsx!(Icon { icon: MdPending, width: width, height: height })));
    icons.push(("MdPendingActions".to_owned(), rsx!(Icon { icon: MdPendingActions, width: width, height: height })));
    icons.push(("MdPercent".to_owned(), rsx!(Icon { icon: MdPercent, width: width, height: height })));
    icons.push(("MdPermCameraMic".to_owned(), rsx!(Icon { icon: MdPermCameraMic, width: width, height: height })));
    icons.push(("MdPermContactCalendar".to_owned(), rsx!(Icon { icon: MdPermContactCalendar, width: width, height: height })));
    icons.push(("MdPermDataSetting".to_owned(), rsx!(Icon { icon: MdPermDataSetting, width: width, height: height })));
    icons.push(("MdPermDeviceInformation".to_owned(), rsx!(Icon { icon: MdPermDeviceInformation, width: width, height: height })));
    icons.push(("MdPermIdentity".to_owned(), rsx!(Icon { icon: MdPermIdentity, width: width, height: height })));
    icons.push(("MdPermMedia".to_owned(), rsx!(Icon { icon: MdPermMedia, width: width, height: height })));
    icons.push(("MdPermPhoneMsg".to_owned(), rsx!(Icon { icon: MdPermPhoneMsg, width: width, height: height })));
    icons.push(("MdPermScanWifi".to_owned(), rsx!(Icon { icon: MdPermScanWifi, width: width, height: height })));
    icons.push(("MdPets".to_owned(), rsx!(Icon { icon: MdPets, width: width, height: height })));
    icons.push(("MdPhp".to_owned(), rsx!(Icon { icon: MdPhp, width: width, height: height })));
    icons.push(("MdPictureInPicture".to_owned(), rsx!(Icon { icon: MdPictureInPicture, width: width, height: height })));
    icons.push(("MdPictureInPictureAlt".to_owned(), rsx!(Icon { icon: MdPictureInPictureAlt, width: width, height: height })));
    icons.push(("MdPinEnd".to_owned(), rsx!(Icon { icon: MdPinEnd, width: width, height: height })));
    icons.push(("MdPinInvoke".to_owned(), rsx!(Icon { icon: MdPinInvoke, width: width, height: height })));
    icons.push(("MdPinch".to_owned(), rsx!(Icon { icon: MdPinch, width: width, height: height })));
    icons.push(("MdPlagiarism".to_owned(), rsx!(Icon { icon: MdPlagiarism, width: width, height: height })));
    icons.push(("MdPlayForWork".to_owned(), rsx!(Icon { icon: MdPlayForWork, width: width, height: height })));
    icons.push(("MdPolymer".to_owned(), rsx!(Icon { icon: MdPolymer, width: width, height: height })));
    icons.push(("MdPowerSettingsNew".to_owned(), rsx!(Icon { icon: MdPowerSettingsNew, width: width, height: height })));
    icons.push(("MdPregnantWoman".to_owned(), rsx!(Icon { icon: MdPregnantWoman, width: width, height: height })));
    icons.push(("MdPreview".to_owned(), rsx!(Icon { icon: MdPreview, width: width, height: height })));
    icons.push(("MdPrint".to_owned(), rsx!(Icon { icon: MdPrint, width: width, height: height })));
    icons.push(("MdPrivacyTip".to_owned(), rsx!(Icon { icon: MdPrivacyTip, width: width, height: height })));
    icons.push(("MdPrivateConnectivity".to_owned(), rsx!(Icon { icon: MdPrivateConnectivity, width: width, height: height })));
    icons.push(("MdProductionQuantityLimits".to_owned(), rsx!(Icon { icon: MdProductionQuantityLimits, width: width, height: height })));
    icons.push(("MdPublishedWithChanges".to_owned(), rsx!(Icon { icon: MdPublishedWithChanges, width: width, height: height })));
    icons.push(("MdQueryBuilder".to_owned(), rsx!(Icon { icon: MdQueryBuilder, width: width, height: height })));
    icons.push(("MdQuestionAnswer".to_owned(), rsx!(Icon { icon: MdQuestionAnswer, width: width, height: height })));
    icons.push(("MdQuestionMark".to_owned(), rsx!(Icon { icon: MdQuestionMark, width: width, height: height })));
    icons.push(("MdQuickreply".to_owned(), rsx!(Icon { icon: MdQuickreply, width: width, height: height })));
    icons.push(("MdRebaseEdit".to_owned(), rsx!(Icon { icon: MdRebaseEdit, width: width, height: height })));
    icons.push(("MdReceipt".to_owned(), rsx!(Icon { icon: MdReceipt, width: width, height: height })));
    icons.push(("MdRecordVoiceOver".to_owned(), rsx!(Icon { icon: MdRecordVoiceOver, width: width, height: height })));
    icons.push(("MdRedeem".to_owned(), rsx!(Icon { icon: MdRedeem, width: width, height: height })));
    icons.push(("MdRemoveDone".to_owned(), rsx!(Icon { icon: MdRemoveDone, width: width, height: height })));
    icons.push(("MdRemoveShoppingCart".to_owned(), rsx!(Icon { icon: MdRemoveShoppingCart, width: width, height: height })));
    icons.push(("MdReorder".to_owned(), rsx!(Icon { icon: MdReorder, width: width, height: height })));
    icons.push(("MdRepartition".to_owned(), rsx!(Icon { icon: MdRepartition, width: width, height: height })));
    icons.push(("MdReportProblem".to_owned(), rsx!(Icon { icon: MdReportProblem, width: width, height: height })));
    icons.push(("MdRequestPage".to_owned(), rsx!(Icon { icon: MdRequestPage, width: width, height: height })));
    icons.push(("MdRestore".to_owned(), rsx!(Icon { icon: MdRestore, width: width, height: height })));
    icons.push(("MdRestoreFromTrash".to_owned(), rsx!(Icon { icon: MdRestoreFromTrash, width: width, height: height })));
    icons.push(("MdRestorePage".to_owned(), rsx!(Icon { icon: MdRestorePage, width: width, height: height })));
    icons.push(("MdRocket".to_owned(), rsx!(Icon { icon: MdRocket, width: width, height: height })));
    icons.push(("MdRocketLaunch".to_owned(), rsx!(Icon { icon: MdRocketLaunch, width: width, height: height })));
    icons.push(("MdRoom".to_owned(), rsx!(Icon { icon: MdRoom, width: width, height: height })));
    icons.push(("MdRoundedCorner".to_owned(), rsx!(Icon { icon: MdRoundedCorner, width: width, height: height })));
    icons.push(("MdRowing".to_owned(), rsx!(Icon { icon: MdRowing, width: width, height: height })));
    icons.push(("MdRule".to_owned(), rsx!(Icon { icon: MdRule, width: width, height: height })));
    icons.push(("MdSatelliteAlt".to_owned(), rsx!(Icon { icon: MdSatelliteAlt, width: width, height: height })));
    icons.push(("MdSavedSearch".to_owned(), rsx!(Icon { icon: MdSavedSearch, width: width, height: height })));
    icons.push(("MdSavings".to_owned(), rsx!(Icon { icon: MdSavings, width: width, height: height })));
    icons.push(("MdSchedule".to_owned(), rsx!(Icon { icon: MdSchedule, width: width, height: height })));
    icons.push(("MdScheduleSend".to_owned(), rsx!(Icon { icon: MdScheduleSend, width: width, height: height })));
    icons.push(("MdSearch".to_owned(), rsx!(Icon { icon: MdSearch, width: width, height: height })));
    icons.push(("MdSearchOff".to_owned(), rsx!(Icon { icon: MdSearchOff, width: width, height: height })));
    icons.push(("MdSegment".to_owned(), rsx!(Icon { icon: MdSegment, width: width, height: height })));
    icons.push(("MdSendAndArchive".to_owned(), rsx!(Icon { icon: MdSendAndArchive, width: width, height: height })));
    icons.push(("MdSensors".to_owned(), rsx!(Icon { icon: MdSensors, width: width, height: height })));
    icons.push(("MdSensorsOff".to_owned(), rsx!(Icon { icon: MdSensorsOff, width: width, height: height })));
    icons.push(("MdSettings".to_owned(), rsx!(Icon { icon: MdSettings, width: width, height: height })));
    icons.push(("MdSettingsAccessibility".to_owned(), rsx!(Icon { icon: MdSettingsAccessibility, width: width, height: height })));
    icons.push(("MdSettingsApplications".to_owned(), rsx!(Icon { icon: MdSettingsApplications, width: width, height: height })));
    icons.push(("MdSettingsBackupRestore".to_owned(), rsx!(Icon { icon: MdSettingsBackupRestore, width: width, height: height })));
    icons.push(("MdSettingsBluetooth".to_owned(), rsx!(Icon { icon: MdSettingsBluetooth, width: width, height: height })));
    icons.push(("MdSettingsBrightness".to_owned(), rsx!(Icon { icon: MdSettingsBrightness, width: width, height: height })));
    icons.push(("MdSettingsCell".to_owned(), rsx!(Icon { icon: MdSettingsCell, width: width, height: height })));
    icons.push(("MdSettingsEthernet".to_owned(), rsx!(Icon { icon: MdSettingsEthernet, width: width, height: height })));
    icons.push(("MdSettingsInputAntenna".to_owned(), rsx!(Icon { icon: MdSettingsInputAntenna, width: width, height: height })));
    icons.push(("MdSettingsInputComponent".to_owned(), rsx!(Icon { icon: MdSettingsInputComponent, width: width, height: height })));
    icons.push(("MdSettingsInputComposite".to_owned(), rsx!(Icon { icon: MdSettingsInputComposite, width: width, height: height })));
    icons.push(("MdSettingsInputHdmi".to_owned(), rsx!(Icon { icon: MdSettingsInputHdmi, width: width, height: height })));
    icons.push(("MdSettingsInputSvideo".to_owned(), rsx!(Icon { icon: MdSettingsInputSvideo, width: width, height: height })));
    icons.push(("MdSettingsOverscan".to_owned(), rsx!(Icon { icon: MdSettingsOverscan, width: width, height: height })));
    icons.push(("MdSettingsPhone".to_owned(), rsx!(Icon { icon: MdSettingsPhone, width: width, height: height })));
    icons.push(("MdSettingsPower".to_owned(), rsx!(Icon { icon: MdSettingsPower, width: width, height: height })));
    icons.push(("MdSettingsRemote".to_owned(), rsx!(Icon { icon: MdSettingsRemote, width: width, height: height })));
    icons.push(("MdSettingsVoice".to_owned(), rsx!(Icon { icon: MdSettingsVoice, width: width, height: height })));
    icons.push(("MdShop".to_owned(), rsx!(Icon { icon: MdShop, width: width, height: height })));
    icons.push(("MdShop2".to_owned(), rsx!(Icon { icon: MdShop2, width: width, height: height })));
    icons.push(("MdShopTwo".to_owned(), rsx!(Icon { icon: MdShopTwo, width: width, height: height })));
    icons.push(("MdShoppingBag".to_owned(), rsx!(Icon { icon: MdShoppingBag, width: width, height: height })));
    icons.push(("MdShoppingBasket".to_owned(), rsx!(Icon { icon: MdShoppingBasket, width: width, height: height })));
    icons.push(("MdShoppingCart".to_owned(), rsx!(Icon { icon: MdShoppingCart, width: width, height: height })));
    icons.push(("MdShoppingCartCheckout".to_owned(), rsx!(Icon { icon: MdShoppingCartCheckout, width: width, height: height })));
    icons.push(("MdSmartButton".to_owned(), rsx!(Icon { icon: MdSmartButton, width: width, height: height })));
    icons.push(("MdSource".to_owned(), rsx!(Icon { icon: MdSource, width: width, height: height })));
    icons.push(("MdSpaceDashboard".to_owned(), rsx!(Icon { icon: MdSpaceDashboard, width: width, height: height })));
    icons.push(("MdSpatialAudio".to_owned(), rsx!(Icon { icon: MdSpatialAudio, width: width, height: height })));
    icons.push(("MdSpatialAudioOff".to_owned(), rsx!(Icon { icon: MdSpatialAudioOff, width: width, height: height })));
    icons.push(("MdSpatialTracking".to_owned(), rsx!(Icon { icon: MdSpatialTracking, width: width, height: height })));
    icons.push(("MdSpeakerNotes".to_owned(), rsx!(Icon { icon: MdSpeakerNotes, width: width, height: height })));
    icons.push(("MdSpeakerNotesOff".to_owned(), rsx!(Icon { icon: MdSpeakerNotesOff, width: width, height: height })));
    icons.push(("MdSpellcheck".to_owned(), rsx!(Icon { icon: MdSpellcheck, width: width, height: height })));
    icons.push(("MdStarRate".to_owned(), rsx!(Icon { icon: MdStarRate, width: width, height: height })));
    icons.push(("MdStars".to_owned(), rsx!(Icon { icon: MdStars, width: width, height: height })));
    icons.push(("MdStickyNote2".to_owned(), rsx!(Icon { icon: MdStickyNote2, width: width, height: height })));
    icons.push(("MdStore".to_owned(), rsx!(Icon { icon: MdStore, width: width, height: height })));
    icons.push(("MdSubject".to_owned(), rsx!(Icon { icon: MdSubject, width: width, height: height })));
    icons.push(("MdSubtitlesOff".to_owned(), rsx!(Icon { icon: MdSubtitlesOff, width: width, height: height })));
    icons.push(("MdSupervisedUserCircle".to_owned(), rsx!(Icon { icon: MdSupervisedUserCircle, width: width, height: height })));
    icons.push(("MdSupervisorAccount".to_owned(), rsx!(Icon { icon: MdSupervisorAccount, width: width, height: height })));
    icons.push(("MdSupport".to_owned(), rsx!(Icon { icon: MdSupport, width: width, height: height })));
    icons.push(("MdSwapHoriz".to_owned(), rsx!(Icon { icon: MdSwapHoriz, width: width, height: height })));
    icons.push(("MdSwapHorizontalCircle".to_owned(), rsx!(Icon { icon: MdSwapHorizontalCircle, width: width, height: height })));
    icons.push(("MdSwapVert".to_owned(), rsx!(Icon { icon: MdSwapVert, width: width, height: height })));
    icons.push(("MdSwapVerticalCircle".to_owned(), rsx!(Icon { icon: MdSwapVerticalCircle, width: width, height: height })));
    icons.push(("MdSwipe".to_owned(), rsx!(Icon { icon: MdSwipe, width: width, height: height })));
    icons.push(("MdSwipeDown".to_owned(), rsx!(Icon { icon: MdSwipeDown, width: width, height: height })));
    icons.push(("MdSwipeDownAlt".to_owned(), rsx!(Icon { icon: MdSwipeDownAlt, width: width, height: height })));
    icons.push(("MdSwipeLeft".to_owned(), rsx!(Icon { icon: MdSwipeLeft, width: width, height: height })));
    icons.push(("MdSwipeLeftAlt".to_owned(), rsx!(Icon { icon: MdSwipeLeftAlt, width: width, height: height })));
    icons.push(("MdSwipeRight".to_owned(), rsx!(Icon { icon: MdSwipeRight, width: width, height: height })));
    icons.push(("MdSwipeRightAlt".to_owned(), rsx!(Icon { icon: MdSwipeRightAlt, width: width, height: height })));
    icons.push(("MdSwipeUp".to_owned(), rsx!(Icon { icon: MdSwipeUp, width: width, height: height })));
    icons.push(("MdSwipeUpAlt".to_owned(), rsx!(Icon { icon: MdSwipeUpAlt, width: width, height: height })));
    icons.push(("MdSwipeVertical".to_owned(), rsx!(Icon { icon: MdSwipeVertical, width: width, height: height })));
    icons.push(("MdSwitchAccessShortcut".to_owned(), rsx!(Icon { icon: MdSwitchAccessShortcut, width: width, height: height })));
    icons.push(("MdSwitchAccessShortcutAdd".to_owned(), rsx!(Icon { icon: MdSwitchAccessShortcutAdd, width: width, height: height })));
    icons.push(("MdSyncAlt".to_owned(), rsx!(Icon { icon: MdSyncAlt, width: width, height: height })));
    icons.push(("MdSystemUpdateAlt".to_owned(), rsx!(Icon { icon: MdSystemUpdateAlt, width: width, height: height })));
    icons.push(("MdTab".to_owned(), rsx!(Icon { icon: MdTab, width: width, height: height })));
    icons.push(("MdTabUnselected".to_owned(), rsx!(Icon { icon: MdTabUnselected, width: width, height: height })));
    icons.push(("MdTableView".to_owned(), rsx!(Icon { icon: MdTableView, width: width, height: height })));
    icons.push(("MdTaskAlt".to_owned(), rsx!(Icon { icon: MdTaskAlt, width: width, height: height })));
    icons.push(("MdTerminal".to_owned(), rsx!(Icon { icon: MdTerminal, width: width, height: height })));
    icons.push(("MdTextRotateUp".to_owned(), rsx!(Icon { icon: MdTextRotateUp, width: width, height: height })));
    icons.push(("MdTextRotateVertical".to_owned(), rsx!(Icon { icon: MdTextRotateVertical, width: width, height: height })));
    icons.push(("MdTextRotationAngledown".to_owned(), rsx!(Icon { icon: MdTextRotationAngledown, width: width, height: height })));
    icons.push(("MdTextRotationAngleup".to_owned(), rsx!(Icon { icon: MdTextRotationAngleup, width: width, height: height })));
    icons.push(("MdTextRotationDown".to_owned(), rsx!(Icon { icon: MdTextRotationDown, width: width, height: height })));
    icons.push(("MdTextRotationNone".to_owned(), rsx!(Icon { icon: MdTextRotationNone, width: width, height: height })));
    icons.push(("MdTheaters".to_owned(), rsx!(Icon { icon: MdTheaters, width: width, height: height })));
    icons.push(("MdThumbDown".to_owned(), rsx!(Icon { icon: MdThumbDown, width: width, height: height })));
    icons.push(("MdThumbDownOffAlt".to_owned(), rsx!(Icon { icon: MdThumbDownOffAlt, width: width, height: height })));
    icons.push(("MdThumbUp".to_owned(), rsx!(Icon { icon: MdThumbUp, width: width, height: height })));
    icons.push(("MdThumbUpOffAlt".to_owned(), rsx!(Icon { icon: MdThumbUpOffAlt, width: width, height: height })));
    icons.push(("MdThumbsUpDown".to_owned(), rsx!(Icon { icon: MdThumbsUpDown, width: width, height: height })));
    icons.push(("MdTimeline".to_owned(), rsx!(Icon { icon: MdTimeline, width: width, height: height })));
    icons.push(("MdTipsAndUpdates".to_owned(), rsx!(Icon { icon: MdTipsAndUpdates, width: width, height: height })));
    icons.push(("MdToc".to_owned(), rsx!(Icon { icon: MdToc, width: width, height: height })));
    icons.push(("MdToday".to_owned(), rsx!(Icon { icon: MdToday, width: width, height: height })));
    icons.push(("MdToken".to_owned(), rsx!(Icon { icon: MdToken, width: width, height: height })));
    icons.push(("MdToll".to_owned(), rsx!(Icon { icon: MdToll, width: width, height: height })));
    icons.push(("MdTouchApp".to_owned(), rsx!(Icon { icon: MdTouchApp, width: width, height: height })));
    icons.push(("MdTour".to_owned(), rsx!(Icon { icon: MdTour, width: width, height: height })));
    icons.push(("MdTrackChanges".to_owned(), rsx!(Icon { icon: MdTrackChanges, width: width, height: height })));
    icons.push(("MdTranscribe".to_owned(), rsx!(Icon { icon: MdTranscribe, width: width, height: height })));
    icons.push(("MdTranslate".to_owned(), rsx!(Icon { icon: MdTranslate, width: width, height: height })));
    icons.push(("MdTrendingDown".to_owned(), rsx!(Icon { icon: MdTrendingDown, width: width, height: height })));
    icons.push(("MdTrendingFlat".to_owned(), rsx!(Icon { icon: MdTrendingFlat, width: width, height: height })));
    icons.push(("MdTrendingUp".to_owned(), rsx!(Icon { icon: MdTrendingUp, width: width, height: height })));
    icons.push(("MdTroubleshoot".to_owned(), rsx!(Icon { icon: MdTroubleshoot, width: width, height: height })));
    icons.push(("MdTry".to_owned(), rsx!(Icon { icon: MdTry, width: width, height: height })));
    icons.push(("MdTurnedIn".to_owned(), rsx!(Icon { icon: MdTurnedIn, width: width, height: height })));
    icons.push(("MdTurnedInNot".to_owned(), rsx!(Icon { icon: MdTurnedInNot, width: width, height: height })));
    icons.push(("MdUnfoldLessDouble".to_owned(), rsx!(Icon { icon: MdUnfoldLessDouble, width: width, height: height })));
    icons.push(("MdUnfoldMoreDouble".to_owned(), rsx!(Icon { icon: MdUnfoldMoreDouble, width: width, height: height })));
    icons.push(("MdUnpublished".to_owned(), rsx!(Icon { icon: MdUnpublished, width: width, height: height })));
    icons.push(("MdUpdate".to_owned(), rsx!(Icon { icon: MdUpdate, width: width, height: height })));
    icons.push(("MdUpdateDisabled".to_owned(), rsx!(Icon { icon: MdUpdateDisabled, width: width, height: height })));
    icons.push(("MdUpgrade".to_owned(), rsx!(Icon { icon: MdUpgrade, width: width, height: height })));
    icons.push(("MdVerified".to_owned(), rsx!(Icon { icon: MdVerified, width: width, height: height })));
    icons.push(("MdVerifiedUser".to_owned(), rsx!(Icon { icon: MdVerifiedUser, width: width, height: height })));
    icons.push(("MdVerticalSplit".to_owned(), rsx!(Icon { icon: MdVerticalSplit, width: width, height: height })));
    icons.push(("MdViewAgenda".to_owned(), rsx!(Icon { icon: MdViewAgenda, width: width, height: height })));
    icons.push(("MdViewArray".to_owned(), rsx!(Icon { icon: MdViewArray, width: width, height: height })));
    icons.push(("MdViewCarousel".to_owned(), rsx!(Icon { icon: MdViewCarousel, width: width, height: height })));
    icons.push(("MdViewColumn".to_owned(), rsx!(Icon { icon: MdViewColumn, width: width, height: height })));
    icons.push(("MdViewComfyAlt".to_owned(), rsx!(Icon { icon: MdViewComfyAlt, width: width, height: height })));
    icons.push(("MdViewCompactAlt".to_owned(), rsx!(Icon { icon: MdViewCompactAlt, width: width, height: height })));
    icons.push(("MdViewCozy".to_owned(), rsx!(Icon { icon: MdViewCozy, width: width, height: height })));
    icons.push(("MdViewDay".to_owned(), rsx!(Icon { icon: MdViewDay, width: width, height: height })));
    icons.push(("MdViewHeadline".to_owned(), rsx!(Icon { icon: MdViewHeadline, width: width, height: height })));
    icons.push(("MdViewInAr".to_owned(), rsx!(Icon { icon: MdViewInAr, width: width, height: height })));
    icons.push(("MdViewKanban".to_owned(), rsx!(Icon { icon: MdViewKanban, width: width, height: height })));
    icons.push(("MdViewList".to_owned(), rsx!(Icon { icon: MdViewList, width: width, height: height })));
    icons.push(("MdViewModule".to_owned(), rsx!(Icon { icon: MdViewModule, width: width, height: height })));
    icons.push(("MdViewQuilt".to_owned(), rsx!(Icon { icon: MdViewQuilt, width: width, height: height })));
    icons.push(("MdViewSidebar".to_owned(), rsx!(Icon { icon: MdViewSidebar, width: width, height: height })));
    icons.push(("MdViewStream".to_owned(), rsx!(Icon { icon: MdViewStream, width: width, height: height })));
    icons.push(("MdViewTimeline".to_owned(), rsx!(Icon { icon: MdViewTimeline, width: width, height: height })));
    icons.push(("MdViewWeek".to_owned(), rsx!(Icon { icon: MdViewWeek, width: width, height: height })));
    icons.push(("MdVisibility".to_owned(), rsx!(Icon { icon: MdVisibility, width: width, height: height })));
    icons.push(("MdVisibilityOff".to_owned(), rsx!(Icon { icon: MdVisibilityOff, width: width, height: height })));
    icons.push(("MdVoiceOverOff".to_owned(), rsx!(Icon { icon: MdVoiceOverOff, width: width, height: height })));
    icons.push(("MdWatchLater".to_owned(), rsx!(Icon { icon: MdWatchLater, width: width, height: height })));
    icons.push(("MdWebhook".to_owned(), rsx!(Icon { icon: MdWebhook, width: width, height: height })));
    icons.push(("MdWidthFull".to_owned(), rsx!(Icon { icon: MdWidthFull, width: width, height: height })));
    icons.push(("MdWidthNormal".to_owned(), rsx!(Icon { icon: MdWidthNormal, width: width, height: height })));
    icons.push(("MdWidthWide".to_owned(), rsx!(Icon { icon: MdWidthWide, width: width, height: height })));
    icons.push(("MdWifiProtectedSetup".to_owned(), rsx!(Icon { icon: MdWifiProtectedSetup, width: width, height: height })));
    icons.push(("MdWork".to_owned(), rsx!(Icon { icon: MdWork, width: width, height: height })));
    icons.push(("MdWorkHistory".to_owned(), rsx!(Icon { icon: MdWorkHistory, width: width, height: height })));
    icons.push(("MdWorkOff".to_owned(), rsx!(Icon { icon: MdWorkOff, width: width, height: height })));
    icons.push(("MdWorkOutline".to_owned(), rsx!(Icon { icon: MdWorkOutline, width: width, height: height })));
    icons.push(("MdWysiwyg".to_owned(), rsx!(Icon { icon: MdWysiwyg, width: width, height: height })));
    icons.push(("MdYoutubeSearchedFor".to_owned(), rsx!(Icon { icon: MdYoutubeSearchedFor, width: width, height: height })));
    icons.push(("MdZoomIn".to_owned(), rsx!(Icon { icon: MdZoomIn, width: width, height: height })));
    icons.push(("MdZoomOut".to_owned(), rsx!(Icon { icon: MdZoomOut, width: width, height: height })));
    icons
}}
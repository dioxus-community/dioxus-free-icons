...
impl IconShape for MdAudioFile {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdInterpreterMode {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdPauseCircle {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdPlayCircle {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdPlaylistAddCheckCircle {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdPlaylistAddCircle {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdPlaylistRemove {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdVideoFile {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdVolumeDownAlt {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
impl IconShape for MdWebAssetOff {
    fn view_box(&self) -> &str {
        "0 0 24 24"
    }
    fn xmlns(&self) -> &str {
...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("Md10k".to_owned(), rsx!(Icon { icon: Md10k, width: width, height: height })));
    icons.push(("Md1k".to_owned(), rsx!(Icon { icon: Md1k, width: width, height: height })));
    icons.push(("Md1kPlus".to_owned(), rsx!(Icon { icon: Md1kPlus, width: width, height: height })));
    icons.push(("Md2k".to_owned(), rsx!(Icon { icon: Md2k, width: width, height: height })));
    icons.push(("Md2kPlus".to_owned(), rsx!(Icon { icon: Md2kPlus, width: width, height: height })));
    icons.push(("Md3k".to_owned(), rsx!(Icon { icon: Md3k, width: width, height: height })));
    icons.push(("Md3kPlus".to_owned(), rsx!(Icon { icon: Md3kPlus, width: width, height: height })));
    icons.push(("Md4k".to_owned(), rsx!(Icon { icon: Md4k, width: width, height: height })));
    icons.push(("Md4kPlus".to_owned(), rsx!(Icon { icon: Md4kPlus, width: width, height: height })));
    icons.push(("Md5g".to_owned(), rsx!(Icon { icon: Md5g, width: width, height: height })));
    icons.push(("Md5k".to_owned(), rsx!(Icon { icon: Md5k, width: width, height: height })));
    icons.push(("Md5kPlus".to_owned(), rsx!(Icon { icon: Md5kPlus, width: width, height: height })));
    icons.push(("Md6k".to_owned(), rsx!(Icon { icon: Md6k, width: width, height: height })));
    icons.push(("Md6kPlus".to_owned(), rsx!(Icon { icon: Md6kPlus, width: width, height: height })));
    icons.push(("Md7k".to_owned(), rsx!(Icon { icon: Md7k, width: width, height: height })));
    icons.push(("Md7kPlus".to_owned(), rsx!(Icon { icon: Md7kPlus, width: width, height: height })));
    icons.push(("Md8k".to_owned(), rsx!(Icon { icon: Md8k, width: width, height: height })));
    icons.push(("Md8kPlus".to_owned(), rsx!(Icon { icon: Md8kPlus, width: width, height: height })));
    icons.push(("Md9k".to_owned(), rsx!(Icon { icon: Md9k, width: width, height: height })));
    icons.push(("Md9kPlus".to_owned(), rsx!(Icon { icon: Md9kPlus, width: width, height: height })));
    icons.push(("MdAddToQueue".to_owned(), rsx!(Icon { icon: MdAddToQueue, width: width, height: height })));
    icons.push(("MdAirplay".to_owned(), rsx!(Icon { icon: MdAirplay, width: width, height: height })));
    icons.push(("MdAlbum".to_owned(), rsx!(Icon { icon: MdAlbum, width: width, height: height })));
    icons.push(("MdArtTrack".to_owned(), rsx!(Icon { icon: MdArtTrack, width: width, height: height })));
    icons.push(("MdAudioFile".to_owned(), rsx!(Icon { icon: MdAudioFile, width: width, height: height })));
    icons.push(("MdAvTimer".to_owned(), rsx!(Icon { icon: MdAvTimer, width: width, height: height })));
    icons.push(("MdBrandingWatermark".to_owned(), rsx!(Icon { icon: MdBrandingWatermark, width: width, height: height })));
    icons.push(("MdCallToAction".to_owned(), rsx!(Icon { icon: MdCallToAction, width: width, height: height })));
    icons.push(("MdClosedCaption".to_owned(), rsx!(Icon { icon: MdClosedCaption, width: width, height: height })));
    icons.push(("MdClosedCaptionDisabled".to_owned(), rsx!(Icon { icon: MdClosedCaptionDisabled, width: width, height: height })));
    icons.push(("MdClosedCaptionOff".to_owned(), rsx!(Icon { icon: MdClosedCaptionOff, width: width, height: height })));
    icons.push(("MdControlCamera".to_owned(), rsx!(Icon { icon: MdControlCamera, width: width, height: height })));
    icons.push(("MdEqualizer".to_owned(), rsx!(Icon { icon: MdEqualizer, width: width, height: height })));
    icons.push(("MdExplicit".to_owned(), rsx!(Icon { icon: MdExplicit, width: width, height: height })));
    icons.push(("MdFastForward".to_owned(), rsx!(Icon { icon: MdFastForward, width: width, height: height })));
    icons.push(("MdFastRewind".to_owned(), rsx!(Icon { icon: MdFastRewind, width: width, height: height })));
    icons.push(("MdFeaturedPlayList".to_owned(), rsx!(Icon { icon: MdFeaturedPlayList, width: width, height: height })));
    icons.push(("MdFeaturedVideo".to_owned(), rsx!(Icon { icon: MdFeaturedVideo, width: width, height: height })));
    icons.push(("MdFiberDvr".to_owned(), rsx!(Icon { icon: MdFiberDvr, width: width, height: height })));
    icons.push(("MdFiberManualRecord".to_owned(), rsx!(Icon { icon: MdFiberManualRecord, width: width, height: height })));
    icons.push(("MdFiberNew".to_owned(), rsx!(Icon { icon: MdFiberNew, width: width, height: height })));
    icons.push(("MdFiberPin".to_owned(), rsx!(Icon { icon: MdFiberPin, width: width, height: height })));
    icons.push(("MdFiberSmartRecord".to_owned(), rsx!(Icon { icon: MdFiberSmartRecord, width: width, height: height })));
    icons.push(("MdForward10".to_owned(), rsx!(Icon { icon: MdForward10, width: width, height: height })));
    icons.push(("MdForward30".to_owned(), rsx!(Icon { icon: MdForward30, width: width, height: height })));
    icons.push(("MdForward5".to_owned(), rsx!(Icon { icon: MdForward5, width: width, height: height })));
    icons.push(("MdGames".to_owned(), rsx!(Icon { icon: MdGames, width: width, height: height })));
    icons.push(("MdHd".to_owned(), rsx!(Icon { icon: MdHd, width: width, height: height })));
    icons.push(("MdHearing".to_owned(), rsx!(Icon { icon: MdHearing, width: width, height: height })));
    icons.push(("MdHearingDisabled".to_owned(), rsx!(Icon { icon: MdHearingDisabled, width: width, height: height })));
    icons.push(("MdHighQuality".to_owned(), rsx!(Icon { icon: MdHighQuality, width: width, height: height })));
    icons.push(("MdInterpreterMode".to_owned(), rsx!(Icon { icon: MdInterpreterMode, width: width, height: height })));
    icons.push(("MdLibraryAdd".to_owned(), rsx!(Icon { icon: MdLibraryAdd, width: width, height: height })));
    icons.push(("MdLibraryAddCheck".to_owned(), rsx!(Icon { icon: MdLibraryAddCheck, width: width, height: height })));
    icons.push(("MdLibraryBooks".to_owned(), rsx!(Icon { icon: MdLibraryBooks, width: width, height: height })));
    icons.push(("MdLibraryMusic".to_owned(), rsx!(Icon { icon: MdLibraryMusic, width: width, height: height })));
    icons.push(("MdLoop".to_owned(), rsx!(Icon { icon: MdLoop, width: width, height: height })));
    icons.push(("MdLyrics".to_owned(), rsx!(Icon { icon: MdLyrics, width: width, height: height })));
    icons.push(("MdMic".to_owned(), rsx!(Icon { icon: MdMic, width: width, height: height })));
    icons.push(("MdMicNone".to_owned(), rsx!(Icon { icon: MdMicNone, width: width, height: height })));
    icons.push(("MdMicOff".to_owned(), rsx!(Icon { icon: MdMicOff, width: width, height: height })));
    icons.push(("MdMissedVideoCall".to_owned(), rsx!(Icon { icon: MdMissedVideoCall, width: width, height: height })));
    icons.push(("MdMovie".to_owned(), rsx!(Icon { icon: MdMovie, width: width, height: height })));
    icons.push(("MdMovieEdit".to_owned(), rsx!(Icon { icon: MdMovieEdit, width: width, height: height })));
    icons.push(("MdMusicVideo".to_owned(), rsx!(Icon { icon: MdMusicVideo, width: width, height: height })));
    icons.push(("MdNewReleases".to_owned(), rsx!(Icon { icon: MdNewReleases, width: width, height: height })));
    icons.push(("MdNotInterested".to_owned(), rsx!(Icon { icon: MdNotInterested, width: width, height: height })));
    icons.push(("MdNote".to_owned(), rsx!(Icon { icon: MdNote, width: width, height: height })));
    icons.push(("MdPause".to_owned(), rsx!(Icon { icon: MdPause, width: width, height: height })));
    icons.push(("MdPauseCircle".to_owned(), rsx!(Icon { icon: MdPauseCircle, width: width, height: height })));
    icons.push(("MdPauseCircleFilled".to_owned(), rsx!(Icon { icon: MdPauseCircleFilled, width: width, height: height })));
    icons.push(("MdPauseCircleOutline".to_owned(), rsx!(Icon { icon: MdPauseCircleOutline, width: width, height: height })));
    icons.push(("MdPlayArrow".to_owned(), rsx!(Icon { icon: MdPlayArrow, width: width, height: height })));
    icons.push(("MdPlayCircle".to_owned(), rsx!(Icon { icon: MdPlayCircle, width: width, height: height })));
    icons.push(("MdPlayCircleFilled".to_owned(), rsx!(Icon { icon: MdPlayCircleFilled, width: width, height: height })));
    icons.push(("MdPlayCircleOutline".to_owned(), rsx!(Icon { icon: MdPlayCircleOutline, width: width, height: height })));
    icons.push(("MdPlayDisabled".to_owned(), rsx!(Icon { icon: MdPlayDisabled, width: width, height: height })));
    icons.push(("MdPlaylistAdd".to_owned(), rsx!(Icon { icon: MdPlaylistAdd, width: width, height: height })));
    icons.push(("MdPlaylistAddCheck".to_owned(), rsx!(Icon { icon: MdPlaylistAddCheck, width: width, height: height })));
    icons.push(("MdPlaylistAddCheckCircle".to_owned(), rsx!(Icon { icon: MdPlaylistAddCheckCircle, width: width, height: height })));
    icons.push(("MdPlaylistAddCircle".to_owned(), rsx!(Icon { icon: MdPlaylistAddCircle, width: width, height: height })));
    icons.push(("MdPlaylistPlay".to_owned(), rsx!(Icon { icon: MdPlaylistPlay, width: width, height: height })));
    icons.push(("MdPlaylistRemove".to_owned(), rsx!(Icon { icon: MdPlaylistRemove, width: width, height: height })));
    icons.push(("MdQueue".to_owned(), rsx!(Icon { icon: MdQueue, width: width, height: height })));
    icons.push(("MdQueueMusic".to_owned(), rsx!(Icon { icon: MdQueueMusic, width: width, height: height })));
    icons.push(("MdQueuePlayNext".to_owned(), rsx!(Icon { icon: MdQueuePlayNext, width: width, height: height })));
    icons.push(("MdRadio".to_owned(), rsx!(Icon { icon: MdRadio, width: width, height: height })));
    icons.push(("MdRecentActors".to_owned(), rsx!(Icon { icon: MdRecentActors, width: width, height: height })));
    icons.push(("MdRemoveFromQueue".to_owned(), rsx!(Icon { icon: MdRemoveFromQueue, width: width, height: height })));
    icons.push(("MdRepeat".to_owned(), rsx!(Icon { icon: MdRepeat, width: width, height: height })));
    icons.push(("MdRepeatOn".to_owned(), rsx!(Icon { icon: MdRepeatOn, width: width, height: height })));
    icons.push(("MdRepeatOne".to_owned(), rsx!(Icon { icon: MdRepeatOne, width: width, height: height })));
    icons.push(("MdRepeatOneOn".to_owned(), rsx!(Icon { icon: MdRepeatOneOn, width: width, height: height })));
    icons.push(("MdReplay".to_owned(), rsx!(Icon { icon: MdReplay, width: width, height: height })));
    icons.push(("MdReplay10".to_owned(), rsx!(Icon { icon: MdReplay10, width: width, height: height })));
    icons.push(("MdReplay30".to_owned(), rsx!(Icon { icon: MdReplay30, width: width, height: height })));
    icons.push(("MdReplay5".to_owned(), rsx!(Icon { icon: MdReplay5, width: width, height: height })));
    icons.push(("MdReplayCircleFilled".to_owned(), rsx!(Icon { icon: MdReplayCircleFilled, width: width, height: height })));
    icons.push(("MdSd".to_owned(), rsx!(Icon { icon: MdSd, width: width, height: height })));
    icons.push(("MdShuffle".to_owned(), rsx!(Icon { icon: MdShuffle, width: width, height: height })));
    icons.push(("MdShuffleOn".to_owned(), rsx!(Icon { icon: MdShuffleOn, width: width, height: height })));
    icons.push(("MdSkipNext".to_owned(), rsx!(Icon { icon: MdSkipNext, width: width, height: height })));
    icons.push(("MdSkipPrevious".to_owned(), rsx!(Icon { icon: MdSkipPrevious, width: width, height: height })));
    icons.push(("MdSlowMotionVideo".to_owned(), rsx!(Icon { icon: MdSlowMotionVideo, width: width, height: height })));
    icons.push(("MdSnooze".to_owned(), rsx!(Icon { icon: MdSnooze, width: width, height: height })));
    icons.push(("MdSortByAlpha".to_owned(), rsx!(Icon { icon: MdSortByAlpha, width: width, height: height })));
    icons.push(("MdSpeed".to_owned(), rsx!(Icon { icon: MdSpeed, width: width, height: height })));
    icons.push(("MdStop".to_owned(), rsx!(Icon { icon: MdStop, width: width, height: height })));
    icons.push(("MdStopCircle".to_owned(), rsx!(Icon { icon: MdStopCircle, width: width, height: height })));
    icons.push(("MdSubscriptions".to_owned(), rsx!(Icon { icon: MdSubscriptions, width: width, height: height })));
    icons.push(("MdSubtitles".to_owned(), rsx!(Icon { icon: MdSubtitles, width: width, height: height })));
    icons.push(("MdSurroundSound".to_owned(), rsx!(Icon { icon: MdSurroundSound, width: width, height: height })));
    icons.push(("MdVideoCall".to_owned(), rsx!(Icon { icon: MdVideoCall, width: width, height: height })));
    icons.push(("MdVideoFile".to_owned(), rsx!(Icon { icon: MdVideoFile, width: width, height: height })));
    icons.push(("MdVideoLabel".to_owned(), rsx!(Icon { icon: MdVideoLabel, width: width, height: height })));
    icons.push(("MdVideoLibrary".to_owned(), rsx!(Icon { icon: MdVideoLibrary, width: width, height: height })));
    icons.push(("MdVideoSettings".to_owned(), rsx!(Icon { icon: MdVideoSettings, width: width, height: height })));
    icons.push(("MdVideocam".to_owned(), rsx!(Icon { icon: MdVideocam, width: width, height: height })));
    icons.push(("MdVideocamOff".to_owned(), rsx!(Icon { icon: MdVideocamOff, width: width, height: height })));
    icons.push(("MdVolumeDown".to_owned(), rsx!(Icon { icon: MdVolumeDown, width: width, height: height })));
    icons.push(("MdVolumeDownAlt".to_owned(), rsx!(Icon { icon: MdVolumeDownAlt, width: width, height: height })));
    icons.push(("MdVolumeMute".to_owned(), rsx!(Icon { icon: MdVolumeMute, width: width, height: height })));
    icons.push(("MdVolumeOff".to_owned(), rsx!(Icon { icon: MdVolumeOff, width: width, height: height })));
    icons.push(("MdVolumeUp".to_owned(), rsx!(Icon { icon: MdVolumeUp, width: width, height: height })));
    icons.push(("MdWeb".to_owned(), rsx!(Icon { icon: MdWeb, width: width, height: height })));
    icons.push(("MdWebAsset".to_owned(), rsx!(Icon { icon: MdWebAsset, width: width, height: height })));
    icons.push(("MdWebAssetOff".to_owned(), rsx!(Icon { icon: MdWebAssetOff, width: width, height: height })));
    icons
}}
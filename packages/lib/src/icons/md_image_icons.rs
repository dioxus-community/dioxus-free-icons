...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("Md10mp".to_owned(), rsx!(Icon { icon: Md10mp, width: width, height: height })));
    icons.push(("Md11mp".to_owned(), rsx!(Icon { icon: Md11mp, width: width, height: height })));
    icons.push(("Md12mp".to_owned(), rsx!(Icon { icon: Md12mp, width: width, height: height })));
    icons.push(("Md13mp".to_owned(), rsx!(Icon { icon: Md13mp, width: width, height: height })));
    icons.push(("Md14mp".to_owned(), rsx!(Icon { icon: Md14mp, width: width, height: height })));
    icons.push(("Md15mp".to_owned(), rsx!(Icon { icon: Md15mp, width: width, height: height })));
    icons.push(("Md16mp".to_owned(), rsx!(Icon { icon: Md16mp, width: width, height: height })));
    icons.push(("Md17mp".to_owned(), rsx!(Icon { icon: Md17mp, width: width, height: height })));
    icons.push(("Md18mp".to_owned(), rsx!(Icon { icon: Md18mp, width: width, height: height })));
    icons.push(("Md19mp".to_owned(), rsx!(Icon { icon: Md19mp, width: width, height: height })));
    icons.push(("Md20mp".to_owned(), rsx!(Icon { icon: Md20mp, width: width, height: height })));
    icons.push(("Md21mp".to_owned(), rsx!(Icon { icon: Md21mp, width: width, height: height })));
    icons.push(("Md22mp".to_owned(), rsx!(Icon { icon: Md22mp, width: width, height: height })));
    icons.push(("Md23mp".to_owned(), rsx!(Icon { icon: Md23mp, width: width, height: height })));
    icons.push(("Md24mp".to_owned(), rsx!(Icon { icon: Md24mp, width: width, height: height })));
    icons.push(("Md2mp".to_owned(), rsx!(Icon { icon: Md2mp, width: width, height: height })));
    icons.push(("Md30fpsSelect".to_owned(), rsx!(Icon { icon: Md30fpsSelect, width: width, height: height })));
    icons.push(("Md3mp".to_owned(), rsx!(Icon { icon: Md3mp, width: width, height: height })));
    icons.push(("Md4mp".to_owned(), rsx!(Icon { icon: Md4mp, width: width, height: height })));
    icons.push(("Md5mp".to_owned(), rsx!(Icon { icon: Md5mp, width: width, height: height })));
    icons.push(("Md60fpsSelect".to_owned(), rsx!(Icon { icon: Md60fpsSelect, width: width, height: height })));
    icons.push(("Md6mp".to_owned(), rsx!(Icon { icon: Md6mp, width: width, height: height })));
    icons.push(("Md7mp".to_owned(), rsx!(Icon { icon: Md7mp, width: width, height: height })));
    icons.push(("Md8mp".to_owned(), rsx!(Icon { icon: Md8mp, width: width, height: height })));
    icons.push(("Md9mp".to_owned(), rsx!(Icon { icon: Md9mp, width: width, height: height })));
    icons.push(("MdAddAPhoto".to_owned(), rsx!(Icon { icon: MdAddAPhoto, width: width, height: height })));
    icons.push(("MdAddPhotoAlternate".to_owned(), rsx!(Icon { icon: MdAddPhotoAlternate, width: width, height: height })));
    icons.push(("MdAddToPhotos".to_owned(), rsx!(Icon { icon: MdAddToPhotos, width: width, height: height })));
    icons.push(("MdAdjust".to_owned(), rsx!(Icon { icon: MdAdjust, width: width, height: height })));
    icons.push(("MdAnimation".to_owned(), rsx!(Icon { icon: MdAnimation, width: width, height: height })));
    icons.push(("MdAssistant".to_owned(), rsx!(Icon { icon: MdAssistant, width: width, height: height })));
    icons.push(("MdAssistantPhoto".to_owned(), rsx!(Icon { icon: MdAssistantPhoto, width: width, height: height })));
    icons.push(("MdAudiotrack".to_owned(), rsx!(Icon { icon: MdAudiotrack, width: width, height: height })));
    icons.push(("MdAutoAwesome".to_owned(), rsx!(Icon { icon: MdAutoAwesome, width: width, height: height })));
    icons.push(("MdAutoAwesomeMosaic".to_owned(), rsx!(Icon { icon: MdAutoAwesomeMosaic, width: width, height: height })));
    icons.push(("MdAutoAwesomeMotion".to_owned(), rsx!(Icon { icon: MdAutoAwesomeMotion, width: width, height: height })));
    icons.push(("MdAutoFixHigh".to_owned(), rsx!(Icon { icon: MdAutoFixHigh, width: width, height: height })));
    icons.push(("MdAutoFixNormal".to_owned(), rsx!(Icon { icon: MdAutoFixNormal, width: width, height: height })));
    icons.push(("MdAutoFixOff".to_owned(), rsx!(Icon { icon: MdAutoFixOff, width: width, height: height })));
    icons.push(("MdAutoStories".to_owned(), rsx!(Icon { icon: MdAutoStories, width: width, height: height })));
    icons.push(("MdAutofpsSelect".to_owned(), rsx!(Icon { icon: MdAutofpsSelect, width: width, height: height })));
    icons.push(("MdBedtime".to_owned(), rsx!(Icon { icon: MdBedtime, width: width, height: height })));
    icons.push(("MdBedtimeOff".to_owned(), rsx!(Icon { icon: MdBedtimeOff, width: width, height: height })));
    icons.push(("MdBlurCircular".to_owned(), rsx!(Icon { icon: MdBlurCircular, width: width, height: height })));
    icons.push(("MdBlurLinear".to_owned(), rsx!(Icon { icon: MdBlurLinear, width: width, height: height })));
    icons.push(("MdBlurOff".to_owned(), rsx!(Icon { icon: MdBlurOff, width: width, height: height })));
    icons.push(("MdBlurOn".to_owned(), rsx!(Icon { icon: MdBlurOn, width: width, height: height })));
    icons.push(("MdBrightness1".to_owned(), rsx!(Icon { icon: MdBrightness1, width: width, height: height })));
    icons.push(("MdBrightness2".to_owned(), rsx!(Icon { icon: MdBrightness2, width: width, height: height })));
    icons.push(("MdBrightness3".to_owned(), rsx!(Icon { icon: MdBrightness3, width: width, height: height })));
    icons.push(("MdBrightness4".to_owned(), rsx!(Icon { icon: MdBrightness4, width: width, height: height })));
    icons.push(("MdBrightness5".to_owned(), rsx!(Icon { icon: MdBrightness5, width: width, height: height })));
    icons.push(("MdBrightness6".to_owned(), rsx!(Icon { icon: MdBrightness6, width: width, height: height })));
    icons.push(("MdBrightness7".to_owned(), rsx!(Icon { icon: MdBrightness7, width: width, height: height })));
    icons.push(("MdBrokenImage".to_owned(), rsx!(Icon { icon: MdBrokenImage, width: width, height: height })));
    icons.push(("MdBrush".to_owned(), rsx!(Icon { icon: MdBrush, width: width, height: height })));
    icons.push(("MdBurstMode".to_owned(), rsx!(Icon { icon: MdBurstMode, width: width, height: height })));
    icons.push(("MdCamera".to_owned(), rsx!(Icon { icon: MdCamera, width: width, height: height })));
    icons.push(("MdCameraAlt".to_owned(), rsx!(Icon { icon: MdCameraAlt, width: width, height: height })));
    icons.push(("MdCameraFront".to_owned(), rsx!(Icon { icon: MdCameraFront, width: width, height: height })));
    icons.push(("MdCameraRear".to_owned(), rsx!(Icon { icon: MdCameraRear, width: width, height: height })));
    icons.push(("MdCameraRoll".to_owned(), rsx!(Icon { icon: MdCameraRoll, width: width, height: height })));
    icons.push(("MdCases".to_owned(), rsx!(Icon { icon: MdCases, width: width, height: height })));
    icons.push(("MdCenterFocusStrong".to_owned(), rsx!(Icon { icon: MdCenterFocusStrong, width: width, height: height })));
    icons.push(("MdCenterFocusWeak".to_owned(), rsx!(Icon { icon: MdCenterFocusWeak, width: width, height: height })));
    icons.push(("MdCircle".to_owned(), rsx!(Icon { icon: MdCircle, width: width, height: height })));
    icons.push(("MdCollections".to_owned(), rsx!(Icon { icon: MdCollections, width: width, height: height })));
    icons.push(("MdCollectionsBookmark".to_owned(), rsx!(Icon { icon: MdCollectionsBookmark, width: width, height: height })));
    icons.push(("MdColorLens".to_owned(), rsx!(Icon { icon: MdColorLens, width: width, height: height })));
    icons.push(("MdColorize".to_owned(), rsx!(Icon { icon: MdColorize, width: width, height: height })));
    icons.push(("MdCompare".to_owned(), rsx!(Icon { icon: MdCompare, width: width, height: height })));
    icons.push(("MdContrast".to_owned(), rsx!(Icon { icon: MdContrast, width: width, height: height })));
    icons.push(("MdControlPoint".to_owned(), rsx!(Icon { icon: MdControlPoint, width: width, height: height })));
    icons.push(("MdControlPointDuplicate".to_owned(), rsx!(Icon { icon: MdControlPointDuplicate, width: width, height: height })));
    icons.push(("MdCrop".to_owned(), rsx!(Icon { icon: MdCrop, width: width, height: height })));
    icons.push(("MdCrop169".to_owned(), rsx!(Icon { icon: MdCrop169, width: width, height: height })));
    icons.push(("MdCrop32".to_owned(), rsx!(Icon { icon: MdCrop32, width: width, height: height })));
    icons.push(("MdCrop54".to_owned(), rsx!(Icon { icon: MdCrop54, width: width, height: height })));
    icons.push(("MdCrop75".to_owned(), rsx!(Icon { icon: MdCrop75, width: width, height: height })));
    icons.push(("MdCropDin".to_owned(), rsx!(Icon { icon: MdCropDin, width: width, height: height })));
    icons.push(("MdCropFree".to_owned(), rsx!(Icon { icon: MdCropFree, width: width, height: height })));
    icons.push(("MdCropLandscape".to_owned(), rsx!(Icon { icon: MdCropLandscape, width: width, height: height })));
    icons.push(("MdCropOriginal".to_owned(), rsx!(Icon { icon: MdCropOriginal, width: width, height: height })));
    icons.push(("MdCropPortrait".to_owned(), rsx!(Icon { icon: MdCropPortrait, width: width, height: height })));
    icons.push(("MdCropRotate".to_owned(), rsx!(Icon { icon: MdCropRotate, width: width, height: height })));
    icons.push(("MdCropSquare".to_owned(), rsx!(Icon { icon: MdCropSquare, width: width, height: height })));
    icons.push(("MdCurrencyBitcoin".to_owned(), rsx!(Icon { icon: MdCurrencyBitcoin, width: width, height: height })));
    icons.push(("MdCurrencyFranc".to_owned(), rsx!(Icon { icon: MdCurrencyFranc, width: width, height: height })));
    icons.push(("MdCurrencyLira".to_owned(), rsx!(Icon { icon: MdCurrencyLira, width: width, height: height })));
    icons.push(("MdCurrencyPound".to_owned(), rsx!(Icon { icon: MdCurrencyPound, width: width, height: height })));
    icons.push(("MdCurrencyRuble".to_owned(), rsx!(Icon { icon: MdCurrencyRuble, width: width, height: height })));
    icons.push(("MdCurrencyRupee".to_owned(), rsx!(Icon { icon: MdCurrencyRupee, width: width, height: height })));
    icons.push(("MdCurrencyYen".to_owned(), rsx!(Icon { icon: MdCurrencyYen, width: width, height: height })));
    icons.push(("MdCurrencyYuan".to_owned(), rsx!(Icon { icon: MdCurrencyYuan, width: width, height: height })));
    icons.push(("MdDeblur".to_owned(), rsx!(Icon { icon: MdDeblur, width: width, height: height })));
    icons.push(("MdDehaze".to_owned(), rsx!(Icon { icon: MdDehaze, width: width, height: height })));
    icons.push(("MdDetails".to_owned(), rsx!(Icon { icon: MdDetails, width: width, height: height })));
    icons.push(("MdDirtyLens".to_owned(), rsx!(Icon { icon: MdDirtyLens, width: width, height: height })));
    icons.push(("MdEdit".to_owned(), rsx!(Icon { icon: MdEdit, width: width, height: height })));
    icons.push(("MdEuro".to_owned(), rsx!(Icon { icon: MdEuro, width: width, height: height })));
    icons.push(("MdExposure".to_owned(), rsx!(Icon { icon: MdExposure, width: width, height: height })));
    icons.push(("MdExposureNeg1".to_owned(), rsx!(Icon { icon: MdExposureNeg1, width: width, height: height })));
    icons.push(("MdExposureNeg2".to_owned(), rsx!(Icon { icon: MdExposureNeg2, width: width, height: height })));
    icons.push(("MdExposurePlus1".to_owned(), rsx!(Icon { icon: MdExposurePlus1, width: width, height: height })));
    icons.push(("MdExposurePlus2".to_owned(), rsx!(Icon { icon: MdExposurePlus2, width: width, height: height })));
    icons.push(("MdExposureZero".to_owned(), rsx!(Icon { icon: MdExposureZero, width: width, height: height })));
    icons.push(("MdFaceRetouchingNatural".to_owned(), rsx!(Icon { icon: MdFaceRetouchingNatural, width: width, height: height })));
    icons.push(("MdFaceRetouchingOff".to_owned(), rsx!(Icon { icon: MdFaceRetouchingOff, width: width, height: height })));
    icons.push(("MdFilter".to_owned(), rsx!(Icon { icon: MdFilter, width: width, height: height })));
    icons.push(("MdFilter1".to_owned(), rsx!(Icon { icon: MdFilter1, width: width, height: height })));
    icons.push(("MdFilter2".to_owned(), rsx!(Icon { icon: MdFilter2, width: width, height: height })));
    icons.push(("MdFilter3".to_owned(), rsx!(Icon { icon: MdFilter3, width: width, height: height })));
    icons.push(("MdFilter4".to_owned(), rsx!(Icon { icon: MdFilter4, width: width, height: height })));
    icons.push(("MdFilter5".to_owned(), rsx!(Icon { icon: MdFilter5, width: width, height: height })));
    icons.push(("MdFilter6".to_owned(), rsx!(Icon { icon: MdFilter6, width: width, height: height })));
    icons.push(("MdFilter7".to_owned(), rsx!(Icon { icon: MdFilter7, width: width, height: height })));
    icons.push(("MdFilter8".to_owned(), rsx!(Icon { icon: MdFilter8, width: width, height: height })));
    icons.push(("MdFilter9".to_owned(), rsx!(Icon { icon: MdFilter9, width: width, height: height })));
    icons.push(("MdFilter9Plus".to_owned(), rsx!(Icon { icon: MdFilter9Plus, width: width, height: height })));
    icons.push(("MdFilterBAndW".to_owned(), rsx!(Icon { icon: MdFilterBAndW, width: width, height: height })));
    icons.push(("MdFilterCenterFocus".to_owned(), rsx!(Icon { icon: MdFilterCenterFocus, width: width, height: height })));
    icons.push(("MdFilterDrama".to_owned(), rsx!(Icon { icon: MdFilterDrama, width: width, height: height })));
    icons.push(("MdFilterFrames".to_owned(), rsx!(Icon { icon: MdFilterFrames, width: width, height: height })));
    icons.push(("MdFilterHdr".to_owned(), rsx!(Icon { icon: MdFilterHdr, width: width, height: height })));
    icons.push(("MdFilterNone".to_owned(), rsx!(Icon { icon: MdFilterNone, width: width, height: height })));
    icons.push(("MdFilterTiltShift".to_owned(), rsx!(Icon { icon: MdFilterTiltShift, width: width, height: height })));
    icons.push(("MdFilterVintage".to_owned(), rsx!(Icon { icon: MdFilterVintage, width: width, height: height })));
    icons.push(("MdFlare".to_owned(), rsx!(Icon { icon: MdFlare, width: width, height: height })));
    icons.push(("MdFlashAuto".to_owned(), rsx!(Icon { icon: MdFlashAuto, width: width, height: height })));
    icons.push(("MdFlashOff".to_owned(), rsx!(Icon { icon: MdFlashOff, width: width, height: height })));
    icons.push(("MdFlashOn".to_owned(), rsx!(Icon { icon: MdFlashOn, width: width, height: height })));
    icons.push(("MdFlip".to_owned(), rsx!(Icon { icon: MdFlip, width: width, height: height })));
    icons.push(("MdFlipCameraAndroid".to_owned(), rsx!(Icon { icon: MdFlipCameraAndroid, width: width, height: height })));
    icons.push(("MdFlipCameraIos".to_owned(), rsx!(Icon { icon: MdFlipCameraIos, width: width, height: height })));
    icons.push(("MdGradient".to_owned(), rsx!(Icon { icon: MdGradient, width: width, height: height })));
    icons.push(("MdGrain".to_owned(), rsx!(Icon { icon: MdGrain, width: width, height: height })));
    icons.push(("MdGridOff".to_owned(), rsx!(Icon { icon: MdGridOff, width: width, height: height })));
    icons.push(("MdGridOn".to_owned(), rsx!(Icon { icon: MdGridOn, width: width, height: height })));
    icons.push(("MdHdrEnhancedSelect".to_owned(), rsx!(Icon { icon: MdHdrEnhancedSelect, width: width, height: height })));
    icons.push(("MdHdrOff".to_owned(), rsx!(Icon { icon: MdHdrOff, width: width, height: height })));
    icons.push(("MdHdrOn".to_owned(), rsx!(Icon { icon: MdHdrOn, width: width, height: height })));
    icons.push(("MdHdrPlus".to_owned(), rsx!(Icon { icon: MdHdrPlus, width: width, height: height })));
    icons.push(("MdHdrStrong".to_owned(), rsx!(Icon { icon: MdHdrStrong, width: width, height: height })));
    icons.push(("MdHdrWeak".to_owned(), rsx!(Icon { icon: MdHdrWeak, width: width, height: height })));
    icons.push(("MdHealing".to_owned(), rsx!(Icon { icon: MdHealing, width: width, height: height })));
    icons.push(("MdHevc".to_owned(), rsx!(Icon { icon: MdHevc, width: width, height: height })));
    icons.push(("MdHideImage".to_owned(), rsx!(Icon { icon: MdHideImage, width: width, height: height })));
    icons.push(("MdImage".to_owned(), rsx!(Icon { icon: MdImage, width: width, height: height })));
    icons.push(("MdImageAspectRatio".to_owned(), rsx!(Icon { icon: MdImageAspectRatio, width: width, height: height })));
    icons.push(("MdImageNotSupported".to_owned(), rsx!(Icon { icon: MdImageNotSupported, width: width, height: height })));
    icons.push(("MdImageSearch".to_owned(), rsx!(Icon { icon: MdImageSearch, width: width, height: height })));
    icons.push(("MdIncompleteCircle".to_owned(), rsx!(Icon { icon: MdIncompleteCircle, width: width, height: height })));
    icons.push(("MdIso".to_owned(), rsx!(Icon { icon: MdIso, width: width, height: height })));
    icons.push(("MdLandscape".to_owned(), rsx!(Icon { icon: MdLandscape, width: width, height: height })));
    icons.push(("MdLeakAdd".to_owned(), rsx!(Icon { icon: MdLeakAdd, width: width, height: height })));
    icons.push(("MdLeakRemove".to_owned(), rsx!(Icon { icon: MdLeakRemove, width: width, height: height })));
    icons.push(("MdLens".to_owned(), rsx!(Icon { icon: MdLens, width: width, height: height })));
    icons.push(("MdLinkedCamera".to_owned(), rsx!(Icon { icon: MdLinkedCamera, width: width, height: height })));
    icons.push(("MdLogoDev".to_owned(), rsx!(Icon { icon: MdLogoDev, width: width, height: height })));
    icons.push(("MdLooks".to_owned(), rsx!(Icon { icon: MdLooks, width: width, height: height })));
    icons.push(("MdLooks3".to_owned(), rsx!(Icon { icon: MdLooks3, width: width, height: height })));
    icons.push(("MdLooks4".to_owned(), rsx!(Icon { icon: MdLooks4, width: width, height: height })));
    icons.push(("MdLooks5".to_owned(), rsx!(Icon { icon: MdLooks5, width: width, height: height })));
    icons.push(("MdLooks6".to_owned(), rsx!(Icon { icon: MdLooks6, width: width, height: height })));
    icons.push(("MdLooksOne".to_owned(), rsx!(Icon { icon: MdLooksOne, width: width, height: height })));
    icons.push(("MdLooksTwo".to_owned(), rsx!(Icon { icon: MdLooksTwo, width: width, height: height })));
    icons.push(("MdLoupe".to_owned(), rsx!(Icon { icon: MdLoupe, width: width, height: height })));
    icons.push(("MdMicExternalOff".to_owned(), rsx!(Icon { icon: MdMicExternalOff, width: width, height: height })));
    icons.push(("MdMicExternalOn".to_owned(), rsx!(Icon { icon: MdMicExternalOn, width: width, height: height })));
    icons.push(("MdMonochromePhotos".to_owned(), rsx!(Icon { icon: MdMonochromePhotos, width: width, height: height })));
    icons.push(("MdMotionPhotosAuto".to_owned(), rsx!(Icon { icon: MdMotionPhotosAuto, width: width, height: height })));
    icons.push(("MdMotionPhotosOff".to_owned(), rsx!(Icon { icon: MdMotionPhotosOff, width: width, height: height })));
    icons.push(("MdMotionPhotosOn".to_owned(), rsx!(Icon { icon: MdMotionPhotosOn, width: width, height: height })));
    icons.push(("MdMotionPhotosPause".to_owned(), rsx!(Icon { icon: MdMotionPhotosPause, width: width, height: height })));
    icons.push(("MdMotionPhotosPaused".to_owned(), rsx!(Icon { icon: MdMotionPhotosPaused, width: width, height: height })));
    icons.push(("MdMovieCreation".to_owned(), rsx!(Icon { icon: MdMovieCreation, width: width, height: height })));
    icons.push(("MdMovieFilter".to_owned(), rsx!(Icon { icon: MdMovieFilter, width: width, height: height })));
    icons.push(("MdMp".to_owned(), rsx!(Icon { icon: MdMp, width: width, height: height })));
    icons.push(("MdMusicNote".to_owned(), rsx!(Icon { icon: MdMusicNote, width: width, height: height })));
    icons.push(("MdMusicOff".to_owned(), rsx!(Icon { icon: MdMusicOff, width: width, height: height })));
    icons.push(("MdNature".to_owned(), rsx!(Icon { icon: MdNature, width: width, height: height })));
    icons.push(("MdNaturePeople".to_owned(), rsx!(Icon { icon: MdNaturePeople, width: width, height: height })));
    icons.push(("MdNavigateBefore".to_owned(), rsx!(Icon { icon: MdNavigateBefore, width: width, height: height })));
    icons.push(("MdNavigateNext".to_owned(), rsx!(Icon { icon: MdNavigateNext, width: width, height: height })));
    icons.push(("MdPalette".to_owned(), rsx!(Icon { icon: MdPalette, width: width, height: height })));
    icons.push(("MdPanorama".to_owned(), rsx!(Icon { icon: MdPanorama, width: width, height: height })));
    icons.push(("MdPanoramaFishEye".to_owned(), rsx!(Icon { icon: MdPanoramaFishEye, width: width, height: height })));
    icons.push(("MdPanoramaHorizontal".to_owned(), rsx!(Icon { icon: MdPanoramaHorizontal, width: width, height: height })));
    icons.push(("MdPanoramaHorizontalSelect".to_owned(), rsx!(Icon { icon: MdPanoramaHorizontalSelect, width: width, height: height })));
    icons.push(("MdPanoramaPhotosphere".to_owned(), rsx!(Icon { icon: MdPanoramaPhotosphere, width: width, height: height })));
    icons.push(("MdPanoramaPhotosphereSelect".to_owned(), rsx!(Icon { icon: MdPanoramaPhotosphereSelect, width: width, height: height })));
    icons.push(("MdPanoramaVertical".to_owned(), rsx!(Icon { icon: MdPanoramaVertical, width: width, height: height })));
    icons.push(("MdPanoramaVerticalSelect".to_owned(), rsx!(Icon { icon: MdPanoramaVerticalSelect, width: width, height: height })));
    icons.push(("MdPanoramaWideAngle".to_owned(), rsx!(Icon { icon: MdPanoramaWideAngle, width: width, height: height })));
    icons.push(("MdPanoramaWideAngleSelect".to_owned(), rsx!(Icon { icon: MdPanoramaWideAngleSelect, width: width, height: height })));
    icons.push(("MdPhoto".to_owned(), rsx!(Icon { icon: MdPhoto, width: width, height: height })));
    icons.push(("MdPhotoAlbum".to_owned(), rsx!(Icon { icon: MdPhotoAlbum, width: width, height: height })));
    icons.push(("MdPhotoCamera".to_owned(), rsx!(Icon { icon: MdPhotoCamera, width: width, height: height })));
    icons.push(("MdPhotoCameraBack".to_owned(), rsx!(Icon { icon: MdPhotoCameraBack, width: width, height: height })));
    icons.push(("MdPhotoCameraFront".to_owned(), rsx!(Icon { icon: MdPhotoCameraFront, width: width, height: height })));
    icons.push(("MdPhotoFilter".to_owned(), rsx!(Icon { icon: MdPhotoFilter, width: width, height: height })));
    icons.push(("MdPhotoLibrary".to_owned(), rsx!(Icon { icon: MdPhotoLibrary, width: width, height: height })));
    icons.push(("MdPhotoSizeSelectActual".to_owned(), rsx!(Icon { icon: MdPhotoSizeSelectActual, width: width, height: height })));
    icons.push(("MdPhotoSizeSelectLarge".to_owned(), rsx!(Icon { icon: MdPhotoSizeSelectLarge, width: width, height: height })));
    icons.push(("MdPhotoSizeSelectSmall".to_owned(), rsx!(Icon { icon: MdPhotoSizeSelectSmall, width: width, height: height })));
    icons.push(("MdPictureAsPdf".to_owned(), rsx!(Icon { icon: MdPictureAsPdf, width: width, height: height })));
    icons.push(("MdPortrait".to_owned(), rsx!(Icon { icon: MdPortrait, width: width, height: height })));
    icons.push(("MdRawOff".to_owned(), rsx!(Icon { icon: MdRawOff, width: width, height: height })));
    icons.push(("MdRawOn".to_owned(), rsx!(Icon { icon: MdRawOn, width: width, height: height })));
    icons.push(("MdReceiptLong".to_owned(), rsx!(Icon { icon: MdReceiptLong, width: width, height: height })));
    icons.push(("MdRemoveRedEye".to_owned(), rsx!(Icon { icon: MdRemoveRedEye, width: width, height: height })));
    icons.push(("MdRotate90DegreesCcw".to_owned(), rsx!(Icon { icon: MdRotate90DegreesCcw, width: width, height: height })));
    icons.push(("MdRotate90DegreesCw".to_owned(), rsx!(Icon { icon: MdRotate90DegreesCw, width: width, height: height })));
    icons.push(("MdRotateLeft".to_owned(), rsx!(Icon { icon: MdRotateLeft, width: width, height: height })));
    icons.push(("MdRotateRight".to_owned(), rsx!(Icon { icon: MdRotateRight, width: width, height: height })));
    icons.push(("MdShutterSpeed".to_owned(), rsx!(Icon { icon: MdShutterSpeed, width: width, height: height })));
    icons.push(("MdSlideshow".to_owned(), rsx!(Icon { icon: MdSlideshow, width: width, height: height })));
    icons.push(("MdStraighten".to_owned(), rsx!(Icon { icon: MdStraighten, width: width, height: height })));
    icons.push(("MdStyle".to_owned(), rsx!(Icon { icon: MdStyle, width: width, height: height })));
    icons.push(("MdSwitchCamera".to_owned(), rsx!(Icon { icon: MdSwitchCamera, width: width, height: height })));
    icons.push(("MdSwitchVideo".to_owned(), rsx!(Icon { icon: MdSwitchVideo, width: width, height: height })));
    icons.push(("MdTagFaces".to_owned(), rsx!(Icon { icon: MdTagFaces, width: width, height: height })));
    icons.push(("MdTexture".to_owned(), rsx!(Icon { icon: MdTexture, width: width, height: height })));
    icons.push(("MdThermostatAuto".to_owned(), rsx!(Icon { icon: MdThermostatAuto, width: width, height: height })));
    icons.push(("MdTimelapse".to_owned(), rsx!(Icon { icon: MdTimelapse, width: width, height: height })));
    icons.push(("MdTimer".to_owned(), rsx!(Icon { icon: MdTimer, width: width, height: height })));
    icons.push(("MdTimer10".to_owned(), rsx!(Icon { icon: MdTimer10, width: width, height: height })));
    icons.push(("MdTimer3".to_owned(), rsx!(Icon { icon: MdTimer3, width: width, height: height })));
    icons.push(("MdTimerOff".to_owned(), rsx!(Icon { icon: MdTimerOff, width: width, height: height })));
    icons.push(("MdTonality".to_owned(), rsx!(Icon { icon: MdTonality, width: width, height: height })));
    icons.push(("MdTransform".to_owned(), rsx!(Icon { icon: MdTransform, width: width, height: height })));
    icons.push(("MdTune".to_owned(), rsx!(Icon { icon: MdTune, width: width, height: height })));
    icons.push(("MdVideoCameraBack".to_owned(), rsx!(Icon { icon: MdVideoCameraBack, width: width, height: height })));
    icons.push(("MdVideoCameraFront".to_owned(), rsx!(Icon { icon: MdVideoCameraFront, width: width, height: height })));
    icons.push(("MdVideoStable".to_owned(), rsx!(Icon { icon: MdVideoStable, width: width, height: height })));
    icons.push(("MdViewComfy".to_owned(), rsx!(Icon { icon: MdViewComfy, width: width, height: height })));
    icons.push(("MdViewCompact".to_owned(), rsx!(Icon { icon: MdViewCompact, width: width, height: height })));
    icons.push(("MdVignette".to_owned(), rsx!(Icon { icon: MdVignette, width: width, height: height })));
    icons.push(("MdVrpano".to_owned(), rsx!(Icon { icon: MdVrpano, width: width, height: height })));
    icons.push(("MdWbAuto".to_owned(), rsx!(Icon { icon: MdWbAuto, width: width, height: height })));
    icons.push(("MdWbCloudy".to_owned(), rsx!(Icon { icon: MdWbCloudy, width: width, height: height })));
    icons.push(("MdWbIncandescent".to_owned(), rsx!(Icon { icon: MdWbIncandescent, width: width, height: height })));
    icons.push(("MdWbIridescent".to_owned(), rsx!(Icon { icon: MdWbIridescent, width: width, height: height })));
    icons.push(("MdWbShade".to_owned(), rsx!(Icon { icon: MdWbShade, width: width, height: height })));
    icons.push(("MdWbSunny".to_owned(), rsx!(Icon { icon: MdWbSunny, width: width, height: height })));
    icons.push(("MdWbTwighlight".to_owned(), rsx!(Icon { icon: MdWbTwighlight, width: width, height: height })));
    icons.push(("MdWbTwilight".to_owned(), rsx!(Icon { icon: MdWbTwilight, width: width, height: height })));
    icons
}}
...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("FaAddressBook".to_owned(), rsx!(Icon { icon: FaAddressBook, width: width, height: height })));
    icons.push(("FaAddressCard".to_owned(), rsx!(Icon { icon: FaAddressCard, width: width, height: height })));
    icons.push(("FaBellSlash".to_owned(), rsx!(Icon { icon: FaBellSlash, width: width, height: height })));
    icons.push(("FaBell".to_owned(), rsx!(Icon { icon: FaBell, width: width, height: height })));
    icons.push(("FaBookmark".to_owned(), rsx!(Icon { icon: FaBookmark, width: width, height: height })));
    icons.push(("FaBuilding".to_owned(), rsx!(Icon { icon: FaBuilding, width: width, height: height })));
    icons.push(("FaCalendarCheck".to_owned(), rsx!(Icon { icon: FaCalendarCheck, width: width, height: height })));
    icons.push(("FaCalendarDays".to_owned(), rsx!(Icon { icon: FaCalendarDays, width: width, height: height })));
    icons.push(("FaCalendarMinus".to_owned(), rsx!(Icon { icon: FaCalendarMinus, width: width, height: height })));
    icons.push(("FaCalendarPlus".to_owned(), rsx!(Icon { icon: FaCalendarPlus, width: width, height: height })));
    icons.push(("FaCalendarXmark".to_owned(), rsx!(Icon { icon: FaCalendarXmark, width: width, height: height })));
    icons.push(("FaCalendar".to_owned(), rsx!(Icon { icon: FaCalendar, width: width, height: height })));
    icons.push(("FaChartBar".to_owned(), rsx!(Icon { icon: FaChartBar, width: width, height: height })));
    icons.push(("FaChessBishop".to_owned(), rsx!(Icon { icon: FaChessBishop, width: width, height: height })));
    icons.push(("FaChessKing".to_owned(), rsx!(Icon { icon: FaChessKing, width: width, height: height })));
    icons.push(("FaChessKnight".to_owned(), rsx!(Icon { icon: FaChessKnight, width: width, height: height })));
    icons.push(("FaChessPawn".to_owned(), rsx!(Icon { icon: FaChessPawn, width: width, height: height })));
    icons.push(("FaChessQueen".to_owned(), rsx!(Icon { icon: FaChessQueen, width: width, height: height })));
    icons.push(("FaChessRook".to_owned(), rsx!(Icon { icon: FaChessRook, width: width, height: height })));
    icons.push(("FaCircleCheck".to_owned(), rsx!(Icon { icon: FaCircleCheck, width: width, height: height })));
    icons.push(("FaCircleDot".to_owned(), rsx!(Icon { icon: FaCircleDot, width: width, height: height })));
    icons.push(("FaCircleDown".to_owned(), rsx!(Icon { icon: FaCircleDown, width: width, height: height })));
    icons.push(("FaCircleLeft".to_owned(), rsx!(Icon { icon: FaCircleLeft, width: width, height: height })));
    icons.push(("FaCirclePause".to_owned(), rsx!(Icon { icon: FaCirclePause, width: width, height: height })));
    icons.push(("FaCirclePlay".to_owned(), rsx!(Icon { icon: FaCirclePlay, width: width, height: height })));
    icons.push(("FaCircleQuestion".to_owned(), rsx!(Icon { icon: FaCircleQuestion, width: width, height: height })));
    icons.push(("FaCircleRight".to_owned(), rsx!(Icon { icon: FaCircleRight, width: width, height: height })));
    icons.push(("FaCircleStop".to_owned(), rsx!(Icon { icon: FaCircleStop, width: width, height: height })));
    icons.push(("FaCircleUp".to_owned(), rsx!(Icon { icon: FaCircleUp, width: width, height: height })));
    icons.push(("FaCircleUser".to_owned(), rsx!(Icon { icon: FaCircleUser, width: width, height: height })));
    icons.push(("FaCircleXmark".to_owned(), rsx!(Icon { icon: FaCircleXmark, width: width, height: height })));
    icons.push(("FaCircle".to_owned(), rsx!(Icon { icon: FaCircle, width: width, height: height })));
    icons.push(("FaClipboard".to_owned(), rsx!(Icon { icon: FaClipboard, width: width, height: height })));
    icons.push(("FaClock".to_owned(), rsx!(Icon { icon: FaClock, width: width, height: height })));
    icons.push(("FaClone".to_owned(), rsx!(Icon { icon: FaClone, width: width, height: height })));
    icons.push(("FaClosedCaptioning".to_owned(), rsx!(Icon { icon: FaClosedCaptioning, width: width, height: height })));
    icons.push(("FaCommentDots".to_owned(), rsx!(Icon { icon: FaCommentDots, width: width, height: height })));
    icons.push(("FaComment".to_owned(), rsx!(Icon { icon: FaComment, width: width, height: height })));
    icons.push(("FaComments".to_owned(), rsx!(Icon { icon: FaComments, width: width, height: height })));
    icons.push(("FaCompass".to_owned(), rsx!(Icon { icon: FaCompass, width: width, height: height })));
    icons.push(("FaCopy".to_owned(), rsx!(Icon { icon: FaCopy, width: width, height: height })));
    icons.push(("FaCopyright".to_owned(), rsx!(Icon { icon: FaCopyright, width: width, height: height })));
    icons.push(("FaCreditCard".to_owned(), rsx!(Icon { icon: FaCreditCard, width: width, height: height })));
    icons.push(("FaEnvelopeOpen".to_owned(), rsx!(Icon { icon: FaEnvelopeOpen, width: width, height: height })));
    icons.push(("FaEnvelope".to_owned(), rsx!(Icon { icon: FaEnvelope, width: width, height: height })));
    icons.push(("FaEyeSlash".to_owned(), rsx!(Icon { icon: FaEyeSlash, width: width, height: height })));
    icons.push(("FaEye".to_owned(), rsx!(Icon { icon: FaEye, width: width, height: height })));
    icons.push(("FaFaceAngry".to_owned(), rsx!(Icon { icon: FaFaceAngry, width: width, height: height })));
    icons.push(("FaFaceDizzy".to_owned(), rsx!(Icon { icon: FaFaceDizzy, width: width, height: height })));
    icons.push(("FaFaceFlushed".to_owned(), rsx!(Icon { icon: FaFaceFlushed, width: width, height: height })));
    icons.push(("FaFaceFrownOpen".to_owned(), rsx!(Icon { icon: FaFaceFrownOpen, width: width, height: height })));
    icons.push(("FaFaceFrown".to_owned(), rsx!(Icon { icon: FaFaceFrown, width: width, height: height })));
    icons.push(("FaFaceGrimace".to_owned(), rsx!(Icon { icon: FaFaceGrimace, width: width, height: height })));
    icons.push(("FaFaceGrinBeamSweat".to_owned(), rsx!(Icon { icon: FaFaceGrinBeamSweat, width: width, height: height })));
    icons.push(("FaFaceGrinBeam".to_owned(), rsx!(Icon { icon: FaFaceGrinBeam, width: width, height: height })));
    icons.push(("FaFaceGrinHearts".to_owned(), rsx!(Icon { icon: FaFaceGrinHearts, width: width, height: height })));
    icons.push(("FaFaceGrinSquintTears".to_owned(), rsx!(Icon { icon: FaFaceGrinSquintTears, width: width, height: height })));
    icons.push(("FaFaceGrinSquint".to_owned(), rsx!(Icon { icon: FaFaceGrinSquint, width: width, height: height })));
    icons.push(("FaFaceGrinStars".to_owned(), rsx!(Icon { icon: FaFaceGrinStars, width: width, height: height })));
    icons.push(("FaFaceGrinTears".to_owned(), rsx!(Icon { icon: FaFaceGrinTears, width: width, height: height })));
    icons.push(("FaFaceGrinTongueSquint".to_owned(), rsx!(Icon { icon: FaFaceGrinTongueSquint, width: width, height: height })));
    icons.push(("FaFaceGrinTongueWink".to_owned(), rsx!(Icon { icon: FaFaceGrinTongueWink, width: width, height: height })));
    icons.push(("FaFaceGrinTongue".to_owned(), rsx!(Icon { icon: FaFaceGrinTongue, width: width, height: height })));
    icons.push(("FaFaceGrinWide".to_owned(), rsx!(Icon { icon: FaFaceGrinWide, width: width, height: height })));
    icons.push(("FaFaceGrinWink".to_owned(), rsx!(Icon { icon: FaFaceGrinWink, width: width, height: height })));
    icons.push(("FaFaceGrin".to_owned(), rsx!(Icon { icon: FaFaceGrin, width: width, height: height })));
    icons.push(("FaFaceKissBeam".to_owned(), rsx!(Icon { icon: FaFaceKissBeam, width: width, height: height })));
    icons.push(("FaFaceKissWinkHeart".to_owned(), rsx!(Icon { icon: FaFaceKissWinkHeart, width: width, height: height })));
    icons.push(("FaFaceKiss".to_owned(), rsx!(Icon { icon: FaFaceKiss, width: width, height: height })));
    icons.push(("FaFaceLaughBeam".to_owned(), rsx!(Icon { icon: FaFaceLaughBeam, width: width, height: height })));
    icons.push(("FaFaceLaughSquint".to_owned(), rsx!(Icon { icon: FaFaceLaughSquint, width: width, height: height })));
    icons.push(("FaFaceLaughWink".to_owned(), rsx!(Icon { icon: FaFaceLaughWink, width: width, height: height })));
    icons.push(("FaFaceLaugh".to_owned(), rsx!(Icon { icon: FaFaceLaugh, width: width, height: height })));
    icons.push(("FaFaceMehBlank".to_owned(), rsx!(Icon { icon: FaFaceMehBlank, width: width, height: height })));
    icons.push(("FaFaceMeh".to_owned(), rsx!(Icon { icon: FaFaceMeh, width: width, height: height })));
    icons.push(("FaFaceRollingEyes".to_owned(), rsx!(Icon { icon: FaFaceRollingEyes, width: width, height: height })));
    icons.push(("FaFaceSadCry".to_owned(), rsx!(Icon { icon: FaFaceSadCry, width: width, height: height })));
    icons.push(("FaFaceSadTear".to_owned(), rsx!(Icon { icon: FaFaceSadTear, width: width, height: height })));
    icons.push(("FaFaceSmileBeam".to_owned(), rsx!(Icon { icon: FaFaceSmileBeam, width: width, height: height })));
    icons.push(("FaFaceSmileWink".to_owned(), rsx!(Icon { icon: FaFaceSmileWink, width: width, height: height })));
    icons.push(("FaFaceSmile".to_owned(), rsx!(Icon { icon: FaFaceSmile, width: width, height: height })));
    icons.push(("FaFaceSurprise".to_owned(), rsx!(Icon { icon: FaFaceSurprise, width: width, height: height })));
    icons.push(("FaFaceTired".to_owned(), rsx!(Icon { icon: FaFaceTired, width: width, height: height })));
    icons.push(("FaFileAudio".to_owned(), rsx!(Icon { icon: FaFileAudio, width: width, height: height })));
    icons.push(("FaFileCode".to_owned(), rsx!(Icon { icon: FaFileCode, width: width, height: height })));
    icons.push(("FaFileExcel".to_owned(), rsx!(Icon { icon: FaFileExcel, width: width, height: height })));
    icons.push(("FaFileImage".to_owned(), rsx!(Icon { icon: FaFileImage, width: width, height: height })));
    icons.push(("FaFileLines".to_owned(), rsx!(Icon { icon: FaFileLines, width: width, height: height })));
    icons.push(("FaFilePdf".to_owned(), rsx!(Icon { icon: FaFilePdf, width: width, height: height })));
    icons.push(("FaFilePowerpoint".to_owned(), rsx!(Icon { icon: FaFilePowerpoint, width: width, height: height })));
    icons.push(("FaFileVideo".to_owned(), rsx!(Icon { icon: FaFileVideo, width: width, height: height })));
    icons.push(("FaFileWord".to_owned(), rsx!(Icon { icon: FaFileWord, width: width, height: height })));
    icons.push(("FaFileZipper".to_owned(), rsx!(Icon { icon: FaFileZipper, width: width, height: height })));
    icons.push(("FaFile".to_owned(), rsx!(Icon { icon: FaFile, width: width, height: height })));
    icons.push(("FaFlag".to_owned(), rsx!(Icon { icon: FaFlag, width: width, height: height })));
    icons.push(("FaFloppyDisk".to_owned(), rsx!(Icon { icon: FaFloppyDisk, width: width, height: height })));
    icons.push(("FaFolderClosed".to_owned(), rsx!(Icon { icon: FaFolderClosed, width: width, height: height })));
    icons.push(("FaFolderOpen".to_owned(), rsx!(Icon { icon: FaFolderOpen, width: width, height: height })));
    icons.push(("FaFolder".to_owned(), rsx!(Icon { icon: FaFolder, width: width, height: height })));
    icons.push(("FaFontAwesome".to_owned(), rsx!(Icon { icon: FaFontAwesome, width: width, height: height })));
    icons.push(("FaFutbol".to_owned(), rsx!(Icon { icon: FaFutbol, width: width, height: height })));
    icons.push(("FaGem".to_owned(), rsx!(Icon { icon: FaGem, width: width, height: height })));
    icons.push(("FaHandBackFist".to_owned(), rsx!(Icon { icon: FaHandBackFist, width: width, height: height })));
    icons.push(("FaHandLizard".to_owned(), rsx!(Icon { icon: FaHandLizard, width: width, height: height })));
    icons.push(("FaHandPeace".to_owned(), rsx!(Icon { icon: FaHandPeace, width: width, height: height })));
    icons.push(("FaHandPointDown".to_owned(), rsx!(Icon { icon: FaHandPointDown, width: width, height: height })));
    icons.push(("FaHandPointLeft".to_owned(), rsx!(Icon { icon: FaHandPointLeft, width: width, height: height })));
    icons.push(("FaHandPointRight".to_owned(), rsx!(Icon { icon: FaHandPointRight, width: width, height: height })));
    icons.push(("FaHandPointUp".to_owned(), rsx!(Icon { icon: FaHandPointUp, width: width, height: height })));
    icons.push(("FaHandPointer".to_owned(), rsx!(Icon { icon: FaHandPointer, width: width, height: height })));
    icons.push(("FaHandScissors".to_owned(), rsx!(Icon { icon: FaHandScissors, width: width, height: height })));
    icons.push(("FaHandSpock".to_owned(), rsx!(Icon { icon: FaHandSpock, width: width, height: height })));
    icons.push(("FaHand".to_owned(), rsx!(Icon { icon: FaHand, width: width, height: height })));
    icons.push(("FaHandshake".to_owned(), rsx!(Icon { icon: FaHandshake, width: width, height: height })));
    icons.push(("FaHardDrive".to_owned(), rsx!(Icon { icon: FaHardDrive, width: width, height: height })));
    icons.push(("FaHeart".to_owned(), rsx!(Icon { icon: FaHeart, width: width, height: height })));
    icons.push(("FaHospital".to_owned(), rsx!(Icon { icon: FaHospital, width: width, height: height })));
    icons.push(("FaHourglass".to_owned(), rsx!(Icon { icon: FaHourglass, width: width, height: height })));
    icons.push(("FaIdBadge".to_owned(), rsx!(Icon { icon: FaIdBadge, width: width, height: height })));
    icons.push(("FaIdCard".to_owned(), rsx!(Icon { icon: FaIdCard, width: width, height: height })));
    icons.push(("FaImage".to_owned(), rsx!(Icon { icon: FaImage, width: width, height: height })));
    icons.push(("FaImages".to_owned(), rsx!(Icon { icon: FaImages, width: width, height: height })));
    icons.push(("FaKeyboard".to_owned(), rsx!(Icon { icon: FaKeyboard, width: width, height: height })));
    icons.push(("FaLemon".to_owned(), rsx!(Icon { icon: FaLemon, width: width, height: height })));
    icons.push(("FaLifeRing".to_owned(), rsx!(Icon { icon: FaLifeRing, width: width, height: height })));
    icons.push(("FaLightbulb".to_owned(), rsx!(Icon { icon: FaLightbulb, width: width, height: height })));
    icons.push(("FaMap".to_owned(), rsx!(Icon { icon: FaMap, width: width, height: height })));
    icons.push(("FaMessage".to_owned(), rsx!(Icon { icon: FaMessage, width: width, height: height })));
    icons.push(("FaMoneyBill1".to_owned(), rsx!(Icon { icon: FaMoneyBill1, width: width, height: height })));
    icons.push(("FaMoon".to_owned(), rsx!(Icon { icon: FaMoon, width: width, height: height })));
    icons.push(("FaNewspaper".to_owned(), rsx!(Icon { icon: FaNewspaper, width: width, height: height })));
    icons.push(("FaNoteSticky".to_owned(), rsx!(Icon { icon: FaNoteSticky, width: width, height: height })));
    icons.push(("FaObjectGroup".to_owned(), rsx!(Icon { icon: FaObjectGroup, width: width, height: height })));
    icons.push(("FaObjectUngroup".to_owned(), rsx!(Icon { icon: FaObjectUngroup, width: width, height: height })));
    icons.push(("FaPaperPlane".to_owned(), rsx!(Icon { icon: FaPaperPlane, width: width, height: height })));
    icons.push(("FaPaste".to_owned(), rsx!(Icon { icon: FaPaste, width: width, height: height })));
    icons.push(("FaPenToSquare".to_owned(), rsx!(Icon { icon: FaPenToSquare, width: width, height: height })));
    icons.push(("FaRectangleList".to_owned(), rsx!(Icon { icon: FaRectangleList, width: width, height: height })));
    icons.push(("FaRectangleXmark".to_owned(), rsx!(Icon { icon: FaRectangleXmark, width: width, height: height })));
    icons.push(("FaRegistered".to_owned(), rsx!(Icon { icon: FaRegistered, width: width, height: height })));
    icons.push(("FaShareFromSquare".to_owned(), rsx!(Icon { icon: FaShareFromSquare, width: width, height: height })));
    icons.push(("FaSnowflake".to_owned(), rsx!(Icon { icon: FaSnowflake, width: width, height: height })));
    icons.push(("FaSquareCaretDown".to_owned(), rsx!(Icon { icon: FaSquareCaretDown, width: width, height: height })));
    icons.push(("FaSquareCaretLeft".to_owned(), rsx!(Icon { icon: FaSquareCaretLeft, width: width, height: height })));
    icons.push(("FaSquareCaretRight".to_owned(), rsx!(Icon { icon: FaSquareCaretRight, width: width, height: height })));
    icons.push(("FaSquareCaretUp".to_owned(), rsx!(Icon { icon: FaSquareCaretUp, width: width, height: height })));
    icons.push(("FaSquareCheck".to_owned(), rsx!(Icon { icon: FaSquareCheck, width: width, height: height })));
    icons.push(("FaSquareFull".to_owned(), rsx!(Icon { icon: FaSquareFull, width: width, height: height })));
    icons.push(("FaSquareMinus".to_owned(), rsx!(Icon { icon: FaSquareMinus, width: width, height: height })));
    icons.push(("FaSquarePlus".to_owned(), rsx!(Icon { icon: FaSquarePlus, width: width, height: height })));
    icons.push(("FaSquare".to_owned(), rsx!(Icon { icon: FaSquare, width: width, height: height })));
    icons.push(("FaStarHalfStroke".to_owned(), rsx!(Icon { icon: FaStarHalfStroke, width: width, height: height })));
    icons.push(("FaStarHalf".to_owned(), rsx!(Icon { icon: FaStarHalf, width: width, height: height })));
    icons.push(("FaStar".to_owned(), rsx!(Icon { icon: FaStar, width: width, height: height })));
    icons.push(("FaSun".to_owned(), rsx!(Icon { icon: FaSun, width: width, height: height })));
    icons.push(("FaThumbsDown".to_owned(), rsx!(Icon { icon: FaThumbsDown, width: width, height: height })));
    icons.push(("FaThumbsUp".to_owned(), rsx!(Icon { icon: FaThumbsUp, width: width, height: height })));
    icons.push(("FaTrashCan".to_owned(), rsx!(Icon { icon: FaTrashCan, width: width, height: height })));
    icons.push(("FaUser".to_owned(), rsx!(Icon { icon: FaUser, width: width, height: height })));
    icons.push(("FaWindowMaximize".to_owned(), rsx!(Icon { icon: FaWindowMaximize, width: width, height: height })));
    icons.push(("FaWindowMinimize".to_owned(), rsx!(Icon { icon: FaWindowMinimize, width: width, height: height })));
    icons.push(("FaWindowRestore".to_owned(), rsx!(Icon { icon: FaWindowRestore, width: width, height: height })));
    icons
}}
...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("HiAcademicCap".to_owned(), rsx!(Icon { icon: HiAcademicCap, width: width, height: height })));
    icons.push(("HiAdjustments".to_owned(), rsx!(Icon { icon: HiAdjustments, width: width, height: height })));
    icons.push(("HiAnnotation".to_owned(), rsx!(Icon { icon: HiAnnotation, width: width, height: height })));
    icons.push(("HiArchive".to_owned(), rsx!(Icon { icon: HiArchive, width: width, height: height })));
    icons.push(("HiArrowCircleDown".to_owned(), rsx!(Icon { icon: HiArrowCircleDown, width: width, height: height })));
    icons.push(("HiArrowCircleLeft".to_owned(), rsx!(Icon { icon: HiArrowCircleLeft, width: width, height: height })));
    icons.push(("HiArrowCircleRight".to_owned(), rsx!(Icon { icon: HiArrowCircleRight, width: width, height: height })));
    icons.push(("HiArrowCircleUp".to_owned(), rsx!(Icon { icon: HiArrowCircleUp, width: width, height: height })));
    icons.push(("HiArrowDown".to_owned(), rsx!(Icon { icon: HiArrowDown, width: width, height: height })));
    icons.push(("HiArrowLeft".to_owned(), rsx!(Icon { icon: HiArrowLeft, width: width, height: height })));
    icons.push(("HiArrowNarrowDown".to_owned(), rsx!(Icon { icon: HiArrowNarrowDown, width: width, height: height })));
    icons.push(("HiArrowNarrowLeft".to_owned(), rsx!(Icon { icon: HiArrowNarrowLeft, width: width, height: height })));
    icons.push(("HiArrowNarrowRight".to_owned(), rsx!(Icon { icon: HiArrowNarrowRight, width: width, height: height })));
    icons.push(("HiArrowNarrowUp".to_owned(), rsx!(Icon { icon: HiArrowNarrowUp, width: width, height: height })));
    icons.push(("HiArrowRight".to_owned(), rsx!(Icon { icon: HiArrowRight, width: width, height: height })));
    icons.push(("HiArrowSmDown".to_owned(), rsx!(Icon { icon: HiArrowSmDown, width: width, height: height })));
    icons.push(("HiArrowSmLeft".to_owned(), rsx!(Icon { icon: HiArrowSmLeft, width: width, height: height })));
    icons.push(("HiArrowSmRight".to_owned(), rsx!(Icon { icon: HiArrowSmRight, width: width, height: height })));
    icons.push(("HiArrowSmUp".to_owned(), rsx!(Icon { icon: HiArrowSmUp, width: width, height: height })));
    icons.push(("HiArrowUp".to_owned(), rsx!(Icon { icon: HiArrowUp, width: width, height: height })));
    icons.push(("HiArrowsExpand".to_owned(), rsx!(Icon { icon: HiArrowsExpand, width: width, height: height })));
    icons.push(("HiAtSymbol".to_owned(), rsx!(Icon { icon: HiAtSymbol, width: width, height: height })));
    icons.push(("HiBackspace".to_owned(), rsx!(Icon { icon: HiBackspace, width: width, height: height })));
    icons.push(("HiBadgeCheck".to_owned(), rsx!(Icon { icon: HiBadgeCheck, width: width, height: height })));
    icons.push(("HiBan".to_owned(), rsx!(Icon { icon: HiBan, width: width, height: height })));
    icons.push(("HiBeaker".to_owned(), rsx!(Icon { icon: HiBeaker, width: width, height: height })));
    icons.push(("HiBell".to_owned(), rsx!(Icon { icon: HiBell, width: width, height: height })));
    icons.push(("HiBookOpen".to_owned(), rsx!(Icon { icon: HiBookOpen, width: width, height: height })));
    icons.push(("HiBookmarkAlt".to_owned(), rsx!(Icon { icon: HiBookmarkAlt, width: width, height: height })));
    icons.push(("HiBookmark".to_owned(), rsx!(Icon { icon: HiBookmark, width: width, height: height })));
    icons.push(("HiBriefcase".to_owned(), rsx!(Icon { icon: HiBriefcase, width: width, height: height })));
    icons.push(("HiCake".to_owned(), rsx!(Icon { icon: HiCake, width: width, height: height })));
    icons.push(("HiCalculator".to_owned(), rsx!(Icon { icon: HiCalculator, width: width, height: height })));
    icons.push(("HiCalendar".to_owned(), rsx!(Icon { icon: HiCalendar, width: width, height: height })));
    icons.push(("HiCamera".to_owned(), rsx!(Icon { icon: HiCamera, width: width, height: height })));
    icons.push(("HiCash".to_owned(), rsx!(Icon { icon: HiCash, width: width, height: height })));
    icons.push(("HiChartBar".to_owned(), rsx!(Icon { icon: HiChartBar, width: width, height: height })));
    icons.push(("HiChartPie".to_owned(), rsx!(Icon { icon: HiChartPie, width: width, height: height })));
    icons.push(("HiChartSquareBar".to_owned(), rsx!(Icon { icon: HiChartSquareBar, width: width, height: height })));
    icons.push(("HiChatAlt2".to_owned(), rsx!(Icon { icon: HiChatAlt2, width: width, height: height })));
    icons.push(("HiChatAlt".to_owned(), rsx!(Icon { icon: HiChatAlt, width: width, height: height })));
    icons.push(("HiChat".to_owned(), rsx!(Icon { icon: HiChat, width: width, height: height })));
    icons.push(("HiCheckCircle".to_owned(), rsx!(Icon { icon: HiCheckCircle, width: width, height: height })));
    icons.push(("HiCheck".to_owned(), rsx!(Icon { icon: HiCheck, width: width, height: height })));
    icons.push(("HiChevronDoubleDown".to_owned(), rsx!(Icon { icon: HiChevronDoubleDown, width: width, height: height })));
    icons.push(("HiChevronDoubleLeft".to_owned(), rsx!(Icon { icon: HiChevronDoubleLeft, width: width, height: height })));
    icons.push(("HiChevronDoubleRight".to_owned(), rsx!(Icon { icon: HiChevronDoubleRight, width: width, height: height })));
    icons.push(("HiChevronDoubleUp".to_owned(), rsx!(Icon { icon: HiChevronDoubleUp, width: width, height: height })));
    icons.push(("HiChevronDown".to_owned(), rsx!(Icon { icon: HiChevronDown, width: width, height: height })));
    icons.push(("HiChevronLeft".to_owned(), rsx!(Icon { icon: HiChevronLeft, width: width, height: height })));
    icons.push(("HiChevronRight".to_owned(), rsx!(Icon { icon: HiChevronRight, width: width, height: height })));
    icons.push(("HiChevronUp".to_owned(), rsx!(Icon { icon: HiChevronUp, width: width, height: height })));
    icons.push(("HiChip".to_owned(), rsx!(Icon { icon: HiChip, width: width, height: height })));
    icons.push(("HiClipboardCheck".to_owned(), rsx!(Icon { icon: HiClipboardCheck, width: width, height: height })));
    icons.push(("HiClipboardCopy".to_owned(), rsx!(Icon { icon: HiClipboardCopy, width: width, height: height })));
    icons.push(("HiClipboardList".to_owned(), rsx!(Icon { icon: HiClipboardList, width: width, height: height })));
    icons.push(("HiClipboard".to_owned(), rsx!(Icon { icon: HiClipboard, width: width, height: height })));
    icons.push(("HiClock".to_owned(), rsx!(Icon { icon: HiClock, width: width, height: height })));
    icons.push(("HiCloudDownload".to_owned(), rsx!(Icon { icon: HiCloudDownload, width: width, height: height })));
    icons.push(("HiCloudUpload".to_owned(), rsx!(Icon { icon: HiCloudUpload, width: width, height: height })));
    icons.push(("HiCloud".to_owned(), rsx!(Icon { icon: HiCloud, width: width, height: height })));
    icons.push(("HiCode".to_owned(), rsx!(Icon { icon: HiCode, width: width, height: height })));
    icons.push(("HiCog".to_owned(), rsx!(Icon { icon: HiCog, width: width, height: height })));
    icons.push(("HiCollection".to_owned(), rsx!(Icon { icon: HiCollection, width: width, height: height })));
    icons.push(("HiColorSwatch".to_owned(), rsx!(Icon { icon: HiColorSwatch, width: width, height: height })));
    icons.push(("HiCreditCard".to_owned(), rsx!(Icon { icon: HiCreditCard, width: width, height: height })));
    icons.push(("HiCubeTransparent".to_owned(), rsx!(Icon { icon: HiCubeTransparent, width: width, height: height })));
    icons.push(("HiCube".to_owned(), rsx!(Icon { icon: HiCube, width: width, height: height })));
    icons.push(("HiCurrencyBangladeshi".to_owned(), rsx!(Icon { icon: HiCurrencyBangladeshi, width: width, height: height })));
    icons.push(("HiCurrencyDollar".to_owned(), rsx!(Icon { icon: HiCurrencyDollar, width: width, height: height })));
    icons.push(("HiCurrencyEuro".to_owned(), rsx!(Icon { icon: HiCurrencyEuro, width: width, height: height })));
    icons.push(("HiCurrencyPound".to_owned(), rsx!(Icon { icon: HiCurrencyPound, width: width, height: height })));
    icons.push(("HiCurrencyRupee".to_owned(), rsx!(Icon { icon: HiCurrencyRupee, width: width, height: height })));
    icons.push(("HiCurrencyYen".to_owned(), rsx!(Icon { icon: HiCurrencyYen, width: width, height: height })));
    icons.push(("HiCursorClick".to_owned(), rsx!(Icon { icon: HiCursorClick, width: width, height: height })));
    icons.push(("HiDatabase".to_owned(), rsx!(Icon { icon: HiDatabase, width: width, height: height })));
    icons.push(("HiDesktopComputer".to_owned(), rsx!(Icon { icon: HiDesktopComputer, width: width, height: height })));
    icons.push(("HiDeviceMobile".to_owned(), rsx!(Icon { icon: HiDeviceMobile, width: width, height: height })));
    icons.push(("HiDeviceTablet".to_owned(), rsx!(Icon { icon: HiDeviceTablet, width: width, height: height })));
    icons.push(("HiDocumentAdd".to_owned(), rsx!(Icon { icon: HiDocumentAdd, width: width, height: height })));
    icons.push(("HiDocumentDownload".to_owned(), rsx!(Icon { icon: HiDocumentDownload, width: width, height: height })));
    icons.push(("HiDocumentDuplicate".to_owned(), rsx!(Icon { icon: HiDocumentDuplicate, width: width, height: height })));
    icons.push(("HiDocumentRemove".to_owned(), rsx!(Icon { icon: HiDocumentRemove, width: width, height: height })));
    icons.push(("HiDocumentReport".to_owned(), rsx!(Icon { icon: HiDocumentReport, width: width, height: height })));
    icons.push(("HiDocumentSearch".to_owned(), rsx!(Icon { icon: HiDocumentSearch, width: width, height: height })));
    icons.push(("HiDocumentText".to_owned(), rsx!(Icon { icon: HiDocumentText, width: width, height: height })));
    icons.push(("HiDocument".to_owned(), rsx!(Icon { icon: HiDocument, width: width, height: height })));
    icons.push(("HiDotsCircleHorizontal".to_owned(), rsx!(Icon { icon: HiDotsCircleHorizontal, width: width, height: height })));
    icons.push(("HiDotsHorizontal".to_owned(), rsx!(Icon { icon: HiDotsHorizontal, width: width, height: height })));
    icons.push(("HiDotsVertical".to_owned(), rsx!(Icon { icon: HiDotsVertical, width: width, height: height })));
    icons.push(("HiDownload".to_owned(), rsx!(Icon { icon: HiDownload, width: width, height: height })));
    icons.push(("HiDuplicate".to_owned(), rsx!(Icon { icon: HiDuplicate, width: width, height: height })));
    icons.push(("HiEmojiHappy".to_owned(), rsx!(Icon { icon: HiEmojiHappy, width: width, height: height })));
    icons.push(("HiEmojiSad".to_owned(), rsx!(Icon { icon: HiEmojiSad, width: width, height: height })));
    icons.push(("HiExclamationCircle".to_owned(), rsx!(Icon { icon: HiExclamationCircle, width: width, height: height })));
    icons.push(("HiExclamation".to_owned(), rsx!(Icon { icon: HiExclamation, width: width, height: height })));
    icons.push(("HiExternalLink".to_owned(), rsx!(Icon { icon: HiExternalLink, width: width, height: height })));
    icons.push(("HiEyeOff".to_owned(), rsx!(Icon { icon: HiEyeOff, width: width, height: height })));
    icons.push(("HiEye".to_owned(), rsx!(Icon { icon: HiEye, width: width, height: height })));
    icons.push(("HiFastForward".to_owned(), rsx!(Icon { icon: HiFastForward, width: width, height: height })));
    icons.push(("HiFilm".to_owned(), rsx!(Icon { icon: HiFilm, width: width, height: height })));
    icons.push(("HiFilter".to_owned(), rsx!(Icon { icon: HiFilter, width: width, height: height })));
    icons.push(("HiFingerPrint".to_owned(), rsx!(Icon { icon: HiFingerPrint, width: width, height: height })));
    icons.push(("HiFire".to_owned(), rsx!(Icon { icon: HiFire, width: width, height: height })));
    icons.push(("HiFlag".to_owned(), rsx!(Icon { icon: HiFlag, width: width, height: height })));
    icons.push(("HiFolderAdd".to_owned(), rsx!(Icon { icon: HiFolderAdd, width: width, height: height })));
    icons.push(("HiFolderDownload".to_owned(), rsx!(Icon { icon: HiFolderDownload, width: width, height: height })));
    icons.push(("HiFolderOpen".to_owned(), rsx!(Icon { icon: HiFolderOpen, width: width, height: height })));
    icons.push(("HiFolderRemove".to_owned(), rsx!(Icon { icon: HiFolderRemove, width: width, height: height })));
    icons.push(("HiFolder".to_owned(), rsx!(Icon { icon: HiFolder, width: width, height: height })));
    icons.push(("HiGift".to_owned(), rsx!(Icon { icon: HiGift, width: width, height: height })));
    icons.push(("HiGlobeAlt".to_owned(), rsx!(Icon { icon: HiGlobeAlt, width: width, height: height })));
    icons.push(("HiGlobe".to_owned(), rsx!(Icon { icon: HiGlobe, width: width, height: height })));
    icons.push(("HiHand".to_owned(), rsx!(Icon { icon: HiHand, width: width, height: height })));
    icons.push(("HiHashtag".to_owned(), rsx!(Icon { icon: HiHashtag, width: width, height: height })));
    icons.push(("HiHeart".to_owned(), rsx!(Icon { icon: HiHeart, width: width, height: height })));
    icons.push(("HiHome".to_owned(), rsx!(Icon { icon: HiHome, width: width, height: height })));
    icons.push(("HiIdentification".to_owned(), rsx!(Icon { icon: HiIdentification, width: width, height: height })));
    icons.push(("HiInboxIn".to_owned(), rsx!(Icon { icon: HiInboxIn, width: width, height: height })));
    icons.push(("HiInbox".to_owned(), rsx!(Icon { icon: HiInbox, width: width, height: height })));
    icons.push(("HiInformationCircle".to_owned(), rsx!(Icon { icon: HiInformationCircle, width: width, height: height })));
    icons.push(("HiKey".to_owned(), rsx!(Icon { icon: HiKey, width: width, height: height })));
    icons.push(("HiLibrary".to_owned(), rsx!(Icon { icon: HiLibrary, width: width, height: height })));
    icons.push(("HiLightBulb".to_owned(), rsx!(Icon { icon: HiLightBulb, width: width, height: height })));
    icons.push(("HiLightningBolt".to_owned(), rsx!(Icon { icon: HiLightningBolt, width: width, height: height })));
    icons.push(("HiLink".to_owned(), rsx!(Icon { icon: HiLink, width: width, height: height })));
    icons.push(("HiLocationMarker".to_owned(), rsx!(Icon { icon: HiLocationMarker, width: width, height: height })));
    icons.push(("HiLockClosed".to_owned(), rsx!(Icon { icon: HiLockClosed, width: width, height: height })));
    icons.push(("HiLockOpen".to_owned(), rsx!(Icon { icon: HiLockOpen, width: width, height: height })));
    icons.push(("HiLogin".to_owned(), rsx!(Icon { icon: HiLogin, width: width, height: height })));
    icons.push(("HiLogout".to_owned(), rsx!(Icon { icon: HiLogout, width: width, height: height })));
    icons.push(("HiMailOpen".to_owned(), rsx!(Icon { icon: HiMailOpen, width: width, height: height })));
    icons.push(("HiMail".to_owned(), rsx!(Icon { icon: HiMail, width: width, height: height })));
    icons.push(("HiMap".to_owned(), rsx!(Icon { icon: HiMap, width: width, height: height })));
    icons.push(("HiMenuAlt1".to_owned(), rsx!(Icon { icon: HiMenuAlt1, width: width, height: height })));
    icons.push(("HiMenuAlt2".to_owned(), rsx!(Icon { icon: HiMenuAlt2, width: width, height: height })));
    icons.push(("HiMenuAlt3".to_owned(), rsx!(Icon { icon: HiMenuAlt3, width: width, height: height })));
    icons.push(("HiMenuAlt4".to_owned(), rsx!(Icon { icon: HiMenuAlt4, width: width, height: height })));
    icons.push(("HiMenu".to_owned(), rsx!(Icon { icon: HiMenu, width: width, height: height })));
    icons.push(("HiMicrophone".to_owned(), rsx!(Icon { icon: HiMicrophone, width: width, height: height })));
    icons.push(("HiMinusCircle".to_owned(), rsx!(Icon { icon: HiMinusCircle, width: width, height: height })));
    icons.push(("HiMinusSm".to_owned(), rsx!(Icon { icon: HiMinusSm, width: width, height: height })));
    icons.push(("HiMinus".to_owned(), rsx!(Icon { icon: HiMinus, width: width, height: height })));
    icons.push(("HiMoon".to_owned(), rsx!(Icon { icon: HiMoon, width: width, height: height })));
    icons.push(("HiMusicNote".to_owned(), rsx!(Icon { icon: HiMusicNote, width: width, height: height })));
    icons.push(("HiNewspaper".to_owned(), rsx!(Icon { icon: HiNewspaper, width: width, height: height })));
    icons.push(("HiOfficeBuilding".to_owned(), rsx!(Icon { icon: HiOfficeBuilding, width: width, height: height })));
    icons.push(("HiPaperAirplane".to_owned(), rsx!(Icon { icon: HiPaperAirplane, width: width, height: height })));
    icons.push(("HiPaperClip".to_owned(), rsx!(Icon { icon: HiPaperClip, width: width, height: height })));
    icons.push(("HiPause".to_owned(), rsx!(Icon { icon: HiPause, width: width, height: height })));
    icons.push(("HiPencilAlt".to_owned(), rsx!(Icon { icon: HiPencilAlt, width: width, height: height })));
    icons.push(("HiPencil".to_owned(), rsx!(Icon { icon: HiPencil, width: width, height: height })));
    icons.push(("HiPhoneIncoming".to_owned(), rsx!(Icon { icon: HiPhoneIncoming, width: width, height: height })));
    icons.push(("HiPhoneMissedCall".to_owned(), rsx!(Icon { icon: HiPhoneMissedCall, width: width, height: height })));
    icons.push(("HiPhoneOutgoing".to_owned(), rsx!(Icon { icon: HiPhoneOutgoing, width: width, height: height })));
    icons.push(("HiPhone".to_owned(), rsx!(Icon { icon: HiPhone, width: width, height: height })));
    icons.push(("HiPhotograph".to_owned(), rsx!(Icon { icon: HiPhotograph, width: width, height: height })));
    icons.push(("HiPlay".to_owned(), rsx!(Icon { icon: HiPlay, width: width, height: height })));
    icons.push(("HiPlusCircle".to_owned(), rsx!(Icon { icon: HiPlusCircle, width: width, height: height })));
    icons.push(("HiPlusSm".to_owned(), rsx!(Icon { icon: HiPlusSm, width: width, height: height })));
    icons.push(("HiPlus".to_owned(), rsx!(Icon { icon: HiPlus, width: width, height: height })));
    icons.push(("HiPresentationChartBar".to_owned(), rsx!(Icon { icon: HiPresentationChartBar, width: width, height: height })));
    icons.push(("HiPresentationChartLine".to_owned(), rsx!(Icon { icon: HiPresentationChartLine, width: width, height: height })));
    icons.push(("HiPrinter".to_owned(), rsx!(Icon { icon: HiPrinter, width: width, height: height })));
    icons.push(("HiPuzzle".to_owned(), rsx!(Icon { icon: HiPuzzle, width: width, height: height })));
    icons.push(("HiQrcode".to_owned(), rsx!(Icon { icon: HiQrcode, width: width, height: height })));
    icons.push(("HiQuestionMarkCircle".to_owned(), rsx!(Icon { icon: HiQuestionMarkCircle, width: width, height: height })));
    icons.push(("HiReceiptRefund".to_owned(), rsx!(Icon { icon: HiReceiptRefund, width: width, height: height })));
    icons.push(("HiReceiptTax".to_owned(), rsx!(Icon { icon: HiReceiptTax, width: width, height: height })));
    icons.push(("HiRefresh".to_owned(), rsx!(Icon { icon: HiRefresh, width: width, height: height })));
    icons.push(("HiReply".to_owned(), rsx!(Icon { icon: HiReply, width: width, height: height })));
    icons.push(("HiRewind".to_owned(), rsx!(Icon { icon: HiRewind, width: width, height: height })));
    icons.push(("HiRss".to_owned(), rsx!(Icon { icon: HiRss, width: width, height: height })));
    icons.push(("HiSaveAs".to_owned(), rsx!(Icon { icon: HiSaveAs, width: width, height: height })));
    icons.push(("HiSave".to_owned(), rsx!(Icon { icon: HiSave, width: width, height: height })));
    icons.push(("HiScale".to_owned(), rsx!(Icon { icon: HiScale, width: width, height: height })));
    icons.push(("HiScissors".to_owned(), rsx!(Icon { icon: HiScissors, width: width, height: height })));
    icons.push(("HiSearchCircle".to_owned(), rsx!(Icon { icon: HiSearchCircle, width: width, height: height })));
    icons.push(("HiSearch".to_owned(), rsx!(Icon { icon: HiSearch, width: width, height: height })));
    icons.push(("HiSelector".to_owned(), rsx!(Icon { icon: HiSelector, width: width, height: height })));
    icons.push(("HiServer".to_owned(), rsx!(Icon { icon: HiServer, width: width, height: height })));
    icons.push(("HiShare".to_owned(), rsx!(Icon { icon: HiShare, width: width, height: height })));
    icons.push(("HiShieldCheck".to_owned(), rsx!(Icon { icon: HiShieldCheck, width: width, height: height })));
    icons.push(("HiShieldExclamation".to_owned(), rsx!(Icon { icon: HiShieldExclamation, width: width, height: height })));
    icons.push(("HiShoppingBag".to_owned(), rsx!(Icon { icon: HiShoppingBag, width: width, height: height })));
    icons.push(("HiShoppingCart".to_owned(), rsx!(Icon { icon: HiShoppingCart, width: width, height: height })));
    icons.push(("HiSortAscending".to_owned(), rsx!(Icon { icon: HiSortAscending, width: width, height: height })));
    icons.push(("HiSortDescending".to_owned(), rsx!(Icon { icon: HiSortDescending, width: width, height: height })));
    icons.push(("HiSparkles".to_owned(), rsx!(Icon { icon: HiSparkles, width: width, height: height })));
    icons.push(("HiSpeakerphone".to_owned(), rsx!(Icon { icon: HiSpeakerphone, width: width, height: height })));
    icons.push(("HiStar".to_owned(), rsx!(Icon { icon: HiStar, width: width, height: height })));
    icons.push(("HiStatusOffline".to_owned(), rsx!(Icon { icon: HiStatusOffline, width: width, height: height })));
    icons.push(("HiStatusOnline".to_owned(), rsx!(Icon { icon: HiStatusOnline, width: width, height: height })));
    icons.push(("HiStop".to_owned(), rsx!(Icon { icon: HiStop, width: width, height: height })));
    icons.push(("HiSun".to_owned(), rsx!(Icon { icon: HiSun, width: width, height: height })));
    icons.push(("HiSupport".to_owned(), rsx!(Icon { icon: HiSupport, width: width, height: height })));
    icons.push(("HiSwitchHorizontal".to_owned(), rsx!(Icon { icon: HiSwitchHorizontal, width: width, height: height })));
    icons.push(("HiSwitchVertical".to_owned(), rsx!(Icon { icon: HiSwitchVertical, width: width, height: height })));
    icons.push(("HiTable".to_owned(), rsx!(Icon { icon: HiTable, width: width, height: height })));
    icons.push(("HiTag".to_owned(), rsx!(Icon { icon: HiTag, width: width, height: height })));
    icons.push(("HiTemplate".to_owned(), rsx!(Icon { icon: HiTemplate, width: width, height: height })));
    icons.push(("HiTerminal".to_owned(), rsx!(Icon { icon: HiTerminal, width: width, height: height })));
    icons.push(("HiThumbDown".to_owned(), rsx!(Icon { icon: HiThumbDown, width: width, height: height })));
    icons.push(("HiThumbUp".to_owned(), rsx!(Icon { icon: HiThumbUp, width: width, height: height })));
    icons.push(("HiTicket".to_owned(), rsx!(Icon { icon: HiTicket, width: width, height: height })));
    icons.push(("HiTranslate".to_owned(), rsx!(Icon { icon: HiTranslate, width: width, height: height })));
    icons.push(("HiTrash".to_owned(), rsx!(Icon { icon: HiTrash, width: width, height: height })));
    icons.push(("HiTrendingDown".to_owned(), rsx!(Icon { icon: HiTrendingDown, width: width, height: height })));
    icons.push(("HiTrendingUp".to_owned(), rsx!(Icon { icon: HiTrendingUp, width: width, height: height })));
    icons.push(("HiTruck".to_owned(), rsx!(Icon { icon: HiTruck, width: width, height: height })));
    icons.push(("HiUpload".to_owned(), rsx!(Icon { icon: HiUpload, width: width, height: height })));
    icons.push(("HiUserAdd".to_owned(), rsx!(Icon { icon: HiUserAdd, width: width, height: height })));
    icons.push(("HiUserCircle".to_owned(), rsx!(Icon { icon: HiUserCircle, width: width, height: height })));
    icons.push(("HiUserGroup".to_owned(), rsx!(Icon { icon: HiUserGroup, width: width, height: height })));
    icons.push(("HiUserRemove".to_owned(), rsx!(Icon { icon: HiUserRemove, width: width, height: height })));
    icons.push(("HiUser".to_owned(), rsx!(Icon { icon: HiUser, width: width, height: height })));
    icons.push(("HiUsers".to_owned(), rsx!(Icon { icon: HiUsers, width: width, height: height })));
    icons.push(("HiVariable".to_owned(), rsx!(Icon { icon: HiVariable, width: width, height: height })));
    icons.push(("HiVideoCamera".to_owned(), rsx!(Icon { icon: HiVideoCamera, width: width, height: height })));
    icons.push(("HiViewBoards".to_owned(), rsx!(Icon { icon: HiViewBoards, width: width, height: height })));
    icons.push(("HiViewGridAdd".to_owned(), rsx!(Icon { icon: HiViewGridAdd, width: width, height: height })));
    icons.push(("HiViewGrid".to_owned(), rsx!(Icon { icon: HiViewGrid, width: width, height: height })));
    icons.push(("HiViewList".to_owned(), rsx!(Icon { icon: HiViewList, width: width, height: height })));
    icons.push(("HiVolumeOff".to_owned(), rsx!(Icon { icon: HiVolumeOff, width: width, height: height })));
    icons.push(("HiVolumeUp".to_owned(), rsx!(Icon { icon: HiVolumeUp, width: width, height: height })));
    icons.push(("HiWifi".to_owned(), rsx!(Icon { icon: HiWifi, width: width, height: height })));
    icons.push(("HiXCircle".to_owned(), rsx!(Icon { icon: HiXCircle, width: width, height: height })));
    icons.push(("HiX".to_owned(), rsx!(Icon { icon: HiX, width: width, height: height })));
    icons.push(("HiZoomIn".to_owned(), rsx!(Icon { icon: HiZoomIn, width: width, height: height })));
    icons.push(("HiZoomOut".to_owned(), rsx!(Icon { icon: HiZoomOut, width: width, height: height })));
    icons
}}
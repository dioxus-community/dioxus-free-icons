...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("GoAccessibility".to_owned(), rsx!(Icon { icon: GoAccessibility, width: width, height: height })));
    icons.push(("GoAlert".to_owned(), rsx!(Icon { icon: GoAlert, width: width, height: height })));
    icons.push(("GoApps".to_owned(), rsx!(Icon { icon: GoApps, width: width, height: height })));
    icons.push(("GoArchive".to_owned(), rsx!(Icon { icon: GoArchive, width: width, height: height })));
    icons.push(("GoArrowBoth".to_owned(), rsx!(Icon { icon: GoArrowBoth, width: width, height: height })));
    icons.push(("GoArrowDown".to_owned(), rsx!(Icon { icon: GoArrowDown, width: width, height: height })));
    icons.push(("GoArrowLeft".to_owned(), rsx!(Icon { icon: GoArrowLeft, width: width, height: height })));
    icons.push(("GoArrowRight".to_owned(), rsx!(Icon { icon: GoArrowRight, width: width, height: height })));
    icons.push(("GoArrowSwitch".to_owned(), rsx!(Icon { icon: GoArrowSwitch, width: width, height: height })));
    icons.push(("GoArrowUp".to_owned(), rsx!(Icon { icon: GoArrowUp, width: width, height: height })));
    icons.push(("GoBeaker".to_owned(), rsx!(Icon { icon: GoBeaker, width: width, height: height })));
    icons.push(("GoBell".to_owned(), rsx!(Icon { icon: GoBell, width: width, height: height })));
    icons.push(("GoBellFill".to_owned(), rsx!(Icon { icon: GoBellFill, width: width, height: height })));
    icons.push(("GoBellSlash".to_owned(), rsx!(Icon { icon: GoBellSlash, width: width, height: height })));
    icons.push(("GoBlocked".to_owned(), rsx!(Icon { icon: GoBlocked, width: width, height: height })));
    icons.push(("GoBold".to_owned(), rsx!(Icon { icon: GoBold, width: width, height: height })));
    icons.push(("GoBook".to_owned(), rsx!(Icon { icon: GoBook, width: width, height: height })));
    icons.push(("GoBookmark".to_owned(), rsx!(Icon { icon: GoBookmark, width: width, height: height })));
    icons.push(("GoBookmarkSlash".to_owned(), rsx!(Icon { icon: GoBookmarkSlash, width: width, height: height })));
    icons.push(("GoBriefcase".to_owned(), rsx!(Icon { icon: GoBriefcase, width: width, height: height })));
    icons.push(("GoBroadcast".to_owned(), rsx!(Icon { icon: GoBroadcast, width: width, height: height })));
    icons.push(("GoBrowser".to_owned(), rsx!(Icon { icon: GoBrowser, width: width, height: height })));
    icons.push(("GoBug".to_owned(), rsx!(Icon { icon: GoBug, width: width, height: height })));
    icons.push(("GoCalendar".to_owned(), rsx!(Icon { icon: GoCalendar, width: width, height: height })));
    icons.push(("GoCheck".to_owned(), rsx!(Icon { icon: GoCheck, width: width, height: height })));
    icons.push(("GoCheckCircle".to_owned(), rsx!(Icon { icon: GoCheckCircle, width: width, height: height })));
    icons.push(("GoCheckCircleFill".to_owned(), rsx!(Icon { icon: GoCheckCircleFill, width: width, height: height })));
    icons.push(("GoChecklist".to_owned(), rsx!(Icon { icon: GoChecklist, width: width, height: height })));
    icons.push(("GoChevronDown".to_owned(), rsx!(Icon { icon: GoChevronDown, width: width, height: height })));
    icons.push(("GoChevronLeft".to_owned(), rsx!(Icon { icon: GoChevronLeft, width: width, height: height })));
    icons.push(("GoChevronRight".to_owned(), rsx!(Icon { icon: GoChevronRight, width: width, height: height })));
    icons.push(("GoChevronUp".to_owned(), rsx!(Icon { icon: GoChevronUp, width: width, height: height })));
    icons.push(("GoCircle".to_owned(), rsx!(Icon { icon: GoCircle, width: width, height: height })));
    icons.push(("GoCircleSlash".to_owned(), rsx!(Icon { icon: GoCircleSlash, width: width, height: height })));
    icons.push(("GoClock".to_owned(), rsx!(Icon { icon: GoClock, width: width, height: height })));
    icons.push(("GoCloud".to_owned(), rsx!(Icon { icon: GoCloud, width: width, height: height })));
    icons.push(("GoCloudOffline".to_owned(), rsx!(Icon { icon: GoCloudOffline, width: width, height: height })));
    icons.push(("GoCode".to_owned(), rsx!(Icon { icon: GoCode, width: width, height: height })));
    icons.push(("GoCodeOfConduct".to_owned(), rsx!(Icon { icon: GoCodeOfConduct, width: width, height: height })));
    icons.push(("GoCodeReview".to_owned(), rsx!(Icon { icon: GoCodeReview, width: width, height: height })));
    icons.push(("GoCodeSquare".to_owned(), rsx!(Icon { icon: GoCodeSquare, width: width, height: height })));
    icons.push(("GoCodescan".to_owned(), rsx!(Icon { icon: GoCodescan, width: width, height: height })));
    icons.push(("GoCodescanCheckmark".to_owned(), rsx!(Icon { icon: GoCodescanCheckmark, width: width, height: height })));
    icons.push(("GoCodespaces".to_owned(), rsx!(Icon { icon: GoCodespaces, width: width, height: height })));
    icons.push(("GoColumns".to_owned(), rsx!(Icon { icon: GoColumns, width: width, height: height })));
    icons.push(("GoComment".to_owned(), rsx!(Icon { icon: GoComment, width: width, height: height })));
    icons.push(("GoCommentDiscussion".to_owned(), rsx!(Icon { icon: GoCommentDiscussion, width: width, height: height })));
    icons.push(("GoContainer".to_owned(), rsx!(Icon { icon: GoContainer, width: width, height: height })));
    icons.push(("GoCopilot".to_owned(), rsx!(Icon { icon: GoCopilot, width: width, height: height })));
    icons.push(("GoCopilotError".to_owned(), rsx!(Icon { icon: GoCopilotError, width: width, height: height })));
    icons.push(("GoCopilotWarning".to_owned(), rsx!(Icon { icon: GoCopilotWarning, width: width, height: height })));
    icons.push(("GoCopy".to_owned(), rsx!(Icon { icon: GoCopy, width: width, height: height })));
    icons.push(("GoCpu".to_owned(), rsx!(Icon { icon: GoCpu, width: width, height: height })));
    icons.push(("GoCreditCard".to_owned(), rsx!(Icon { icon: GoCreditCard, width: width, height: height })));
    icons.push(("GoCrossReference".to_owned(), rsx!(Icon { icon: GoCrossReference, width: width, height: height })));
    icons.push(("GoDash".to_owned(), rsx!(Icon { icon: GoDash, width: width, height: height })));
    icons.push(("GoDatabase".to_owned(), rsx!(Icon { icon: GoDatabase, width: width, height: height })));
    icons.push(("GoDependabot".to_owned(), rsx!(Icon { icon: GoDependabot, width: width, height: height })));
    icons.push(("GoDesktopDownload".to_owned(), rsx!(Icon { icon: GoDesktopDownload, width: width, height: height })));
    icons.push(("GoDeviceCamera".to_owned(), rsx!(Icon { icon: GoDeviceCamera, width: width, height: height })));
    icons.push(("GoDeviceCameraVideo".to_owned(), rsx!(Icon { icon: GoDeviceCameraVideo, width: width, height: height })));
    icons.push(("GoDeviceDesktop".to_owned(), rsx!(Icon { icon: GoDeviceDesktop, width: width, height: height })));
    icons.push(("GoDeviceMobile".to_owned(), rsx!(Icon { icon: GoDeviceMobile, width: width, height: height })));
    icons.push(("GoDiamond".to_owned(), rsx!(Icon { icon: GoDiamond, width: width, height: height })));
    icons.push(("GoDiff".to_owned(), rsx!(Icon { icon: GoDiff, width: width, height: height })));
    icons.push(("GoDiffAdded".to_owned(), rsx!(Icon { icon: GoDiffAdded, width: width, height: height })));
    icons.push(("GoDiffIgnored".to_owned(), rsx!(Icon { icon: GoDiffIgnored, width: width, height: height })));
    icons.push(("GoDiffModified".to_owned(), rsx!(Icon { icon: GoDiffModified, width: width, height: height })));
    icons.push(("GoDiffRemoved".to_owned(), rsx!(Icon { icon: GoDiffRemoved, width: width, height: height })));
    icons.push(("GoDiffRenamed".to_owned(), rsx!(Icon { icon: GoDiffRenamed, width: width, height: height })));
    icons.push(("GoDot".to_owned(), rsx!(Icon { icon: GoDot, width: width, height: height })));
    icons.push(("GoDotFill".to_owned(), rsx!(Icon { icon: GoDotFill, width: width, height: height })));
    icons.push(("GoDownload".to_owned(), rsx!(Icon { icon: GoDownload, width: width, height: height })));
    icons.push(("GoDuplicate".to_owned(), rsx!(Icon { icon: GoDuplicate, width: width, height: height })));
    icons.push(("GoEllipsis".to_owned(), rsx!(Icon { icon: GoEllipsis, width: width, height: height })));
    icons.push(("GoEye".to_owned(), rsx!(Icon { icon: GoEye, width: width, height: height })));
    icons.push(("GoEyeClosed".to_owned(), rsx!(Icon { icon: GoEyeClosed, width: width, height: height })));
    icons.push(("GoFeedDiscussion".to_owned(), rsx!(Icon { icon: GoFeedDiscussion, width: width, height: height })));
    icons.push(("GoFeedForked".to_owned(), rsx!(Icon { icon: GoFeedForked, width: width, height: height })));
    icons.push(("GoFeedHeart".to_owned(), rsx!(Icon { icon: GoFeedHeart, width: width, height: height })));
    icons.push(("GoFeedMerged".to_owned(), rsx!(Icon { icon: GoFeedMerged, width: width, height: height })));
    icons.push(("GoFeedPerson".to_owned(), rsx!(Icon { icon: GoFeedPerson, width: width, height: height })));
    icons.push(("GoFeedRepo".to_owned(), rsx!(Icon { icon: GoFeedRepo, width: width, height: height })));
    icons.push(("GoFeedRocket".to_owned(), rsx!(Icon { icon: GoFeedRocket, width: width, height: height })));
    icons.push(("GoFeedStar".to_owned(), rsx!(Icon { icon: GoFeedStar, width: width, height: height })));
    icons.push(("GoFeedTag".to_owned(), rsx!(Icon { icon: GoFeedTag, width: width, height: height })));
    icons.push(("GoFeedTrophy".to_owned(), rsx!(Icon { icon: GoFeedTrophy, width: width, height: height })));
    icons.push(("GoFile".to_owned(), rsx!(Icon { icon: GoFile, width: width, height: height })));
    icons.push(("GoFileAdded".to_owned(), rsx!(Icon { icon: GoFileAdded, width: width, height: height })));
    icons.push(("GoFileBadge".to_owned(), rsx!(Icon { icon: GoFileBadge, width: width, height: height })));
    icons.push(("GoFileBinary".to_owned(), rsx!(Icon { icon: GoFileBinary, width: width, height: height })));
    icons.push(("GoFileCode".to_owned(), rsx!(Icon { icon: GoFileCode, width: width, height: height })));
    icons.push(("GoFileDiff".to_owned(), rsx!(Icon { icon: GoFileDiff, width: width, height: height })));
    icons.push(("GoFileDirectory".to_owned(), rsx!(Icon { icon: GoFileDirectory, width: width, height: height })));
    icons.push(("GoFileDirectoryFill".to_owned(), rsx!(Icon { icon: GoFileDirectoryFill, width: width, height: height })));
    icons.push(("GoFileDirectoryOpenFill".to_owned(), rsx!(Icon { icon: GoFileDirectoryOpenFill, width: width, height: height })));
    icons.push(("GoFileMoved".to_owned(), rsx!(Icon { icon: GoFileMoved, width: width, height: height })));
    icons.push(("GoFileRemoved".to_owned(), rsx!(Icon { icon: GoFileRemoved, width: width, height: height })));
    icons.push(("GoFileSubmodule".to_owned(), rsx!(Icon { icon: GoFileSubmodule, width: width, height: height })));
    icons.push(("GoFileSymlinkFile".to_owned(), rsx!(Icon { icon: GoFileSymlinkFile, width: width, height: height })));
    icons.push(("GoFileZip".to_owned(), rsx!(Icon { icon: GoFileZip, width: width, height: height })));
    icons.push(("GoFilter".to_owned(), rsx!(Icon { icon: GoFilter, width: width, height: height })));
    icons.push(("GoFlame".to_owned(), rsx!(Icon { icon: GoFlame, width: width, height: height })));
    icons.push(("GoFold".to_owned(), rsx!(Icon { icon: GoFold, width: width, height: height })));
    icons.push(("GoFoldDown".to_owned(), rsx!(Icon { icon: GoFoldDown, width: width, height: height })));
    icons.push(("GoFoldUp".to_owned(), rsx!(Icon { icon: GoFoldUp, width: width, height: height })));
    icons.push(("GoGear".to_owned(), rsx!(Icon { icon: GoGear, width: width, height: height })));
    icons.push(("GoGift".to_owned(), rsx!(Icon { icon: GoGift, width: width, height: height })));
    icons.push(("GoGitBranch".to_owned(), rsx!(Icon { icon: GoGitBranch, width: width, height: height })));
    icons.push(("GoGitCommit".to_owned(), rsx!(Icon { icon: GoGitCommit, width: width, height: height })));
    icons.push(("GoGitCompare".to_owned(), rsx!(Icon { icon: GoGitCompare, width: width, height: height })));
    icons.push(("GoGitMerge".to_owned(), rsx!(Icon { icon: GoGitMerge, width: width, height: height })));
    icons.push(("GoGitPullRequest".to_owned(), rsx!(Icon { icon: GoGitPullRequest, width: width, height: height })));
    icons.push(("GoGitPullRequestClosed".to_owned(), rsx!(Icon { icon: GoGitPullRequestClosed, width: width, height: height })));
    icons.push(("GoGitPullRequestDraft".to_owned(), rsx!(Icon { icon: GoGitPullRequestDraft, width: width, height: height })));
    icons.push(("GoGlobe".to_owned(), rsx!(Icon { icon: GoGlobe, width: width, height: height })));
    icons.push(("GoGrabber".to_owned(), rsx!(Icon { icon: GoGrabber, width: width, height: height })));
    icons.push(("GoGraph".to_owned(), rsx!(Icon { icon: GoGraph, width: width, height: height })));
    icons.push(("GoHash".to_owned(), rsx!(Icon { icon: GoHash, width: width, height: height })));
    icons.push(("GoHeading".to_owned(), rsx!(Icon { icon: GoHeading, width: width, height: height })));
    icons.push(("GoHeart".to_owned(), rsx!(Icon { icon: GoHeart, width: width, height: height })));
    icons.push(("GoHeartFill".to_owned(), rsx!(Icon { icon: GoHeartFill, width: width, height: height })));
    icons.push(("GoHistory".to_owned(), rsx!(Icon { icon: GoHistory, width: width, height: height })));
    icons.push(("GoHome".to_owned(), rsx!(Icon { icon: GoHome, width: width, height: height })));
    icons.push(("GoHorizontalRule".to_owned(), rsx!(Icon { icon: GoHorizontalRule, width: width, height: height })));
    icons.push(("GoHourglass".to_owned(), rsx!(Icon { icon: GoHourglass, width: width, height: height })));
    icons.push(("GoHubot".to_owned(), rsx!(Icon { icon: GoHubot, width: width, height: height })));
    icons.push(("GoIdBadge".to_owned(), rsx!(Icon { icon: GoIdBadge, width: width, height: height })));
    icons.push(("GoImage".to_owned(), rsx!(Icon { icon: GoImage, width: width, height: height })));
    icons.push(("GoInbox".to_owned(), rsx!(Icon { icon: GoInbox, width: width, height: height })));
    icons.push(("GoInfinity".to_owned(), rsx!(Icon { icon: GoInfinity, width: width, height: height })));
    icons.push(("GoInfo".to_owned(), rsx!(Icon { icon: GoInfo, width: width, height: height })));
    icons.push(("GoIssueClosed".to_owned(), rsx!(Icon { icon: GoIssueClosed, width: width, height: height })));
    icons.push(("GoIssueDraft".to_owned(), rsx!(Icon { icon: GoIssueDraft, width: width, height: height })));
    icons.push(("GoIssueOpened".to_owned(), rsx!(Icon { icon: GoIssueOpened, width: width, height: height })));
    icons.push(("GoIssueReopened".to_owned(), rsx!(Icon { icon: GoIssueReopened, width: width, height: height })));
    icons.push(("GoItalic".to_owned(), rsx!(Icon { icon: GoItalic, width: width, height: height })));
    icons.push(("GoIterations".to_owned(), rsx!(Icon { icon: GoIterations, width: width, height: height })));
    icons.push(("GoKebabHorizontal".to_owned(), rsx!(Icon { icon: GoKebabHorizontal, width: width, height: height })));
    icons.push(("GoKey".to_owned(), rsx!(Icon { icon: GoKey, width: width, height: height })));
    icons.push(("GoKeyAsterisk".to_owned(), rsx!(Icon { icon: GoKeyAsterisk, width: width, height: height })));
    icons.push(("GoLaw".to_owned(), rsx!(Icon { icon: GoLaw, width: width, height: height })));
    icons.push(("GoLightBulb".to_owned(), rsx!(Icon { icon: GoLightBulb, width: width, height: height })));
    icons.push(("GoLink".to_owned(), rsx!(Icon { icon: GoLink, width: width, height: height })));
    icons.push(("GoLinkExternal".to_owned(), rsx!(Icon { icon: GoLinkExternal, width: width, height: height })));
    icons.push(("GoListOrdered".to_owned(), rsx!(Icon { icon: GoListOrdered, width: width, height: height })));
    icons.push(("GoListUnordered".to_owned(), rsx!(Icon { icon: GoListUnordered, width: width, height: height })));
    icons.push(("GoLocation".to_owned(), rsx!(Icon { icon: GoLocation, width: width, height: height })));
    icons.push(("GoLock".to_owned(), rsx!(Icon { icon: GoLock, width: width, height: height })));
    icons.push(("GoLog".to_owned(), rsx!(Icon { icon: GoLog, width: width, height: height })));
    icons.push(("GoLogoGist".to_owned(), rsx!(Icon { icon: GoLogoGist, width: width, height: height })));
    icons.push(("GoLogoGithub".to_owned(), rsx!(Icon { icon: GoLogoGithub, width: width, height: height })));
    icons.push(("GoMail".to_owned(), rsx!(Icon { icon: GoMail, width: width, height: height })));
    icons.push(("GoMarkGithub".to_owned(), rsx!(Icon { icon: GoMarkGithub, width: width, height: height })));
    icons.push(("GoMarkdown".to_owned(), rsx!(Icon { icon: GoMarkdown, width: width, height: height })));
    icons.push(("GoMegaphone".to_owned(), rsx!(Icon { icon: GoMegaphone, width: width, height: height })));
    icons.push(("GoMention".to_owned(), rsx!(Icon { icon: GoMention, width: width, height: height })));
    icons.push(("GoMeter".to_owned(), rsx!(Icon { icon: GoMeter, width: width, height: height })));
    icons.push(("GoMilestone".to_owned(), rsx!(Icon { icon: GoMilestone, width: width, height: height })));
    icons.push(("GoMirror".to_owned(), rsx!(Icon { icon: GoMirror, width: width, height: height })));
    icons.push(("GoMoon".to_owned(), rsx!(Icon { icon: GoMoon, width: width, height: height })));
    icons.push(("GoMortarBoard".to_owned(), rsx!(Icon { icon: GoMortarBoard, width: width, height: height })));
    icons.push(("GoMultiSelect".to_owned(), rsx!(Icon { icon: GoMultiSelect, width: width, height: height })));
    icons.push(("GoMute".to_owned(), rsx!(Icon { icon: GoMute, width: width, height: height })));
    icons.push(("GoNoEntry".to_owned(), rsx!(Icon { icon: GoNoEntry, width: width, height: height })));
    icons.push(("GoNorthStar".to_owned(), rsx!(Icon { icon: GoNorthStar, width: width, height: height })));
    icons.push(("GoNote".to_owned(), rsx!(Icon { icon: GoNote, width: width, height: height })));
    icons.push(("GoNumber".to_owned(), rsx!(Icon { icon: GoNumber, width: width, height: height })));
    icons.push(("GoOrganization".to_owned(), rsx!(Icon { icon: GoOrganization, width: width, height: height })));
    icons.push(("GoPackage".to_owned(), rsx!(Icon { icon: GoPackage, width: width, height: height })));
    icons.push(("GoPackageDependencies".to_owned(), rsx!(Icon { icon: GoPackageDependencies, width: width, height: height })));
    icons.push(("GoPackageDependents".to_owned(), rsx!(Icon { icon: GoPackageDependents, width: width, height: height })));
    icons.push(("GoPaintbrush".to_owned(), rsx!(Icon { icon: GoPaintbrush, width: width, height: height })));
    icons.push(("GoPaperAirplane".to_owned(), rsx!(Icon { icon: GoPaperAirplane, width: width, height: height })));
    icons.push(("GoPaste".to_owned(), rsx!(Icon { icon: GoPaste, width: width, height: height })));
    icons.push(("GoPencil".to_owned(), rsx!(Icon { icon: GoPencil, width: width, height: height })));
    icons.push(("GoPeople".to_owned(), rsx!(Icon { icon: GoPeople, width: width, height: height })));
    icons.push(("GoPerson".to_owned(), rsx!(Icon { icon: GoPerson, width: width, height: height })));
    icons.push(("GoPersonAdd".to_owned(), rsx!(Icon { icon: GoPersonAdd, width: width, height: height })));
    icons.push(("GoPersonFill".to_owned(), rsx!(Icon { icon: GoPersonFill, width: width, height: height })));
    icons.push(("GoPin".to_owned(), rsx!(Icon { icon: GoPin, width: width, height: height })));
    icons.push(("GoPlay".to_owned(), rsx!(Icon { icon: GoPlay, width: width, height: height })));
    icons.push(("GoPlug".to_owned(), rsx!(Icon { icon: GoPlug, width: width, height: height })));
    icons.push(("GoPlus".to_owned(), rsx!(Icon { icon: GoPlus, width: width, height: height })));
    icons.push(("GoPlusCircle".to_owned(), rsx!(Icon { icon: GoPlusCircle, width: width, height: height })));
    icons.push(("GoProject".to_owned(), rsx!(Icon { icon: GoProject, width: width, height: height })));
    icons.push(("GoPulse".to_owned(), rsx!(Icon { icon: GoPulse, width: width, height: height })));
    icons.push(("GoQuestion".to_owned(), rsx!(Icon { icon: GoQuestion, width: width, height: height })));
    icons.push(("GoQuote".to_owned(), rsx!(Icon { icon: GoQuote, width: width, height: height })));
    icons.push(("GoReply".to_owned(), rsx!(Icon { icon: GoReply, width: width, height: height })));
    icons.push(("GoRepo".to_owned(), rsx!(Icon { icon: GoRepo, width: width, height: height })));
    icons.push(("GoRepoClone".to_owned(), rsx!(Icon { icon: GoRepoClone, width: width, height: height })));
    icons.push(("GoRepoDeleted".to_owned(), rsx!(Icon { icon: GoRepoDeleted, width: width, height: height })));
    icons.push(("GoRepoForked".to_owned(), rsx!(Icon { icon: GoRepoForked, width: width, height: height })));
    icons.push(("GoRepoLocked".to_owned(), rsx!(Icon { icon: GoRepoLocked, width: width, height: height })));
    icons.push(("GoRepoPull".to_owned(), rsx!(Icon { icon: GoRepoPull, width: width, height: height })));
    icons.push(("GoRepoPush".to_owned(), rsx!(Icon { icon: GoRepoPush, width: width, height: height })));
    icons.push(("GoRepoTemplate".to_owned(), rsx!(Icon { icon: GoRepoTemplate, width: width, height: height })));
    icons.push(("GoReport".to_owned(), rsx!(Icon { icon: GoReport, width: width, height: height })));
    icons.push(("GoRocket".to_owned(), rsx!(Icon { icon: GoRocket, width: width, height: height })));
    icons.push(("GoRows".to_owned(), rsx!(Icon { icon: GoRows, width: width, height: height })));
    icons.push(("GoRss".to_owned(), rsx!(Icon { icon: GoRss, width: width, height: height })));
    icons.push(("GoRuby".to_owned(), rsx!(Icon { icon: GoRuby, width: width, height: height })));
    icons.push(("GoScreenFull".to_owned(), rsx!(Icon { icon: GoScreenFull, width: width, height: height })));
    icons.push(("GoScreenNormal".to_owned(), rsx!(Icon { icon: GoScreenNormal, width: width, height: height })));
    icons.push(("GoSearch".to_owned(), rsx!(Icon { icon: GoSearch, width: width, height: height })));
    icons.push(("GoServer".to_owned(), rsx!(Icon { icon: GoServer, width: width, height: height })));
    icons.push(("GoShare".to_owned(), rsx!(Icon { icon: GoShare, width: width, height: height })));
    icons.push(("GoShareAndroid".to_owned(), rsx!(Icon { icon: GoShareAndroid, width: width, height: height })));
    icons.push(("GoShield".to_owned(), rsx!(Icon { icon: GoShield, width: width, height: height })));
    icons.push(("GoShieldCheck".to_owned(), rsx!(Icon { icon: GoShieldCheck, width: width, height: height })));
    icons.push(("GoShieldLock".to_owned(), rsx!(Icon { icon: GoShieldLock, width: width, height: height })));
    icons.push(("GoShieldX".to_owned(), rsx!(Icon { icon: GoShieldX, width: width, height: height })));
    icons.push(("GoSidebarCollapse".to_owned(), rsx!(Icon { icon: GoSidebarCollapse, width: width, height: height })));
    icons.push(("GoSidebarExpand".to_owned(), rsx!(Icon { icon: GoSidebarExpand, width: width, height: height })));
    icons.push(("GoSignIn".to_owned(), rsx!(Icon { icon: GoSignIn, width: width, height: height })));
    icons.push(("GoSignOut".to_owned(), rsx!(Icon { icon: GoSignOut, width: width, height: height })));
    icons.push(("GoSingleSelect".to_owned(), rsx!(Icon { icon: GoSingleSelect, width: width, height: height })));
    icons.push(("GoSkip".to_owned(), rsx!(Icon { icon: GoSkip, width: width, height: height })));
    icons.push(("GoSliders".to_owned(), rsx!(Icon { icon: GoSliders, width: width, height: height })));
    icons.push(("GoSmiley".to_owned(), rsx!(Icon { icon: GoSmiley, width: width, height: height })));
    icons.push(("GoSortAsc".to_owned(), rsx!(Icon { icon: GoSortAsc, width: width, height: height })));
    icons.push(("GoSortDesc".to_owned(), rsx!(Icon { icon: GoSortDesc, width: width, height: height })));
    icons.push(("GoSquare".to_owned(), rsx!(Icon { icon: GoSquare, width: width, height: height })));
    icons.push(("GoSquareFill".to_owned(), rsx!(Icon { icon: GoSquareFill, width: width, height: height })));
    icons.push(("GoSquirrel".to_owned(), rsx!(Icon { icon: GoSquirrel, width: width, height: height })));
    icons.push(("GoStack".to_owned(), rsx!(Icon { icon: GoStack, width: width, height: height })));
    icons.push(("GoStar".to_owned(), rsx!(Icon { icon: GoStar, width: width, height: height })));
    icons.push(("GoStarFill".to_owned(), rsx!(Icon { icon: GoStarFill, width: width, height: height })));
    icons.push(("GoStop".to_owned(), rsx!(Icon { icon: GoStop, width: width, height: height })));
    icons.push(("GoStopwatch".to_owned(), rsx!(Icon { icon: GoStopwatch, width: width, height: height })));
    icons.push(("GoStrikethrough".to_owned(), rsx!(Icon { icon: GoStrikethrough, width: width, height: height })));
    icons.push(("GoSun".to_owned(), rsx!(Icon { icon: GoSun, width: width, height: height })));
    icons.push(("GoSync".to_owned(), rsx!(Icon { icon: GoSync, width: width, height: height })));
    icons.push(("GoTabExternal".to_owned(), rsx!(Icon { icon: GoTabExternal, width: width, height: height })));
    icons.push(("GoTable".to_owned(), rsx!(Icon { icon: GoTable, width: width, height: height })));
    icons.push(("GoTag".to_owned(), rsx!(Icon { icon: GoTag, width: width, height: height })));
    icons.push(("GoTasklist".to_owned(), rsx!(Icon { icon: GoTasklist, width: width, height: height })));
    icons.push(("GoTelescope".to_owned(), rsx!(Icon { icon: GoTelescope, width: width, height: height })));
    icons.push(("GoTelescopeFill".to_owned(), rsx!(Icon { icon: GoTelescopeFill, width: width, height: height })));
    icons.push(("GoTerminal".to_owned(), rsx!(Icon { icon: GoTerminal, width: width, height: height })));
    icons.push(("GoThreeBars".to_owned(), rsx!(Icon { icon: GoThreeBars, width: width, height: height })));
    icons.push(("GoThumbsdown".to_owned(), rsx!(Icon { icon: GoThumbsdown, width: width, height: height })));
    icons.push(("GoThumbsup".to_owned(), rsx!(Icon { icon: GoThumbsup, width: width, height: height })));
    icons.push(("GoTools".to_owned(), rsx!(Icon { icon: GoTools, width: width, height: height })));
    icons.push(("GoTrash".to_owned(), rsx!(Icon { icon: GoTrash, width: width, height: height })));
    icons.push(("GoTriangleDown".to_owned(), rsx!(Icon { icon: GoTriangleDown, width: width, height: height })));
    icons.push(("GoTriangleLeft".to_owned(), rsx!(Icon { icon: GoTriangleLeft, width: width, height: height })));
    icons.push(("GoTriangleRight".to_owned(), rsx!(Icon { icon: GoTriangleRight, width: width, height: height })));
    icons.push(("GoTriangleUp".to_owned(), rsx!(Icon { icon: GoTriangleUp, width: width, height: height })));
    icons.push(("GoTrophy".to_owned(), rsx!(Icon { icon: GoTrophy, width: width, height: height })));
    icons.push(("GoTypography".to_owned(), rsx!(Icon { icon: GoTypography, width: width, height: height })));
    icons.push(("GoUnfold".to_owned(), rsx!(Icon { icon: GoUnfold, width: width, height: height })));
    icons.push(("GoUnlock".to_owned(), rsx!(Icon { icon: GoUnlock, width: width, height: height })));
    icons.push(("GoUnmute".to_owned(), rsx!(Icon { icon: GoUnmute, width: width, height: height })));
    icons.push(("GoUnverified".to_owned(), rsx!(Icon { icon: GoUnverified, width: width, height: height })));
    icons.push(("GoUpload".to_owned(), rsx!(Icon { icon: GoUpload, width: width, height: height })));
    icons.push(("GoVerified".to_owned(), rsx!(Icon { icon: GoVerified, width: width, height: height })));
    icons.push(("GoVersions".to_owned(), rsx!(Icon { icon: GoVersions, width: width, height: height })));
    icons.push(("GoVideo".to_owned(), rsx!(Icon { icon: GoVideo, width: width, height: height })));
    icons.push(("GoWebhook".to_owned(), rsx!(Icon { icon: GoWebhook, width: width, height: height })));
    icons.push(("GoWorkflow".to_owned(), rsx!(Icon { icon: GoWorkflow, width: width, height: height })));
    icons.push(("GoX".to_owned(), rsx!(Icon { icon: GoX, width: width, height: height })));
    icons.push(("GoXCircle".to_owned(), rsx!(Icon { icon: GoXCircle, width: width, height: height })));
    icons.push(("GoXCircleFill".to_owned(), rsx!(Icon { icon: GoXCircleFill, width: width, height: height })));
    icons.push(("GoZap".to_owned(), rsx!(Icon { icon: GoZap, width: width, height: height })));
    icons
}}
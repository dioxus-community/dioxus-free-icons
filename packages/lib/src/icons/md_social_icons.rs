...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("Md18UpRating".to_owned(), rsx!(Icon { icon: Md18UpRating, width: width, height: height })));
    icons.push(("Md6FtApart".to_owned(), rsx!(Icon { icon: Md6FtApart, width: width, height: height })));
    icons.push(("MdAddModerator".to_owned(), rsx!(Icon { icon: MdAddModerator, width: width, height: height })));
    icons.push(("MdAddReaction".to_owned(), rsx!(Icon { icon: MdAddReaction, width: width, height: height })));
    icons.push(("MdArchitecture".to_owned(), rsx!(Icon { icon: MdArchitecture, width: width, height: height })));
    icons.push(("MdAssistWalker".to_owned(), rsx!(Icon { icon: MdAssistWalker, width: width, height: height })));
    icons.push(("MdBackHand".to_owned(), rsx!(Icon { icon: MdBackHand, width: width, height: height })));
    icons.push(("MdBlind".to_owned(), rsx!(Icon { icon: MdBlind, width: width, height: height })));
    icons.push(("MdBoy".to_owned(), rsx!(Icon { icon: MdBoy, width: width, height: height })));
    icons.push(("MdCake".to_owned(), rsx!(Icon { icon: MdCake, width: width, height: height })));
    icons.push(("MdCatchingPokemon".to_owned(), rsx!(Icon { icon: MdCatchingPokemon, width: width, height: height })));
    icons.push(("MdCleanHands".to_owned(), rsx!(Icon { icon: MdCleanHands, width: width, height: height })));
    icons.push(("MdCo2".to_owned(), rsx!(Icon { icon: MdCo2, width: width, height: height })));
    icons.push(("MdCompost".to_owned(), rsx!(Icon { icon: MdCompost, width: width, height: height })));
    icons.push(("MdConnectWithoutContact".to_owned(), rsx!(Icon { icon: MdConnectWithoutContact, width: width, height: height })));
    icons.push(("MdConstruction".to_owned(), rsx!(Icon { icon: MdConstruction, width: width, height: height })));
    icons.push(("MdCookie".to_owned(), rsx!(Icon { icon: MdCookie, width: width, height: height })));
    icons.push(("MdCoronavirus".to_owned(), rsx!(Icon { icon: MdCoronavirus, width: width, height: height })));
    icons.push(("MdCrueltyFree".to_owned(), rsx!(Icon { icon: MdCrueltyFree, width: width, height: height })));
    icons.push(("MdCyclone".to_owned(), rsx!(Icon { icon: MdCyclone, width: width, height: height })));
    icons.push(("MdDeck".to_owned(), rsx!(Icon { icon: MdDeck, width: width, height: height })));
    icons.push(("MdDewPoint".to_owned(), rsx!(Icon { icon: MdDewPoint, width: width, height: height })));
    icons.push(("MdDiversity1".to_owned(), rsx!(Icon { icon: MdDiversity1, width: width, height: height })));
    icons.push(("MdDiversity2".to_owned(), rsx!(Icon { icon: MdDiversity2, width: width, height: height })));
    icons.push(("MdDiversity3".to_owned(), rsx!(Icon { icon: MdDiversity3, width: width, height: height })));
    icons.push(("MdDomain".to_owned(), rsx!(Icon { icon: MdDomain, width: width, height: height })));
    icons.push(("MdDomainAdd".to_owned(), rsx!(Icon { icon: MdDomainAdd, width: width, height: height })));
    icons.push(("MdDownhillSkiing".to_owned(), rsx!(Icon { icon: MdDownhillSkiing, width: width, height: height })));
    icons.push(("MdEditNotifications".to_owned(), rsx!(Icon { icon: MdEditNotifications, width: width, height: height })));
    icons.push(("MdElderly".to_owned(), rsx!(Icon { icon: MdElderly, width: width, height: height })));
    icons.push(("MdElderlyWoman".to_owned(), rsx!(Icon { icon: MdElderlyWoman, width: width, height: height })));
    icons.push(("MdEmojiEmotions".to_owned(), rsx!(Icon { icon: MdEmojiEmotions, width: width, height: height })));
    icons.push(("MdEmojiEvents".to_owned(), rsx!(Icon { icon: MdEmojiEvents, width: width, height: height })));
    icons.push(("MdEmojiFlags".to_owned(), rsx!(Icon { icon: MdEmojiFlags, width: width, height: height })));
    icons.push(("MdEmojiFoodBeverage".to_owned(), rsx!(Icon { icon: MdEmojiFoodBeverage, width: width, height: height })));
    icons.push(("MdEmojiNature".to_owned(), rsx!(Icon { icon: MdEmojiNature, width: width, height: height })));
    icons.push(("MdEmojiObjects".to_owned(), rsx!(Icon { icon: MdEmojiObjects, width: width, height: height })));
    icons.push(("MdEmojiPeople".to_owned(), rsx!(Icon { icon: MdEmojiPeople, width: width, height: height })));
    icons.push(("MdEmojiSymbols".to_owned(), rsx!(Icon { icon: MdEmojiSymbols, width: width, height: height })));
    icons.push(("MdEmojiTransportation".to_owned(), rsx!(Icon { icon: MdEmojiTransportation, width: width, height: height })));
    icons.push(("MdEngineering".to_owned(), rsx!(Icon { icon: MdEngineering, width: width, height: height })));
    icons.push(("MdFace2".to_owned(), rsx!(Icon { icon: MdFace2, width: width, height: height })));
    icons.push(("MdFace3".to_owned(), rsx!(Icon { icon: MdFace3, width: width, height: height })));
    icons.push(("MdFace4".to_owned(), rsx!(Icon { icon: MdFace4, width: width, height: height })));
    icons.push(("MdFace5".to_owned(), rsx!(Icon { icon: MdFace5, width: width, height: height })));
    icons.push(("MdFace6".to_owned(), rsx!(Icon { icon: MdFace6, width: width, height: height })));
    icons.push(("MdFacebook".to_owned(), rsx!(Icon { icon: MdFacebook, width: width, height: height })));
    icons.push(("MdFemale".to_owned(), rsx!(Icon { icon: MdFemale, width: width, height: height })));
    icons.push(("MdFireplace".to_owned(), rsx!(Icon { icon: MdFireplace, width: width, height: height })));
    icons.push(("MdFitbit".to_owned(), rsx!(Icon { icon: MdFitbit, width: width, height: height })));
    icons.push(("MdFlood".to_owned(), rsx!(Icon { icon: MdFlood, width: width, height: height })));
    icons.push(("MdFollowTheSigns".to_owned(), rsx!(Icon { icon: MdFollowTheSigns, width: width, height: height })));
    icons.push(("MdFrontHand".to_owned(), rsx!(Icon { icon: MdFrontHand, width: width, height: height })));
    icons.push(("MdGirl".to_owned(), rsx!(Icon { icon: MdGirl, width: width, height: height })));
    icons.push(("MdGroup".to_owned(), rsx!(Icon { icon: MdGroup, width: width, height: height })));
    icons.push(("MdGroupAdd".to_owned(), rsx!(Icon { icon: MdGroupAdd, width: width, height: height })));
    icons.push(("MdGroupOff".to_owned(), rsx!(Icon { icon: MdGroupOff, width: width, height: height })));
    icons.push(("MdGroupRemove".to_owned(), rsx!(Icon { icon: MdGroupRemove, width: width, height: height })));
    icons.push(("MdGroups".to_owned(), rsx!(Icon { icon: MdGroups, width: width, height: height })));
    icons.push(("MdGroups2".to_owned(), rsx!(Icon { icon: MdGroups2, width: width, height: height })));
    icons.push(("MdGroups3".to_owned(), rsx!(Icon { icon: MdGroups3, width: width, height: height })));
    icons.push(("MdHandshake".to_owned(), rsx!(Icon { icon: MdHandshake, width: width, height: height })));
    icons.push(("MdHealthAndSafety".to_owned(), rsx!(Icon { icon: MdHealthAndSafety, width: width, height: height })));
    icons.push(("MdHeartBroken".to_owned(), rsx!(Icon { icon: MdHeartBroken, width: width, height: height })));
    icons.push(("MdHiking".to_owned(), rsx!(Icon { icon: MdHiking, width: width, height: height })));
    icons.push(("MdHistoryEdu".to_owned(), rsx!(Icon { icon: MdHistoryEdu, width: width, height: height })));
    icons.push(("MdHive".to_owned(), rsx!(Icon { icon: MdHive, width: width, height: height })));
    icons.push(("MdIceSkating".to_owned(), rsx!(Icon { icon: MdIceSkating, width: width, height: height })));
    icons.push(("MdInterests".to_owned(), rsx!(Icon { icon: MdInterests, width: width, height: height })));
    icons.push(("MdIosShare".to_owned(), rsx!(Icon { icon: MdIosShare, width: width, height: height })));
    icons.push(("MdKayaking".to_owned(), rsx!(Icon { icon: MdKayaking, width: width, height: height })));
    icons.push(("MdKingBed".to_owned(), rsx!(Icon { icon: MdKingBed, width: width, height: height })));
    icons.push(("MdKitesurfing".to_owned(), rsx!(Icon { icon: MdKitesurfing, width: width, height: height })));
    icons.push(("MdLandslide".to_owned(), rsx!(Icon { icon: MdLandslide, width: width, height: height })));
    icons.push(("MdLocationCity".to_owned(), rsx!(Icon { icon: MdLocationCity, width: width, height: height })));
    icons.push(("MdLuggage".to_owned(), rsx!(Icon { icon: MdLuggage, width: width, height: height })));
    icons.push(("MdMale".to_owned(), rsx!(Icon { icon: MdMale, width: width, height: height })));
    icons.push(("MdMan".to_owned(), rsx!(Icon { icon: MdMan, width: width, height: height })));
    icons.push(("MdMan2".to_owned(), rsx!(Icon { icon: MdMan2, width: width, height: height })));
    icons.push(("MdMan3".to_owned(), rsx!(Icon { icon: MdMan3, width: width, height: height })));
    icons.push(("MdMan4".to_owned(), rsx!(Icon { icon: MdMan4, width: width, height: height })));
    icons.push(("MdMasks".to_owned(), rsx!(Icon { icon: MdMasks, width: width, height: height })));
    icons.push(("MdMilitaryTech".to_owned(), rsx!(Icon { icon: MdMilitaryTech, width: width, height: height })));
    icons.push(("MdMood".to_owned(), rsx!(Icon { icon: MdMood, width: width, height: height })));
    icons.push(("MdMoodBad".to_owned(), rsx!(Icon { icon: MdMoodBad, width: width, height: height })));
    icons.push(("MdNightsStay".to_owned(), rsx!(Icon { icon: MdNightsStay, width: width, height: height })));
    icons.push(("MdNoAdultContent".to_owned(), rsx!(Icon { icon: MdNoAdultContent, width: width, height: height })));
    icons.push(("MdNoLuggage".to_owned(), rsx!(Icon { icon: MdNoLuggage, width: width, height: height })));
    icons.push(("MdNordicWalking".to_owned(), rsx!(Icon { icon: MdNordicWalking, width: width, height: height })));
    icons.push(("MdNotificationAdd".to_owned(), rsx!(Icon { icon: MdNotificationAdd, width: width, height: height })));
    icons.push(("MdNotifications".to_owned(), rsx!(Icon { icon: MdNotifications, width: width, height: height })));
    icons.push(("MdNotificationsActive".to_owned(), rsx!(Icon { icon: MdNotificationsActive, width: width, height: height })));
    icons.push(("MdNotificationsNone".to_owned(), rsx!(Icon { icon: MdNotificationsNone, width: width, height: height })));
    icons.push(("MdNotificationsOff".to_owned(), rsx!(Icon { icon: MdNotificationsOff, width: width, height: height })));
    icons.push(("MdNotificationsPaused".to_owned(), rsx!(Icon { icon: MdNotificationsPaused, width: width, height: height })));
    icons.push(("MdOutdoorGrill".to_owned(), rsx!(Icon { icon: MdOutdoorGrill, width: width, height: height })));
    icons.push(("MdPages".to_owned(), rsx!(Icon { icon: MdPages, width: width, height: height })));
    icons.push(("MdParagliding".to_owned(), rsx!(Icon { icon: MdParagliding, width: width, height: height })));
    icons.push(("MdPartyMode".to_owned(), rsx!(Icon { icon: MdPartyMode, width: width, height: height })));
    icons.push(("MdPeople".to_owned(), rsx!(Icon { icon: MdPeople, width: width, height: height })));
    icons.push(("MdPeopleAlt".to_owned(), rsx!(Icon { icon: MdPeopleAlt, width: width, height: height })));
    icons.push(("MdPeopleOutline".to_owned(), rsx!(Icon { icon: MdPeopleOutline, width: width, height: height })));
    icons.push(("MdPerson".to_owned(), rsx!(Icon { icon: MdPerson, width: width, height: height })));
    icons.push(("MdPerson2".to_owned(), rsx!(Icon { icon: MdPerson2, width: width, height: height })));
    icons.push(("MdPerson3".to_owned(), rsx!(Icon { icon: MdPerson3, width: width, height: height })));
    icons.push(("MdPerson4".to_owned(), rsx!(Icon { icon: MdPerson4, width: width, height: height })));
    icons.push(("MdPersonAdd".to_owned(), rsx!(Icon { icon: MdPersonAdd, width: width, height: height })));
    icons.push(("MdPersonAddAlt".to_owned(), rsx!(Icon { icon: MdPersonAddAlt, width: width, height: height })));
    icons.push(("MdPersonAddAlt1".to_owned(), rsx!(Icon { icon: MdPersonAddAlt1, width: width, height: height })));
    icons.push(("MdPersonOff".to_owned(), rsx!(Icon { icon: MdPersonOff, width: width, height: height })));
    icons.push(("MdPersonOutline".to_owned(), rsx!(Icon { icon: MdPersonOutline, width: width, height: height })));
    icons.push(("MdPersonRemove".to_owned(), rsx!(Icon { icon: MdPersonRemove, width: width, height: height })));
    icons.push(("MdPersonRemoveAlt1".to_owned(), rsx!(Icon { icon: MdPersonRemoveAlt1, width: width, height: height })));
    icons.push(("MdPersonalInjury".to_owned(), rsx!(Icon { icon: MdPersonalInjury, width: width, height: height })));
    icons.push(("MdPiano".to_owned(), rsx!(Icon { icon: MdPiano, width: width, height: height })));
    icons.push(("MdPianoOff".to_owned(), rsx!(Icon { icon: MdPianoOff, width: width, height: height })));
    icons.push(("MdPix".to_owned(), rsx!(Icon { icon: MdPix, width: width, height: height })));
    icons.push(("MdPlusOne".to_owned(), rsx!(Icon { icon: MdPlusOne, width: width, height: height })));
    icons.push(("MdPoll".to_owned(), rsx!(Icon { icon: MdPoll, width: width, height: height })));
    icons.push(("MdPrecisionManufacturing".to_owned(), rsx!(Icon { icon: MdPrecisionManufacturing, width: width, height: height })));
    icons.push(("MdPsychology".to_owned(), rsx!(Icon { icon: MdPsychology, width: width, height: height })));
    icons.push(("MdPsychologyAlt".to_owned(), rsx!(Icon { icon: MdPsychologyAlt, width: width, height: height })));
    icons.push(("MdPublic".to_owned(), rsx!(Icon { icon: MdPublic, width: width, height: height })));
    icons.push(("MdPublicOff".to_owned(), rsx!(Icon { icon: MdPublicOff, width: width, height: height })));
    icons.push(("MdRealEstateAgent".to_owned(), rsx!(Icon { icon: MdRealEstateAgent, width: width, height: height })));
    icons.push(("MdRecommend".to_owned(), rsx!(Icon { icon: MdRecommend, width: width, height: height })));
    icons.push(("MdRecycling".to_owned(), rsx!(Icon { icon: MdRecycling, width: width, height: height })));
    icons.push(("MdReduceCapacity".to_owned(), rsx!(Icon { icon: MdReduceCapacity, width: width, height: height })));
    icons.push(("MdRemoveModerator".to_owned(), rsx!(Icon { icon: MdRemoveModerator, width: width, height: height })));
    icons.push(("MdRollerSkating".to_owned(), rsx!(Icon { icon: MdRollerSkating, width: width, height: height })));
    icons.push(("MdSafetyDivider".to_owned(), rsx!(Icon { icon: MdSafetyDivider, width: width, height: height })));
    icons.push(("MdSanitizer".to_owned(), rsx!(Icon { icon: MdSanitizer, width: width, height: height })));
    icons.push(("MdScale".to_owned(), rsx!(Icon { icon: MdScale, width: width, height: height })));
    icons.push(("MdSchool".to_owned(), rsx!(Icon { icon: MdSchool, width: width, height: height })));
    icons.push(("MdScience".to_owned(), rsx!(Icon { icon: MdScience, width: width, height: height })));
    icons.push(("MdScoreboard".to_owned(), rsx!(Icon { icon: MdScoreboard, width: width, height: height })));
    icons.push(("MdScubaDiving".to_owned(), rsx!(Icon { icon: MdScubaDiving, width: width, height: height })));
    icons.push(("MdSelfImprovement".to_owned(), rsx!(Icon { icon: MdSelfImprovement, width: width, height: height })));
    icons.push(("MdSentimentDissatisfied".to_owned(), rsx!(Icon { icon: MdSentimentDissatisfied, width: width, height: height })));
    icons.push(("MdSentimentNeutral".to_owned(), rsx!(Icon { icon: MdSentimentNeutral, width: width, height: height })));
    icons.push(("MdSentimentSatisfied".to_owned(), rsx!(Icon { icon: MdSentimentSatisfied, width: width, height: height })));
    icons.push(("MdSentimentVeryDissatisfied".to_owned(), rsx!(Icon { icon: MdSentimentVeryDissatisfied, width: width, height: height })));
    icons.push(("MdSentimentVerySatisfied".to_owned(), rsx!(Icon { icon: MdSentimentVerySatisfied, width: width, height: height })));
    icons.push(("MdSevereCold".to_owned(), rsx!(Icon { icon: MdSevereCold, width: width, height: height })));
    icons.push(("MdShare".to_owned(), rsx!(Icon { icon: MdShare, width: width, height: height })));
    icons.push(("MdSick".to_owned(), rsx!(Icon { icon: MdSick, width: width, height: height })));
    icons.push(("MdSignLanguage".to_owned(), rsx!(Icon { icon: MdSignLanguage, width: width, height: height })));
    icons.push(("MdSingleBed".to_owned(), rsx!(Icon { icon: MdSingleBed, width: width, height: height })));
    icons.push(("MdSkateboarding".to_owned(), rsx!(Icon { icon: MdSkateboarding, width: width, height: height })));
    icons.push(("MdSledding".to_owned(), rsx!(Icon { icon: MdSledding, width: width, height: height })));
    icons.push(("MdSnowboarding".to_owned(), rsx!(Icon { icon: MdSnowboarding, width: width, height: height })));
    icons.push(("MdSnowshoeing".to_owned(), rsx!(Icon { icon: MdSnowshoeing, width: width, height: height })));
    icons.push(("MdSocialDistance".to_owned(), rsx!(Icon { icon: MdSocialDistance, width: width, height: height })));
    icons.push(("MdSouthAmerica".to_owned(), rsx!(Icon { icon: MdSouthAmerica, width: width, height: height })));
    icons.push(("MdSports".to_owned(), rsx!(Icon { icon: MdSports, width: width, height: height })));
    icons.push(("MdSportsBaseball".to_owned(), rsx!(Icon { icon: MdSportsBaseball, width: width, height: height })));
    icons.push(("MdSportsBasketball".to_owned(), rsx!(Icon { icon: MdSportsBasketball, width: width, height: height })));
    icons.push(("MdSportsCricket".to_owned(), rsx!(Icon { icon: MdSportsCricket, width: width, height: height })));
    icons.push(("MdSportsEsports".to_owned(), rsx!(Icon { icon: MdSportsEsports, width: width, height: height })));
    icons.push(("MdSportsFootball".to_owned(), rsx!(Icon { icon: MdSportsFootball, width: width, height: height })));
    icons.push(("MdSportsGolf".to_owned(), rsx!(Icon { icon: MdSportsGolf, width: width, height: height })));
    icons.push(("MdSportsGymnastics".to_owned(), rsx!(Icon { icon: MdSportsGymnastics, width: width, height: height })));
    icons.push(("MdSportsHandball".to_owned(), rsx!(Icon { icon: MdSportsHandball, width: width, height: height })));
    icons.push(("MdSportsHockey".to_owned(), rsx!(Icon { icon: MdSportsHockey, width: width, height: height })));
    icons.push(("MdSportsKabaddi".to_owned(), rsx!(Icon { icon: MdSportsKabaddi, width: width, height: height })));
    icons.push(("MdSportsMartialArts".to_owned(), rsx!(Icon { icon: MdSportsMartialArts, width: width, height: height })));
    icons.push(("MdSportsMma".to_owned(), rsx!(Icon { icon: MdSportsMma, width: width, height: height })));
    icons.push(("MdSportsMotorsports".to_owned(), rsx!(Icon { icon: MdSportsMotorsports, width: width, height: height })));
    icons.push(("MdSportsRugby".to_owned(), rsx!(Icon { icon: MdSportsRugby, width: width, height: height })));
    icons.push(("MdSportsSoccer".to_owned(), rsx!(Icon { icon: MdSportsSoccer, width: width, height: height })));
    icons.push(("MdSportsTennis".to_owned(), rsx!(Icon { icon: MdSportsTennis, width: width, height: height })));
    icons.push(("MdSportsVolleyball".to_owned(), rsx!(Icon { icon: MdSportsVolleyball, width: width, height: height })));
    icons.push(("MdSurfing".to_owned(), rsx!(Icon { icon: MdSurfing, width: width, height: height })));
    icons.push(("MdSwitchAccount".to_owned(), rsx!(Icon { icon: MdSwitchAccount, width: width, height: height })));
    icons.push(("MdThumbDownAlt".to_owned(), rsx!(Icon { icon: MdThumbDownAlt, width: width, height: height })));
    icons.push(("MdThumbUpAlt".to_owned(), rsx!(Icon { icon: MdThumbUpAlt, width: width, height: height })));
    icons.push(("MdThunderstorm".to_owned(), rsx!(Icon { icon: MdThunderstorm, width: width, height: height })));
    icons.push(("MdTornado".to_owned(), rsx!(Icon { icon: MdTornado, width: width, height: height })));
    icons.push(("MdTransgender".to_owned(), rsx!(Icon { icon: MdTransgender, width: width, height: height })));
    icons.push(("MdTravelExplore".to_owned(), rsx!(Icon { icon: MdTravelExplore, width: width, height: height })));
    icons.push(("MdTsunami".to_owned(), rsx!(Icon { icon: MdTsunami, width: width, height: height })));
    icons.push(("MdVaccines".to_owned(), rsx!(Icon { icon: MdVaccines, width: width, height: height })));
    icons.push(("MdVolcano".to_owned(), rsx!(Icon { icon: MdVolcano, width: width, height: height })));
    icons.push(("MdWallet".to_owned(), rsx!(Icon { icon: MdWallet, width: width, height: height })));
    icons.push(("MdWaterDrop".to_owned(), rsx!(Icon { icon: MdWaterDrop, width: width, height: height })));
    icons.push(("MdWavingHand".to_owned(), rsx!(Icon { icon: MdWavingHand, width: width, height: height })));
    icons.push(("MdWhatsapp".to_owned(), rsx!(Icon { icon: MdWhatsapp, width: width, height: height })));
    icons.push(("MdWhatshot".to_owned(), rsx!(Icon { icon: MdWhatshot, width: width, height: height })));
    icons.push(("MdWoman".to_owned(), rsx!(Icon { icon: MdWoman, width: width, height: height })));
    icons.push(("MdWoman2".to_owned(), rsx!(Icon { icon: MdWoman2, width: width, height: height })));
    icons.push(("MdWorkspacePremium".to_owned(), rsx!(Icon { icon: MdWorkspacePremium, width: width, height: height })));
    icons
}}
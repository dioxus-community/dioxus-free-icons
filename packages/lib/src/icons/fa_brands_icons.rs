...
pub fn names(width: u32, height: u32) -> Vec<(String, Element)> {{
    ...
    icons.push(("Fa42Group".to_owned(), rsx!(Icon { icon: Fa42Group, width: width, height: height })));
    icons.push(("Fa500px".to_owned(), rsx!(Icon { icon: Fa500px, width: width, height: height })));
    icons.push(("FaAccessibleIcon".to_owned(), rsx!(Icon { icon: FaAccessibleIcon, width: width, height: height })));
    icons.push(("FaAccusoft".to_owned(), rsx!(Icon { icon: FaAccusoft, width: width, height: height })));
    icons.push(("FaAdn".to_owned(), rsx!(Icon { icon: FaAdn, width: width, height: height })));
    icons.push(("FaAdversal".to_owned(), rsx!(Icon { icon: FaAdversal, width: width, height: height })));
    icons.push(("FaAffiliatetheme".to_owned(), rsx!(Icon { icon: FaAffiliatetheme, width: width, height: height })));
    icons.push(("FaAirbnb".to_owned(), rsx!(Icon { icon: FaAirbnb, width: width, height: height })));
    icons.push(("FaAlgolia".to_owned(), rsx!(Icon { icon: FaAlgolia, width: width, height: height })));
    icons.push(("FaAlipay".to_owned(), rsx!(Icon { icon: FaAlipay, width: width, height: height })));
    icons.push(("FaAmazonPay".to_owned(), rsx!(Icon { icon: FaAmazonPay, width: width, height: height })));
    icons.push(("FaAmazon".to_owned(), rsx!(Icon { icon: FaAmazon, width: width, height: height })));
    icons.push(("FaAmilia".to_owned(), rsx!(Icon { icon: FaAmilia, width: width, height: height })));
    icons.push(("FaAndroid".to_owned(), rsx!(Icon { icon: FaAndroid, width: width, height: height })));
    icons.push(("FaAngellist".to_owned(), rsx!(Icon { icon: FaAngellist, width: width, height: height })));
    icons.push(("FaAngrycreative".to_owned(), rsx!(Icon { icon: FaAngrycreative, width: width, height: height })));
    icons.push(("FaAngular".to_owned(), rsx!(Icon { icon: FaAngular, width: width, height: height })));
    icons.push(("FaAppStoreIos".to_owned(), rsx!(Icon { icon: FaAppStoreIos, width: width, height: height })));
    icons.push(("FaAppStore".to_owned(), rsx!(Icon { icon: FaAppStore, width: width, height: height })));
    icons.push(("FaApper".to_owned(), rsx!(Icon { icon: FaApper, width: width, height: height })));
    icons.push(("FaApplePay".to_owned(), rsx!(Icon { icon: FaApplePay, width: width, height: height })));
    icons.push(("FaApple".to_owned(), rsx!(Icon { icon: FaApple, width: width, height: height })));
    icons.push(("FaArtstation".to_owned(), rsx!(Icon { icon: FaArtstation, width: width, height: height })));
    icons.push(("FaAsymmetrik".to_owned(), rsx!(Icon { icon: FaAsymmetrik, width: width, height: height })));
    icons.push(("FaAtlassian".to_owned(), rsx!(Icon { icon: FaAtlassian, width: width, height: height })));
    icons.push(("FaAudible".to_owned(), rsx!(Icon { icon: FaAudible, width: width, height: height })));
    icons.push(("FaAutoprefixer".to_owned(), rsx!(Icon { icon: FaAutoprefixer, width: width, height: height })));
    icons.push(("FaAvianex".to_owned(), rsx!(Icon { icon: FaAvianex, width: width, height: height })));
    icons.push(("FaAviato".to_owned(), rsx!(Icon { icon: FaAviato, width: width, height: height })));
    icons.push(("FaAws".to_owned(), rsx!(Icon { icon: FaAws, width: width, height: height })));
    icons.push(("FaBandcamp".to_owned(), rsx!(Icon { icon: FaBandcamp, width: width, height: height })));
    icons.push(("FaBattleNet".to_owned(), rsx!(Icon { icon: FaBattleNet, width: width, height: height })));
    icons.push(("FaBehanceSquare".to_owned(), rsx!(Icon { icon: FaBehanceSquare, width: width, height: height })));
    icons.push(("FaBehance".to_owned(), rsx!(Icon { icon: FaBehance, width: width, height: height })));
    icons.push(("FaBilibili".to_owned(), rsx!(Icon { icon: FaBilibili, width: width, height: height })));
    icons.push(("FaBimobject".to_owned(), rsx!(Icon { icon: FaBimobject, width: width, height: height })));
    icons.push(("FaBitbucket".to_owned(), rsx!(Icon { icon: FaBitbucket, width: width, height: height })));
    icons.push(("FaBitcoin".to_owned(), rsx!(Icon { icon: FaBitcoin, width: width, height: height })));
    icons.push(("FaBity".to_owned(), rsx!(Icon { icon: FaBity, width: width, height: height })));
    icons.push(("FaBlackTie".to_owned(), rsx!(Icon { icon: FaBlackTie, width: width, height: height })));
    icons.push(("FaBlackberry".to_owned(), rsx!(Icon { icon: FaBlackberry, width: width, height: height })));
    icons.push(("FaBloggerB".to_owned(), rsx!(Icon { icon: FaBloggerB, width: width, height: height })));
    icons.push(("FaBlogger".to_owned(), rsx!(Icon { icon: FaBlogger, width: width, height: height })));
    icons.push(("FaBluetoothB".to_owned(), rsx!(Icon { icon: FaBluetoothB, width: width, height: height })));
    icons.push(("FaBluetooth".to_owned(), rsx!(Icon { icon: FaBluetooth, width: width, height: height })));
    icons.push(("FaBootstrap".to_owned(), rsx!(Icon { icon: FaBootstrap, width: width, height: height })));
    icons.push(("FaBots".to_owned(), rsx!(Icon { icon: FaBots, width: width, height: height })));
    icons.push(("FaBtc".to_owned(), rsx!(Icon { icon: FaBtc, width: width, height: height })));
    icons.push(("FaBuffer".to_owned(), rsx!(Icon { icon: FaBuffer, width: width, height: height })));
    icons.push(("FaBuromobelexperte".to_owned(), rsx!(Icon { icon: FaBuromobelexperte, width: width, height: height })));
    icons.push(("FaBuyNLarge".to_owned(), rsx!(Icon { icon: FaBuyNLarge, width: width, height: height })));
    icons.push(("FaBuysellads".to_owned(), rsx!(Icon { icon: FaBuysellads, width: width, height: height })));
    icons.push(("FaCanadianMapleLeaf".to_owned(), rsx!(Icon { icon: FaCanadianMapleLeaf, width: width, height: height })));
    icons.push(("FaCcAmazonPay".to_owned(), rsx!(Icon { icon: FaCcAmazonPay, width: width, height: height })));
    icons.push(("FaCcAmex".to_owned(), rsx!(Icon { icon: FaCcAmex, width: width, height: height })));
    icons.push(("FaCcApplePay".to_owned(), rsx!(Icon { icon: FaCcApplePay, width: width, height: height })));
    icons.push(("FaCcDinersClub".to_owned(), rsx!(Icon { icon: FaCcDinersClub, width: width, height: height })));
    icons.push(("FaCcDiscover".to_owned(), rsx!(Icon { icon: FaCcDiscover, width: width, height: height })));
    icons.push(("FaCcJcb".to_owned(), rsx!(Icon { icon: FaCcJcb, width: width, height: height })));
    icons.push(("FaCcMastercard".to_owned(), rsx!(Icon { icon: FaCcMastercard, width: width, height: height })));
    icons.push(("FaCcPaypal".to_owned(), rsx!(Icon { icon: FaCcPaypal, width: width, height: height })));
    icons.push(("FaCcStripe".to_owned(), rsx!(Icon { icon: FaCcStripe, width: width, height: height })));
    icons.push(("FaCcVisa".to_owned(), rsx!(Icon { icon: FaCcVisa, width: width, height: height })));
    icons.push(("FaCentercode".to_owned(), rsx!(Icon { icon: FaCentercode, width: width, height: height })));
    icons.push(("FaCentos".to_owned(), rsx!(Icon { icon: FaCentos, width: width, height: height })));
    icons.push(("FaChrome".to_owned(), rsx!(Icon { icon: FaChrome, width: width, height: height })));
    icons.push(("FaChromecast".to_owned(), rsx!(Icon { icon: FaChromecast, width: width, height: height })));
    icons.push(("FaCloudflare".to_owned(), rsx!(Icon { icon: FaCloudflare, width: width, height: height })));
    icons.push(("FaCloudscale".to_owned(), rsx!(Icon { icon: FaCloudscale, width: width, height: height })));
    icons.push(("FaCloudsmith".to_owned(), rsx!(Icon { icon: FaCloudsmith, width: width, height: height })));
    icons.push(("FaCloudversify".to_owned(), rsx!(Icon { icon: FaCloudversify, width: width, height: height })));
    icons.push(("FaCmplid".to_owned(), rsx!(Icon { icon: FaCmplid, width: width, height: height })));
    icons.push(("FaCodepen".to_owned(), rsx!(Icon { icon: FaCodepen, width: width, height: height })));
    icons.push(("FaCodiepie".to_owned(), rsx!(Icon { icon: FaCodiepie, width: width, height: height })));
    icons.push(("FaConfluence".to_owned(), rsx!(Icon { icon: FaConfluence, width: width, height: height })));
    icons.push(("FaConnectdevelop".to_owned(), rsx!(Icon { icon: FaConnectdevelop, width: width, height: height })));
    icons.push(("FaContao".to_owned(), rsx!(Icon { icon: FaContao, width: width, height: height })));
    icons.push(("FaCottonBureau".to_owned(), rsx!(Icon { icon: FaCottonBureau, width: width, height: height })));
    icons.push(("FaCpanel".to_owned(), rsx!(Icon { icon: FaCpanel, width: width, height: height })));
    icons.push(("FaCreativeCommonsBy".to_owned(), rsx!(Icon { icon: FaCreativeCommonsBy, width: width, height: height })));
    icons.push(("FaCreativeCommonsNcEu".to_owned(), rsx!(Icon { icon: FaCreativeCommonsNcEu, width: width, height: height })));
    icons.push(("FaCreativeCommonsNcJp".to_owned(), rsx!(Icon { icon: FaCreativeCommonsNcJp, width: width, height: height })));
    icons.push(("FaCreativeCommonsNc".to_owned(), rsx!(Icon { icon: FaCreativeCommonsNc, width: width, height: height })));
    icons.push(("FaCreativeCommonsNd".to_owned(), rsx!(Icon { icon: FaCreativeCommonsNd, width: width, height: height })));
    icons.push(("FaCreativeCommonsPdAlt".to_owned(), rsx!(Icon { icon: FaCreativeCommonsPdAlt, width: width, height: height })));
    icons.push(("FaCreativeCommonsPd".to_owned(), rsx!(Icon { icon: FaCreativeCommonsPd, width: width, height: height })));
    icons.push(("FaCreativeCommonsRemix".to_owned(), rsx!(Icon { icon: FaCreativeCommonsRemix, width: width, height: height })));
    icons.push(("FaCreativeCommonsSa".to_owned(), rsx!(Icon { icon: FaCreativeCommonsSa, width: width, height: height })));
    icons.push(("FaCreativeCommonsSamplingPlus".to_owned(), rsx!(Icon { icon: FaCreativeCommonsSamplingPlus, width: width, height: height })));
    icons.push(("FaCreativeCommonsSampling".to_owned(), rsx!(Icon { icon: FaCreativeCommonsSampling, width: width, height: height })));
    icons.push(("FaCreativeCommonsShare".to_owned(), rsx!(Icon { icon: FaCreativeCommonsShare, width: width, height: height })));
    icons.push(("FaCreativeCommonsZero".to_owned(), rsx!(Icon { icon: FaCreativeCommonsZero, width: width, height: height })));
    icons.push(("FaCreativeCommons".to_owned(), rsx!(Icon { icon: FaCreativeCommons, width: width, height: height })));
    icons.push(("FaCriticalRole".to_owned(), rsx!(Icon { icon: FaCriticalRole, width: width, height: height })));
    icons.push(("FaCss3Alt".to_owned(), rsx!(Icon { icon: FaCss3Alt, width: width, height: height })));
    icons.push(("FaCss3".to_owned(), rsx!(Icon { icon: FaCss3, width: width, height: height })));
    icons.push(("FaCuttlefish".to_owned(), rsx!(Icon { icon: FaCuttlefish, width: width, height: height })));
    icons.push(("FaDAndDBeyond".to_owned(), rsx!(Icon { icon: FaDAndDBeyond, width: width, height: height })));
    icons.push(("FaDAndD".to_owned(), rsx!(Icon { icon: FaDAndD, width: width, height: height })));
    icons.push(("FaDailymotion".to_owned(), rsx!(Icon { icon: FaDailymotion, width: width, height: height })));
    icons.push(("FaDashcube".to_owned(), rsx!(Icon { icon: FaDashcube, width: width, height: height })));
    icons.push(("FaDeezer".to_owned(), rsx!(Icon { icon: FaDeezer, width: width, height: height })));
    icons.push(("FaDelicious".to_owned(), rsx!(Icon { icon: FaDelicious, width: width, height: height })));
    icons.push(("FaDeploydog".to_owned(), rsx!(Icon { icon: FaDeploydog, width: width, height: height })));
    icons.push(("FaDeskpro".to_owned(), rsx!(Icon { icon: FaDeskpro, width: width, height: height })));
    icons.push(("FaDev".to_owned(), rsx!(Icon { icon: FaDev, width: width, height: height })));
    icons.push(("FaDeviantart".to_owned(), rsx!(Icon { icon: FaDeviantart, width: width, height: height })));
    icons.push(("FaDhl".to_owned(), rsx!(Icon { icon: FaDhl, width: width, height: height })));
    icons.push(("FaDiaspora".to_owned(), rsx!(Icon { icon: FaDiaspora, width: width, height: height })));
    icons.push(("FaDigg".to_owned(), rsx!(Icon { icon: FaDigg, width: width, height: height })));
    icons.push(("FaDigitalOcean".to_owned(), rsx!(Icon { icon: FaDigitalOcean, width: width, height: height })));
    icons.push(("FaDiscord".to_owned(), rsx!(Icon { icon: FaDiscord, width: width, height: height })));
    icons.push(("FaDiscourse".to_owned(), rsx!(Icon { icon: FaDiscourse, width: width, height: height })));
    icons.push(("FaDochub".to_owned(), rsx!(Icon { icon: FaDochub, width: width, height: height })));
    icons.push(("FaDocker".to_owned(), rsx!(Icon { icon: FaDocker, width: width, height: height })));
    icons.push(("FaDraft2digital".to_owned(), rsx!(Icon { icon: FaDraft2digital, width: width, height: height })));
    icons.push(("FaDribbbleSquare".to_owned(), rsx!(Icon { icon: FaDribbbleSquare, width: width, height: height })));
    icons.push(("FaDribbble".to_owned(), rsx!(Icon { icon: FaDribbble, width: width, height: height })));
    icons.push(("FaDropbox".to_owned(), rsx!(Icon { icon: FaDropbox, width: width, height: height })));
    icons.push(("FaDrupal".to_owned(), rsx!(Icon { icon: FaDrupal, width: width, height: height })));
    icons.push(("FaDyalog".to_owned(), rsx!(Icon { icon: FaDyalog, width: width, height: height })));
    icons.push(("FaEarlybirds".to_owned(), rsx!(Icon { icon: FaEarlybirds, width: width, height: height })));
    icons.push(("FaEbay".to_owned(), rsx!(Icon { icon: FaEbay, width: width, height: height })));
    icons.push(("FaEdgeLegacy".to_owned(), rsx!(Icon { icon: FaEdgeLegacy, width: width, height: height })));
    icons.push(("FaEdge".to_owned(), rsx!(Icon { icon: FaEdge, width: width, height: height })));
    icons.push(("FaElementor".to_owned(), rsx!(Icon { icon: FaElementor, width: width, height: height })));
    icons.push(("FaEllo".to_owned(), rsx!(Icon { icon: FaEllo, width: width, height: height })));
    icons.push(("FaEmber".to_owned(), rsx!(Icon { icon: FaEmber, width: width, height: height })));
    icons.push(("FaEmpire".to_owned(), rsx!(Icon { icon: FaEmpire, width: width, height: height })));
    icons.push(("FaEnvira".to_owned(), rsx!(Icon { icon: FaEnvira, width: width, height: height })));
    icons.push(("FaErlang".to_owned(), rsx!(Icon { icon: FaErlang, width: width, height: height })));
    icons.push(("FaEthereum".to_owned(), rsx!(Icon { icon: FaEthereum, width: width, height: height })));
    icons.push(("FaEtsy".to_owned(), rsx!(Icon { icon: FaEtsy, width: width, height: height })));
    icons.push(("FaEvernote".to_owned(), rsx!(Icon { icon: FaEvernote, width: width, height: height })));
    icons.push(("FaExpeditedssl".to_owned(), rsx!(Icon { icon: FaExpeditedssl, width: width, height: height })));
    icons.push(("FaFacebookF".to_owned(), rsx!(Icon { icon: FaFacebookF, width: width, height: height })));
    icons.push(("FaFacebookMessenger".to_owned(), rsx!(Icon { icon: FaFacebookMessenger, width: width, height: height })));
    icons.push(("FaFacebookSquare".to_owned(), rsx!(Icon { icon: FaFacebookSquare, width: width, height: height })));
    icons.push(("FaFacebook".to_owned(), rsx!(Icon { icon: FaFacebook, width: width, height: height })));
    icons.push(("FaFantasyFlightGames".to_owned(), rsx!(Icon { icon: FaFantasyFlightGames, width: width, height: height })));
    icons.push(("FaFedex".to_owned(), rsx!(Icon { icon: FaFedex, width: width, height: height })));
    icons.push(("FaFedora".to_owned(), rsx!(Icon { icon: FaFedora, width: width, height: height })));
    icons.push(("FaFigma".to_owned(), rsx!(Icon { icon: FaFigma, width: width, height: height })));
    icons.push(("FaFirefoxBrowser".to_owned(), rsx!(Icon { icon: FaFirefoxBrowser, width: width, height: height })));
    icons.push(("FaFirefox".to_owned(), rsx!(Icon { icon: FaFirefox, width: width, height: height })));
    icons.push(("FaFirstOrderAlt".to_owned(), rsx!(Icon { icon: FaFirstOrderAlt, width: width, height: height })));
    icons.push(("FaFirstOrder".to_owned(), rsx!(Icon { icon: FaFirstOrder, width: width, height: height })));
    icons.push(("FaFirstdraft".to_owned(), rsx!(Icon { icon: FaFirstdraft, width: width, height: height })));
    icons.push(("FaFlickr".to_owned(), rsx!(Icon { icon: FaFlickr, width: width, height: height })));
    icons.push(("FaFlipboard".to_owned(), rsx!(Icon { icon: FaFlipboard, width: width, height: height })));
    icons.push(("FaFly".to_owned(), rsx!(Icon { icon: FaFly, width: width, height: height })));
    icons.push(("FaFontAwesome".to_owned(), rsx!(Icon { icon: FaFontAwesome, width: width, height: height })));
    icons.push(("FaFonticonsFi".to_owned(), rsx!(Icon { icon: FaFonticonsFi, width: width, height: height })));
    icons.push(("FaFonticons".to_owned(), rsx!(Icon { icon: FaFonticons, width: width, height: height })));
    icons.push(("FaFortAwesomeAlt".to_owned(), rsx!(Icon { icon: FaFortAwesomeAlt, width: width, height: height })));
    icons.push(("FaFortAwesome".to_owned(), rsx!(Icon { icon: FaFortAwesome, width: width, height: height })));
    icons.push(("FaForumbee".to_owned(), rsx!(Icon { icon: FaForumbee, width: width, height: height })));
    icons.push(("FaFoursquare".to_owned(), rsx!(Icon { icon: FaFoursquare, width: width, height: height })));
    icons.push(("FaFreeCodeCamp".to_owned(), rsx!(Icon { icon: FaFreeCodeCamp, width: width, height: height })));
    icons.push(("FaFreebsd".to_owned(), rsx!(Icon { icon: FaFreebsd, width: width, height: height })));
    icons.push(("FaFulcrum".to_owned(), rsx!(Icon { icon: FaFulcrum, width: width, height: height })));
    icons.push(("FaGalacticRepublic".to_owned(), rsx!(Icon { icon: FaGalacticRepublic, width: width, height: height })));
    icons.push(("FaGalacticSenate".to_owned(), rsx!(Icon { icon: FaGalacticSenate, width: width, height: height })));
    icons.push(("FaGetPocket".to_owned(), rsx!(Icon { icon: FaGetPocket, width: width, height: height })));
    icons.push(("FaGgCircle".to_owned(), rsx!(Icon { icon: FaGgCircle, width: width, height: height })));
    icons.push(("FaGg".to_owned(), rsx!(Icon { icon: FaGg, width: width, height: height })));
    icons.push(("FaGitAlt".to_owned(), rsx!(Icon { icon: FaGitAlt, width: width, height: height })));
    icons.push(("FaGitSquare".to_owned(), rsx!(Icon { icon: FaGitSquare, width: width, height: height })));
    icons.push(("FaGit".to_owned(), rsx!(Icon { icon: FaGit, width: width, height: height })));
    icons.push(("FaGithubAlt".to_owned(), rsx!(Icon { icon: FaGithubAlt, width: width, height: height })));
    icons.push(("FaGithubSquare".to_owned(), rsx!(Icon { icon: FaGithubSquare, width: width, height: height })));
    icons.push(("FaGithub".to_owned(), rsx!(Icon { icon: FaGithub, width: width, height: height })));
    icons.push(("FaGitkraken".to_owned(), rsx!(Icon { icon: FaGitkraken, width: width, height: height })));
    icons.push(("FaGitlab".to_owned(), rsx!(Icon { icon: FaGitlab, width: width, height: height })));
    icons.push(("FaGitter".to_owned(), rsx!(Icon { icon: FaGitter, width: width, height: height })));
    icons.push(("FaGlideG".to_owned(), rsx!(Icon { icon: FaGlideG, width: width, height: height })));
    icons.push(("FaGlide".to_owned(), rsx!(Icon { icon: FaGlide, width: width, height: height })));
    icons.push(("FaGofore".to_owned(), rsx!(Icon { icon: FaGofore, width: width, height: height })));
    icons.push(("FaGolang".to_owned(), rsx!(Icon { icon: FaGolang, width: width, height: height })));
    icons.push(("FaGoodreadsG".to_owned(), rsx!(Icon { icon: FaGoodreadsG, width: width, height: height })));
    icons.push(("FaGoodreads".to_owned(), rsx!(Icon { icon: FaGoodreads, width: width, height: height })));
    icons.push(("FaGoogleDrive".to_owned(), rsx!(Icon { icon: FaGoogleDrive, width: width, height: height })));
    icons.push(("FaGooglePay".to_owned(), rsx!(Icon { icon: FaGooglePay, width: width, height: height })));
    icons.push(("FaGooglePlay".to_owned(), rsx!(Icon { icon: FaGooglePlay, width: width, height: height })));
    icons.push(("FaGooglePlusG".to_owned(), rsx!(Icon { icon: FaGooglePlusG, width: width, height: height })));
    icons.push(("FaGooglePlusSquare".to_owned(), rsx!(Icon { icon: FaGooglePlusSquare, width: width, height: height })));
    icons.push(("FaGooglePlus".to_owned(), rsx!(Icon { icon: FaGooglePlus, width: width, height: height })));
    icons.push(("FaGoogleWallet".to_owned(), rsx!(Icon { icon: FaGoogleWallet, width: width, height: height })));
    icons.push(("FaGoogle".to_owned(), rsx!(Icon { icon: FaGoogle, width: width, height: height })));
    icons.push(("FaGratipay".to_owned(), rsx!(Icon { icon: FaGratipay, width: width, height: height })));
    icons.push(("FaGrav".to_owned(), rsx!(Icon { icon: FaGrav, width: width, height: height })));
    icons.push(("FaGripfire".to_owned(), rsx!(Icon { icon: FaGripfire, width: width, height: height })));
    icons.push(("FaGrunt".to_owned(), rsx!(Icon { icon: FaGrunt, width: width, height: height })));
    icons.push(("FaGuilded".to_owned(), rsx!(Icon { icon: FaGuilded, width: width, height: height })));
    icons.push(("FaGulp".to_owned(), rsx!(Icon { icon: FaGulp, width: width, height: height })));
    icons.push(("FaHackerNewsSquare".to_owned(), rsx!(Icon { icon: FaHackerNewsSquare, width: width, height: height })));
    icons.push(("FaHackerNews".to_owned(), rsx!(Icon { icon: FaHackerNews, width: width, height: height })));
    icons.push(("FaHackerrank".to_owned(), rsx!(Icon { icon: FaHackerrank, width: width, height: height })));
    icons.push(("FaHashnode".to_owned(), rsx!(Icon { icon: FaHashnode, width: width, height: height })));
    icons.push(("FaHips".to_owned(), rsx!(Icon { icon: FaHips, width: width, height: height })));
    icons.push(("FaHireAHelper".to_owned(), rsx!(Icon { icon: FaHireAHelper, width: width, height: height })));
    icons.push(("FaHive".to_owned(), rsx!(Icon { icon: FaHive, width: width, height: height })));
    icons.push(("FaHooli".to_owned(), rsx!(Icon { icon: FaHooli, width: width, height: height })));
    icons.push(("FaHornbill".to_owned(), rsx!(Icon { icon: FaHornbill, width: width, height: height })));
    icons.push(("FaHotjar".to_owned(), rsx!(Icon { icon: FaHotjar, width: width, height: height })));
    icons.push(("FaHouzz".to_owned(), rsx!(Icon { icon: FaHouzz, width: width, height: height })));
    icons.push(("FaHtml5".to_owned(), rsx!(Icon { icon: FaHtml5, width: width, height: height })));
    icons.push(("FaHubspot".to_owned(), rsx!(Icon { icon: FaHubspot, width: width, height: height })));
    icons.push(("FaIdeal".to_owned(), rsx!(Icon { icon: FaIdeal, width: width, height: height })));
    icons.push(("FaImdb".to_owned(), rsx!(Icon { icon: FaImdb, width: width, height: height })));
    icons.push(("FaInstagramSquare".to_owned(), rsx!(Icon { icon: FaInstagramSquare, width: width, height: height })));
    icons.push(("FaInstagram".to_owned(), rsx!(Icon { icon: FaInstagram, width: width, height: height })));
    icons.push(("FaInstalod".to_owned(), rsx!(Icon { icon: FaInstalod, width: width, height: height })));
    icons.push(("FaIntercom".to_owned(), rsx!(Icon { icon: FaIntercom, width: width, height: height })));
    icons.push(("FaInternetExplorer".to_owned(), rsx!(Icon { icon: FaInternetExplorer, width: width, height: height })));
    icons.push(("FaInvision".to_owned(), rsx!(Icon { icon: FaInvision, width: width, height: height })));
    icons.push(("FaIoxhost".to_owned(), rsx!(Icon { icon: FaIoxhost, width: width, height: height })));
    icons.push(("FaItchIo".to_owned(), rsx!(Icon { icon: FaItchIo, width: width, height: height })));
    icons.push(("FaItunesNote".to_owned(), rsx!(Icon { icon: FaItunesNote, width: width, height: height })));
    icons.push(("FaItunes".to_owned(), rsx!(Icon { icon: FaItunes, width: width, height: height })));
    icons.push(("FaJava".to_owned(), rsx!(Icon { icon: FaJava, width: width, height: height })));
    icons.push(("FaJediOrder".to_owned(), rsx!(Icon { icon: FaJediOrder, width: width, height: height })));
    icons.push(("FaJenkins".to_owned(), rsx!(Icon { icon: FaJenkins, width: width, height: height })));
    icons.push(("FaJira".to_owned(), rsx!(Icon { icon: FaJira, width: width, height: height })));
    icons.push(("FaJoget".to_owned(), rsx!(Icon { icon: FaJoget, width: width, height: height })));
    icons.push(("FaJoomla".to_owned(), rsx!(Icon { icon: FaJoomla, width: width, height: height })));
    icons.push(("FaJsSquare".to_owned(), rsx!(Icon { icon: FaJsSquare, width: width, height: height })));
    icons.push(("FaJs".to_owned(), rsx!(Icon { icon: FaJs, width: width, height: height })));
    icons.push(("FaJsfiddle".to_owned(), rsx!(Icon { icon: FaJsfiddle, width: width, height: height })));
    icons.push(("FaKaggle".to_owned(), rsx!(Icon { icon: FaKaggle, width: width, height: height })));
    icons.push(("FaKeybase".to_owned(), rsx!(Icon { icon: FaKeybase, width: width, height: height })));
    icons.push(("FaKeycdn".to_owned(), rsx!(Icon { icon: FaKeycdn, width: width, height: height })));
    icons.push(("FaKickstarterK".to_owned(), rsx!(Icon { icon: FaKickstarterK, width: width, height: height })));
    icons.push(("FaKickstarter".to_owned(), rsx!(Icon { icon: FaKickstarter, width: width, height: height })));
    icons.push(("FaKorvue".to_owned(), rsx!(Icon { icon: FaKorvue, width: width, height: height })));
    icons.push(("FaLaravel".to_owned(), rsx!(Icon { icon: FaLaravel, width: width, height: height })));
    icons.push(("FaLastfmSquare".to_owned(), rsx!(Icon { icon: FaLastfmSquare, width: width, height: height })));
    icons.push(("FaLastfm".to_owned(), rsx!(Icon { icon: FaLastfm, width: width, height: height })));
    icons.push(("FaLeanpub".to_owned(), rsx!(Icon { icon: FaLeanpub, width: width, height: height })));
    icons.push(("FaLess".to_owned(), rsx!(Icon { icon: FaLess, width: width, height: height })));
    icons.push(("FaLine".to_owned(), rsx!(Icon { icon: FaLine, width: width, height: height })));
    icons.push(("FaLinkedinIn".to_owned(), rsx!(Icon { icon: FaLinkedinIn, width: width, height: height })));
    icons.push(("FaLinkedin".to_owned(), rsx!(Icon { icon: FaLinkedin, width: width, height: height })));
    icons.push(("FaLinode".to_owned(), rsx!(Icon { icon: FaLinode, width: width, height: height })));
    icons.push(("FaLinux".to_owned(), rsx!(Icon { icon: FaLinux, width: width, height: height })));
    icons.push(("FaLyft".to_owned(), rsx!(Icon { icon: FaLyft, width: width, height: height })));
    icons.push(("FaMagento".to_owned(), rsx!(Icon { icon: FaMagento, width: width, height: height })));
    icons.push(("FaMailchimp".to_owned(), rsx!(Icon { icon: FaMailchimp, width: width, height: height })));
    icons.push(("FaMandalorian".to_owned(), rsx!(Icon { icon: FaMandalorian, width: width, height: height })));
    icons.push(("FaMarkdown".to_owned(), rsx!(Icon { icon: FaMarkdown, width: width, height: height })));
    icons.push(("FaMastodon".to_owned(), rsx!(Icon { icon: FaMastodon, width: width, height: height })));
    icons.push(("FaMaxcdn".to_owned(), rsx!(Icon { icon: FaMaxcdn, width: width, height: height })));
    icons.push(("FaMdb".to_owned(), rsx!(Icon { icon: FaMdb, width: width, height: height })));
    icons.push(("FaMedapps".to_owned(), rsx!(Icon { icon: FaMedapps, width: width, height: height })));
    icons.push(("FaMedium".to_owned(), rsx!(Icon { icon: FaMedium, width: width, height: height })));
    icons.push(("FaMedrt".to_owned(), rsx!(Icon { icon: FaMedrt, width: width, height: height })));
    icons.push(("FaMeetup".to_owned(), rsx!(Icon { icon: FaMeetup, width: width, height: height })));
    icons.push(("FaMegaport".to_owned(), rsx!(Icon { icon: FaMegaport, width: width, height: height })));
    icons.push(("FaMendeley".to_owned(), rsx!(Icon { icon: FaMendeley, width: width, height: height })));
    icons.push(("FaMicroblog".to_owned(), rsx!(Icon { icon: FaMicroblog, width: width, height: height })));
    icons.push(("FaMicrosoft".to_owned(), rsx!(Icon { icon: FaMicrosoft, width: width, height: height })));
    icons.push(("FaMix".to_owned(), rsx!(Icon { icon: FaMix, width: width, height: height })));
    icons.push(("FaMixcloud".to_owned(), rsx!(Icon { icon: FaMixcloud, width: width, height: height })));
    icons.push(("FaMixer".to_owned(), rsx!(Icon { icon: FaMixer, width: width, height: height })));
    icons.push(("FaMizuni".to_owned(), rsx!(Icon { icon: FaMizuni, width: width, height: height })));
    icons.push(("FaModx".to_owned(), rsx!(Icon { icon: FaModx, width: width, height: height })));
    icons.push(("FaMonero".to_owned(), rsx!(Icon { icon: FaMonero, width: width, height: height })));
    icons.push(("FaNapster".to_owned(), rsx!(Icon { icon: FaNapster, width: width, height: height })));
    icons.push(("FaNeos".to_owned(), rsx!(Icon { icon: FaNeos, width: width, height: height })));
    icons.push(("FaNfcDirectional".to_owned(), rsx!(Icon { icon: FaNfcDirectional, width: width, height: height })));
    icons.push(("FaNfcSymbol".to_owned(), rsx!(Icon { icon: FaNfcSymbol, width: width, height: height })));
    icons.push(("FaNimblr".to_owned(), rsx!(Icon { icon: FaNimblr, width: width, height: height })));
    icons.push(("FaNodeJs".to_owned(), rsx!(Icon { icon: FaNodeJs, width: width, height: height })));
    icons.push(("FaNode".to_owned(), rsx!(Icon { icon: FaNode, width: width, height: height })));
    icons.push(("FaNpm".to_owned(), rsx!(Icon { icon: FaNpm, width: width, height: height })));
    icons.push(("FaNs8".to_owned(), rsx!(Icon { icon: FaNs8, width: width, height: height })));
    icons.push(("FaNutritionix".to_owned(), rsx!(Icon { icon: FaNutritionix, width: width, height: height })));
    icons.push(("FaOctopusDeploy".to_owned(), rsx!(Icon { icon: FaOctopusDeploy, width: width, height: height })));
    icons.push(("FaOdnoklassnikiSquare".to_owned(), rsx!(Icon { icon: FaOdnoklassnikiSquare, width: width, height: height })));
    icons.push(("FaOdnoklassniki".to_owned(), rsx!(Icon { icon: FaOdnoklassniki, width: width, height: height })));
    icons.push(("FaOldRepublic".to_owned(), rsx!(Icon { icon: FaOldRepublic, width: width, height: height })));
    icons.push(("FaOpencart".to_owned(), rsx!(Icon { icon: FaOpencart, width: width, height: height })));
    icons.push(("FaOpenid".to_owned(), rsx!(Icon { icon: FaOpenid, width: width, height: height })));
    icons.push(("FaOpera".to_owned(), rsx!(Icon { icon: FaOpera, width: width, height: height })));
    icons.push(("FaOptinMonster".to_owned(), rsx!(Icon { icon: FaOptinMonster, width: width, height: height })));
    icons.push(("FaOrcid".to_owned(), rsx!(Icon { icon: FaOrcid, width: width, height: height })));
    icons.push(("FaOsi".to_owned(), rsx!(Icon { icon: FaOsi, width: width, height: height })));
    icons.push(("FaPadlet".to_owned(), rsx!(Icon { icon: FaPadlet, width: width, height: height })));
    icons.push(("FaPage4".to_owned(), rsx!(Icon { icon: FaPage4, width: width, height: height })));
    icons.push(("FaPagelines".to_owned(), rsx!(Icon { icon: FaPagelines, width: width, height: height })));
    icons.push(("FaPalfed".to_owned(), rsx!(Icon { icon: FaPalfed, width: width, height: height })));
    icons.push(("FaPatreon".to_owned(), rsx!(Icon { icon: FaPatreon, width: width, height: height })));
    icons.push(("FaPaypal".to_owned(), rsx!(Icon { icon: FaPaypal, width: width, height: height })));
    icons.push(("FaPerbyte".to_owned(), rsx!(Icon { icon: FaPerbyte, width: width, height: height })));
    icons.push(("FaPeriscope".to_owned(), rsx!(Icon { icon: FaPeriscope, width: width, height: height })));
    icons.push(("FaPhabricator".to_owned(), rsx!(Icon { icon: FaPhabricator, width: width, height: height })));
    icons.push(("FaPhoenixFramework".to_owned(), rsx!(Icon { icon: FaPhoenixFramework, width: width, height: height })));
    icons.push(("FaPhoenixSquadron".to_owned(), rsx!(Icon { icon: FaPhoenixSquadron, width: width, height: height })));
    icons.push(("FaPhp".to_owned(), rsx!(Icon { icon: FaPhp, width: width, height: height })));
    icons.push(("FaPiedPiperAlt".to_owned(), rsx!(Icon { icon: FaPiedPiperAlt, width: width, height: height })));
    icons.push(("FaPiedPiperHat".to_owned(), rsx!(Icon { icon: FaPiedPiperHat, width: width, height: height })));
    icons.push(("FaPiedPiperPp".to_owned(), rsx!(Icon { icon: FaPiedPiperPp, width: width, height: height })));
    icons.push(("FaPiedPiperSquare".to_owned(), rsx!(Icon { icon: FaPiedPiperSquare, width: width, height: height })));
    icons.push(("FaPiedPiper".to_owned(), rsx!(Icon { icon: FaPiedPiper, width: width, height: height })));
    icons.push(("FaPinterestP".to_owned(), rsx!(Icon { icon: FaPinterestP, width: width, height: height })));
    icons.push(("FaPinterestSquare".to_owned(), rsx!(Icon { icon: FaPinterestSquare, width: width, height: height })));
    icons.push(("FaPinterest".to_owned(), rsx!(Icon { icon: FaPinterest, width: width, height: height })));
    icons.push(("FaPix".to_owned(), rsx!(Icon { icon: FaPix, width: width, height: height })));
    icons.push(("FaPlaystation".to_owned(), rsx!(Icon { icon: FaPlaystation, width: width, height: height })));
    icons.push(("FaProductHunt".to_owned(), rsx!(Icon { icon: FaProductHunt, width: width, height: height })));
    icons.push(("FaPushed".to_owned(), rsx!(Icon { icon: FaPushed, width: width, height: height })));
    icons.push(("FaPython".to_owned(), rsx!(Icon { icon: FaPython, width: width, height: height })));
    icons.push(("FaQq".to_owned(), rsx!(Icon { icon: FaQq, width: width, height: height })));
    icons.push(("FaQuinscape".to_owned(), rsx!(Icon { icon: FaQuinscape, width: width, height: height })));
    icons.push(("FaQuora".to_owned(), rsx!(Icon { icon: FaQuora, width: width, height: height })));
    icons.push(("FaRProject".to_owned(), rsx!(Icon { icon: FaRProject, width: width, height: height })));
    icons.push(("FaRaspberryPi".to_owned(), rsx!(Icon { icon: FaRaspberryPi, width: width, height: height })));
    icons.push(("FaRavelry".to_owned(), rsx!(Icon { icon: FaRavelry, width: width, height: height })));
    icons.push(("FaReact".to_owned(), rsx!(Icon { icon: FaReact, width: width, height: height })));
    icons.push(("FaReacteurope".to_owned(), rsx!(Icon { icon: FaReacteurope, width: width, height: height })));
    icons.push(("FaReadme".to_owned(), rsx!(Icon { icon: FaReadme, width: width, height: height })));
    icons.push(("FaRebel".to_owned(), rsx!(Icon { icon: FaRebel, width: width, height: height })));
    icons.push(("FaRedRiver".to_owned(), rsx!(Icon { icon: FaRedRiver, width: width, height: height })));
    icons.push(("FaRedditAlien".to_owned(), rsx!(Icon { icon: FaRedditAlien, width: width, height: height })));
    icons.push(("FaRedditSquare".to_owned(), rsx!(Icon { icon: FaRedditSquare, width: width, height: height })));
    icons.push(("FaReddit".to_owned(), rsx!(Icon { icon: FaReddit, width: width, height: height })));
    icons.push(("FaRedhat".to_owned(), rsx!(Icon { icon: FaRedhat, width: width, height: height })));
    icons.push(("FaRenren".to_owned(), rsx!(Icon { icon: FaRenren, width: width, height: height })));
    icons.push(("FaReplyd".to_owned(), rsx!(Icon { icon: FaReplyd, width: width, height: height })));
    icons.push(("FaResearchgate".to_owned(), rsx!(Icon { icon: FaResearchgate, width: width, height: height })));
    icons.push(("FaResolving".to_owned(), rsx!(Icon { icon: FaResolving, width: width, height: height })));
    icons.push(("FaRev".to_owned(), rsx!(Icon { icon: FaRev, width: width, height: height })));
    icons.push(("FaRocketchat".to_owned(), rsx!(Icon { icon: FaRocketchat, width: width, height: height })));
    icons.push(("FaRockrms".to_owned(), rsx!(Icon { icon: FaRockrms, width: width, height: height })));
    icons.push(("FaRust".to_owned(), rsx!(Icon { icon: FaRust, width: width, height: height })));
    icons.push(("FaSafari".to_owned(), rsx!(Icon { icon: FaSafari, width: width, height: height })));
    icons.push(("FaSalesforce".to_owned(), rsx!(Icon { icon: FaSalesforce, width: width, height: height })));
    icons.push(("FaSass".to_owned(), rsx!(Icon { icon: FaSass, width: width, height: height })));
    icons.push(("FaSchlix".to_owned(), rsx!(Icon { icon: FaSchlix, width: width, height: height })));
    icons.push(("FaScreenpal".to_owned(), rsx!(Icon { icon: FaScreenpal, width: width, height: height })));
    icons.push(("FaScribd".to_owned(), rsx!(Icon { icon: FaScribd, width: width, height: height })));
    icons.push(("FaSearchengin".to_owned(), rsx!(Icon { icon: FaSearchengin, width: width, height: height })));
    icons.push(("FaSellcast".to_owned(), rsx!(Icon { icon: FaSellcast, width: width, height: height })));
    icons.push(("FaSellsy".to_owned(), rsx!(Icon { icon: FaSellsy, width: width, height: height })));
    icons.push(("FaServicestack".to_owned(), rsx!(Icon { icon: FaServicestack, width: width, height: height })));
    icons.push(("FaShirtsinbulk".to_owned(), rsx!(Icon { icon: FaShirtsinbulk, width: width, height: height })));
    icons.push(("FaShopify".to_owned(), rsx!(Icon { icon: FaShopify, width: width, height: height })));
    icons.push(("FaShopware".to_owned(), rsx!(Icon { icon: FaShopware, width: width, height: height })));
    icons.push(("FaSimplybuilt".to_owned(), rsx!(Icon { icon: FaSimplybuilt, width: width, height: height })));
    icons.push(("FaSistrix".to_owned(), rsx!(Icon { icon: FaSistrix, width: width, height: height })));
    icons.push(("FaSith".to_owned(), rsx!(Icon { icon: FaSith, width: width, height: height })));
    icons.push(("FaSitrox".to_owned(), rsx!(Icon { icon: FaSitrox, width: width, height: height })));
    icons.push(("FaSketch".to_owned(), rsx!(Icon { icon: FaSketch, width: width, height: height })));
    icons.push(("FaSkyatlas".to_owned(), rsx!(Icon { icon: FaSkyatlas, width: width, height: height })));
    icons.push(("FaSkype".to_owned(), rsx!(Icon { icon: FaSkype, width: width, height: height })));
    icons.push(("FaSlack".to_owned(), rsx!(Icon { icon: FaSlack, width: width, height: height })));
    icons.push(("FaSlideshare".to_owned(), rsx!(Icon { icon: FaSlideshare, width: width, height: height })));
    icons.push(("FaSnapchatSquare".to_owned(), rsx!(Icon { icon: FaSnapchatSquare, width: width, height: height })));
    icons.push(("FaSnapchat".to_owned(), rsx!(Icon { icon: FaSnapchat, width: width, height: height })));
    icons.push(("FaSoundcloud".to_owned(), rsx!(Icon { icon: FaSoundcloud, width: width, height: height })));
    icons.push(("FaSourcetree".to_owned(), rsx!(Icon { icon: FaSourcetree, width: width, height: height })));
    icons.push(("FaSpeakap".to_owned(), rsx!(Icon { icon: FaSpeakap, width: width, height: height })));
    icons.push(("FaSpeakerDeck".to_owned(), rsx!(Icon { icon: FaSpeakerDeck, width: width, height: height })));
    icons.push(("FaSpotify".to_owned(), rsx!(Icon { icon: FaSpotify, width: width, height: height })));
    icons.push(("FaSquareFontAwesomeStroke".to_owned(), rsx!(Icon { icon: FaSquareFontAwesomeStroke, width: width, height: height })));
    icons.push(("FaSquareFontAwesome".to_owned(), rsx!(Icon { icon: FaSquareFontAwesome, width: width, height: height })));
    icons.push(("FaSquarespace".to_owned(), rsx!(Icon { icon: FaSquarespace, width: width, height: height })));
    icons.push(("FaStackExchange".to_owned(), rsx!(Icon { icon: FaStackExchange, width: width, height: height })));
    icons.push(("FaStackOverflow".to_owned(), rsx!(Icon { icon: FaStackOverflow, width: width, height: height })));
    icons.push(("FaStackpath".to_owned(), rsx!(Icon { icon: FaStackpath, width: width, height: height })));
    icons.push(("FaStaylinked".to_owned(), rsx!(Icon { icon: FaStaylinked, width: width, height: height })));
    icons.push(("FaSteamSquare".to_owned(), rsx!(Icon { icon: FaSteamSquare, width: width, height: height })));
    icons.push(("FaSteamSymbol".to_owned(), rsx!(Icon { icon: FaSteamSymbol, width: width, height: height })));
    icons.push(("FaSteam".to_owned(), rsx!(Icon { icon: FaSteam, width: width, height: height })));
    icons.push(("FaStickerMule".to_owned(), rsx!(Icon { icon: FaStickerMule, width: width, height: height })));
    icons.push(("FaStrava".to_owned(), rsx!(Icon { icon: FaStrava, width: width, height: height })));
    icons.push(("FaStripeS".to_owned(), rsx!(Icon { icon: FaStripeS, width: width, height: height })));
    icons.push(("FaStripe".to_owned(), rsx!(Icon { icon: FaStripe, width: width, height: height })));
    icons.push(("FaStudiovinari".to_owned(), rsx!(Icon { icon: FaStudiovinari, width: width, height: height })));
    icons.push(("FaStumbleuponCircle".to_owned(), rsx!(Icon { icon: FaStumbleuponCircle, width: width, height: height })));
    icons.push(("FaStumbleupon".to_owned(), rsx!(Icon { icon: FaStumbleupon, width: width, height: height })));
    icons.push(("FaSuperpowers".to_owned(), rsx!(Icon { icon: FaSuperpowers, width: width, height: height })));
    icons.push(("FaSupple".to_owned(), rsx!(Icon { icon: FaSupple, width: width, height: height })));
    icons.push(("FaSuse".to_owned(), rsx!(Icon { icon: FaSuse, width: width, height: height })));
    icons.push(("FaSwift".to_owned(), rsx!(Icon { icon: FaSwift, width: width, height: height })));
    icons.push(("FaSymfony".to_owned(), rsx!(Icon { icon: FaSymfony, width: width, height: height })));
    icons.push(("FaTeamspeak".to_owned(), rsx!(Icon { icon: FaTeamspeak, width: width, height: height })));
    icons.push(("FaTelegram".to_owned(), rsx!(Icon { icon: FaTelegram, width: width, height: height })));
    icons.push(("FaTencentWeibo".to_owned(), rsx!(Icon { icon: FaTencentWeibo, width: width, height: height })));
    icons.push(("FaTheRedYeti".to_owned(), rsx!(Icon { icon: FaTheRedYeti, width: width, height: height })));
    icons.push(("FaThemeco".to_owned(), rsx!(Icon { icon: FaThemeco, width: width, height: height })));
    icons.push(("FaThemeisle".to_owned(), rsx!(Icon { icon: FaThemeisle, width: width, height: height })));
    icons.push(("FaThinkPeaks".to_owned(), rsx!(Icon { icon: FaThinkPeaks, width: width, height: height })));
    icons.push(("FaTiktok".to_owned(), rsx!(Icon { icon: FaTiktok, width: width, height: height })));
    icons.push(("FaTradeFederation".to_owned(), rsx!(Icon { icon: FaTradeFederation, width: width, height: height })));
    icons.push(("FaTrello".to_owned(), rsx!(Icon { icon: FaTrello, width: width, height: height })));
    icons.push(("FaTumblrSquare".to_owned(), rsx!(Icon { icon: FaTumblrSquare, width: width, height: height })));
    icons.push(("FaTumblr".to_owned(), rsx!(Icon { icon: FaTumblr, width: width, height: height })));
    icons.push(("FaTwitch".to_owned(), rsx!(Icon { icon: FaTwitch, width: width, height: height })));
    icons.push(("FaTwitterSquare".to_owned(), rsx!(Icon { icon: FaTwitterSquare, width: width, height: height })));
    icons.push(("FaTwitter".to_owned(), rsx!(Icon { icon: FaTwitter, width: width, height: height })));
    icons.push(("FaTypo3".to_owned(), rsx!(Icon { icon: FaTypo3, width: width, height: height })));
    icons.push(("FaUber".to_owned(), rsx!(Icon { icon: FaUber, width: width, height: height })));
    icons.push(("FaUbuntu".to_owned(), rsx!(Icon { icon: FaUbuntu, width: width, height: height })));
    icons.push(("FaUikit".to_owned(), rsx!(Icon { icon: FaUikit, width: width, height: height })));
    icons.push(("FaUmbraco".to_owned(), rsx!(Icon { icon: FaUmbraco, width: width, height: height })));
    icons.push(("FaUncharted".to_owned(), rsx!(Icon { icon: FaUncharted, width: width, height: height })));
    icons.push(("FaUniregistry".to_owned(), rsx!(Icon { icon: FaUniregistry, width: width, height: height })));
    icons.push(("FaUnity".to_owned(), rsx!(Icon { icon: FaUnity, width: width, height: height })));
    icons.push(("FaUnsplash".to_owned(), rsx!(Icon { icon: FaUnsplash, width: width, height: height })));
    icons.push(("FaUntappd".to_owned(), rsx!(Icon { icon: FaUntappd, width: width, height: height })));
    icons.push(("FaUps".to_owned(), rsx!(Icon { icon: FaUps, width: width, height: height })));
    icons.push(("FaUsb".to_owned(), rsx!(Icon { icon: FaUsb, width: width, height: height })));
    icons.push(("FaUsps".to_owned(), rsx!(Icon { icon: FaUsps, width: width, height: height })));
    icons.push(("FaUssunnah".to_owned(), rsx!(Icon { icon: FaUssunnah, width: width, height: height })));
    icons.push(("FaVaadin".to_owned(), rsx!(Icon { icon: FaVaadin, width: width, height: height })));
    icons.push(("FaViacoin".to_owned(), rsx!(Icon { icon: FaViacoin, width: width, height: height })));
    icons.push(("FaViadeoSquare".to_owned(), rsx!(Icon { icon: FaViadeoSquare, width: width, height: height })));
    icons.push(("FaViadeo".to_owned(), rsx!(Icon { icon: FaViadeo, width: width, height: height })));
    icons.push(("FaViber".to_owned(), rsx!(Icon { icon: FaViber, width: width, height: height })));
    icons.push(("FaVimeoSquare".to_owned(), rsx!(Icon { icon: FaVimeoSquare, width: width, height: height })));
    icons.push(("FaVimeoV".to_owned(), rsx!(Icon { icon: FaVimeoV, width: width, height: height })));
    icons.push(("FaVimeo".to_owned(), rsx!(Icon { icon: FaVimeo, width: width, height: height })));
    icons.push(("FaVine".to_owned(), rsx!(Icon { icon: FaVine, width: width, height: height })));
    icons.push(("FaVk".to_owned(), rsx!(Icon { icon: FaVk, width: width, height: height })));
    icons.push(("FaVnv".to_owned(), rsx!(Icon { icon: FaVnv, width: width, height: height })));
    icons.push(("FaVuejs".to_owned(), rsx!(Icon { icon: FaVuejs, width: width, height: height })));
    icons.push(("FaWatchmanMonitoring".to_owned(), rsx!(Icon { icon: FaWatchmanMonitoring, width: width, height: height })));
    icons.push(("FaWaze".to_owned(), rsx!(Icon { icon: FaWaze, width: width, height: height })));
    icons.push(("FaWeebly".to_owned(), rsx!(Icon { icon: FaWeebly, width: width, height: height })));
    icons.push(("FaWeibo".to_owned(), rsx!(Icon { icon: FaWeibo, width: width, height: height })));
    icons.push(("FaWeixin".to_owned(), rsx!(Icon { icon: FaWeixin, width: width, height: height })));
    icons.push(("FaWhatsappSquare".to_owned(), rsx!(Icon { icon: FaWhatsappSquare, width: width, height: height })));
    icons.push(("FaWhatsapp".to_owned(), rsx!(Icon { icon: FaWhatsapp, width: width, height: height })));
    icons.push(("FaWhmcs".to_owned(), rsx!(Icon { icon: FaWhmcs, width: width, height: height })));
    icons.push(("FaWikipediaW".to_owned(), rsx!(Icon { icon: FaWikipediaW, width: width, height: height })));
    icons.push(("FaWindows".to_owned(), rsx!(Icon { icon: FaWindows, width: width, height: height })));
    icons.push(("FaWirsindhandwerk".to_owned(), rsx!(Icon { icon: FaWirsindhandwerk, width: width, height: height })));
    icons.push(("FaWix".to_owned(), rsx!(Icon { icon: FaWix, width: width, height: height })));
    icons.push(("FaWizardsOfTheCoast".to_owned(), rsx!(Icon { icon: FaWizardsOfTheCoast, width: width, height: height })));
    icons.push(("FaWodu".to_owned(), rsx!(Icon { icon: FaWodu, width: width, height: height })));
    icons.push(("FaWolfPackBattalion".to_owned(), rsx!(Icon { icon: FaWolfPackBattalion, width: width, height: height })));
    icons.push(("FaWordpressSimple".to_owned(), rsx!(Icon { icon: FaWordpressSimple, width: width, height: height })));
    icons.push(("FaWordpress".to_owned(), rsx!(Icon { icon: FaWordpress, width: width, height: height })));
    icons.push(("FaWpbeginner".to_owned(), rsx!(Icon { icon: FaWpbeginner, width: width, height: height })));
    icons.push(("FaWpexplorer".to_owned(), rsx!(Icon { icon: FaWpexplorer, width: width, height: height })));
    icons.push(("FaWpforms".to_owned(), rsx!(Icon { icon: FaWpforms, width: width, height: height })));
    icons.push(("FaWpressr".to_owned(), rsx!(Icon { icon: FaWpressr, width: width, height: height })));
    icons.push(("FaXbox".to_owned(), rsx!(Icon { icon: FaXbox, width: width, height: height })));
    icons.push(("FaXingSquare".to_owned(), rsx!(Icon { icon: FaXingSquare, width: width, height: height })));
    icons.push(("FaXing".to_owned(), rsx!(Icon { icon: FaXing, width: width, height: height })));
    icons.push(("FaYCombinator".to_owned(), rsx!(Icon { icon: FaYCombinator, width: width, height: height })));
    icons.push(("FaYahoo".to_owned(), rsx!(Icon { icon: FaYahoo, width: width, height: height })));
    icons.push(("FaYammer".to_owned(), rsx!(Icon { icon: FaYammer, width: width, height: height })));
    icons.push(("FaYandexInternational".to_owned(), rsx!(Icon { icon: FaYandexInternational, width: width, height: height })));
    icons.push(("FaYandex".to_owned(), rsx!(Icon { icon: FaYandex, width: width, height: height })));
    icons.push(("FaYarn".to_owned(), rsx!(Icon { icon: FaYarn, width: width, height: height })));
    icons.push(("FaYelp".to_owned(), rsx!(Icon { icon: FaYelp, width: width, height: height })));
    icons.push(("FaYoast".to_owned(), rsx!(Icon { icon: FaYoast, width: width, height: height })));
    icons.push(("FaYoutubeSquare".to_owned(), rsx!(Icon { icon: FaYoutubeSquare, width: width, height: height })));
    icons.push(("FaYoutube".to_owned(), rsx!(Icon { icon: FaYoutube, width: width, height: height })));
    icons.push(("FaZhihu".to_owned(), rsx!(Icon { icon: FaZhihu, width: width, height: height })));
    icons
}}